...
using GA.BDC.WebApi.Fundraising.Core.GAPayNETTCP;
using Moneris;
using Sentry;
         ...
         try
         {
            ...
            var creditCardPaymentResult =
                client.ProcessPaymentTransaction(
                    ...
                    PresenterId: "eFR Store",
                    ClientId: PaymentClient.QSPEFUND,
                    RefId: model.Reference,
                    ReferenceSourceId: "",
                    ReferenceAuthNumber: "",
                    FirstName: model.Holder,
                    LastName: model.Holder,
            ...
            switch (creditCardPaymentResult.TranResponseType)
            {
               ...
               case PaymentResponseType.E: // Communication Error
                    var ccError2 = new CreditCardDeclinedException(model.InternalPaymentMethod.ToString(), model.Amount, creditCardPaymentResult.ResponseCode, creditCardPaymentResult.ResponseRaw, null);
