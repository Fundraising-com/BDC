...
{
   [Authorize]
   public class SalesToProcessNewController : ApiController
   {
      [HttpOptions]
      ...
      public IHttpActionResult Post(SalesToProcessViewModel viewModel)
      {
         using (var efundraisingProdUnitOfWork = new UnitOfWork(Database.EFundraisingProd))
         {
            ...
            var result = reportsFactory.ExecuteReportSalesToProcessNew(DateHelper.PrepareStartDate(viewModel.SalesConfirmStart), 
