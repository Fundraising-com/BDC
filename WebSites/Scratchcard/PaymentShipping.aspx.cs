...
{
	/// <summary>
	/// Summary description for PaymentShipping.
	/// </summary>
	public class PaymentShipping : ScratchcardWebBase
	{
		...
		{
			ScratchcardOmnitureTracking.SetPageNameAndCategory("Public", "Payment & Shipping Terms");
