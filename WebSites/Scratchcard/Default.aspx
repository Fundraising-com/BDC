...
<%@ Page language="c#" Codebehind="Default.aspx.cs" AutoEventWireup="false" Inherits="GA.BDC.WEB.ScratchcardWeb.Default" %>
...
<HTML>
	...
	<body background="Resources/images/_ScratchcardWeb_/_classic_/en-US/common/fond.gif" onload="MM_preloadImages('Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_soccer.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_basket.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_foot.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_softball.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_baseball.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_hockey.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_volley.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_cheer.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_bowling.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_elementary.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_highschool.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_university.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_church.gif','Resources/images/_ScratchcardWeb_/_classic_/en-US/common/icones/B_other.gif')">
		<form id="Form2" method="post" runat="server">
				...
				<TABLE id="TableMain" cellSpacing="0" cellPadding="0" width="754" border="0">
								...
								<TR>
									...
									<TD vAlign="top">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TBODY>
												<tr>
													<td><buttonpanel:contentpanelcontrol id="ContentPanelControl1" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:contentpanelcontrol></td>
												</tr>
												<tr>
													<td align="left">
														<buttonpanel:contentpanelcontrol id="ContentPanelControl3" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:contentpanelcontrol><br>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<buttonpanel:contentpanelcontrol id="ContentPanelControl2" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:contentpanelcontrol>
													</td>
												</tr>
											</TBODY>
										</table>
					...
					<TR>
						<TD bgColor="#666666" colSpan="3">
							<buttonpanel:ContentPanelControl id="ContentPanelControl4" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl>
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<td class="normal_white" valign="top">
										<buttonpanel:ContentPanelControl id="ContentPanelControl5" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl><p>
											<buttonpanel:ContentPanelControl id="ContentPanelControl6" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl></p>
										<br>
									</td>
								</TR>
							</TABLE>
									...
									<TD>
										<P>
											<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TR>
													<TD>
														<buttonpanel:ContentPanelControl id="ContentPanelControl7" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl>&nbsp;</TD>
													<TD>
														<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" class="small_black">
															<TR>
																<TD><buttonpanel:ContentPanelControl id="ContentPanelControl8" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl></TD>
																<TD rowspan="2" width="1" bgcolor="#333333"></TD>
															</TR>
															<TR>
																<TD align="right">
																	<buttonpanel:ContentPanelControl id="ContentPanelControl9" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:ContentPanelControl>&nbsp;&nbsp;&nbsp;</TD>
															</TR>
														</TABLE>
													</TD>
			...
			<buttonpanel:pagepanelcontrol id="PagePanelControl1" runat="server" ASPXFileName="d:\efundraising\source\EFundraisingSolution\ScratchcardWeb\Default.aspx"></buttonpanel:pagepanelcontrol></form>
	</body>
</HTML>
