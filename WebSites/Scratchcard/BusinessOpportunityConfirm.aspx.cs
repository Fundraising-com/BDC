...
{
	/// <summary>
	/// Summary description for BusinessOpportunityConfirm.
	/// </summary>
	public class BusinessOpportunityConfirm : ScratchcardWebBase
	{
		...
		{
			ScratchcardOmnitureTracking.SetPageNameAndCategory("Public", "Agent Program Confirmation");
