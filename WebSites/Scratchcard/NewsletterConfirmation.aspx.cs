...
{
	/// <summary>
	/// Summary description for NewsletterConfirmation.
	/// </summary>
	public class NewsletterConfirmation : ScratchcardWebBase
	{
		...
		{
			ScratchcardOmnitureTracking.SetPageNameAndCategory("Public", "Newsletter Confirmation");
			ScratchcardOmnitureTracking.AddEvent_Custom(3);
