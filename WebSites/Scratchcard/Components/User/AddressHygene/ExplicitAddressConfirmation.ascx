<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ExplicitAddressConfirmation.ascx.cs" Inherits="GA.BDC.WEB.ScratchcardWeb.Components.User.AddressHygiene.ExplicitAddressConfirmation" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<br />
				...
				<TR>
					...
					<TD class="NormalText">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td valign="top" class="normal_text">Please confirm:&nbsp;&nbsp;&nbsp;</td>
								<td class="normal_text"><asp:Literal ID="AddressLiteral" Runat="server"></asp:Literal></td>
							</tr>
						</table>
