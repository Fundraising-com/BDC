namespace GA.BDC.WEB.ScratchcardWeb.Components.User.AddressHygiene
{
	using System;
	using System.Data;
   ...
   // public delegate void OutputAddressEventHandler(object sender, OutputAddress outputAddress, bool addressChanged, int nAddress);
	...
	public class AddressHygiene : System.Web.UI.UserControl {
		...
		protected System.Web.UI.WebControls.TextBox Address1TextBox;
		protected System.Web.UI.WebControls.TextBox Address2TextBox;
        ...
        //    addressHygieneSingleMessageRequest.EnableSuggestionList = false;
