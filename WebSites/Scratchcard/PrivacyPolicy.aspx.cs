...
{
	/// <summary>
	/// Summary description for PrivacyPolicy.
	/// </summary>
	public class PrivacyPolicy : ScratchcardWebBase
	{
		...
		{
			ScratchcardOmnitureTracking.SetPageNameAndCategory("Public", "Privacy Policy");
