namespace QSPFulfillment.Reports
{
	...
	/// </summary>
	public class ControlerGroupOnlinePassword : QSPFulfillment.CustomerService.CustomerServiceControl
	{
		...
		protected QSPFulfillment.CommonWeb.RSGeneration rsGenerationGroupOnlinePassword;
		...
		private void btnPreview_Click(object sender, System.EventArgs e)
		{
			...
			if(Validate())
			{
				...
				rsGenerationGroupOnlinePassword.Generate(parameterValues, REPORT_TIMEOUT);
			}
			else
			{
		...
		public ParameterValueCollection GetParameterValueCollection()
		{
			...
			parameterValue = new ParameterValue();
			parameterValue.Name = "iBusiness_Division_ID";
