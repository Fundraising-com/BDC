namespace QSPFulfillment.Reports
{
	...
	/// </summary>
	public class ControlerMagNetSales : QSPFulfillment.CustomerService.CustomerServiceControl
	{
		...
		protected QSPFulfillment.CommonWeb.RSGeneration rsGenerationMagNetSales;
		...
		private void btnPreview_Click(object sender, System.EventArgs e)
		{
			...
			if(Validate())
			{
				...
				rsGenerationMagNetSales.Generate(parameterValues, REPORT_TIMEOUT);
			}
			else
			{
