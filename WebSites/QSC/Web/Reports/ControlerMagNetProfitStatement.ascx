<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ControlerMagNetProfitStatement.ascx.cs" Inherits="QSPFulfillment.Reports.ControlerMagNetProfitStatement" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<div style="TEXT-ALIGN: center">
	<table id="Table1" cellspacing="0" cellpadding="0" width="500" border="0">
		<tr>
			<td><asp:label id="lblTitle" cssclass="CSPageTitle" runat="server"> MagNet Profit Statement Report</asp:label></td>
		</tr>
	</table>
</div>
...
<cc2:rsgeneration id="rsGenerationMagNetProfitStatement" runat="server" reportname="MagNetProfitStatement" mode="PopUp"></cc2:rsgeneration>
