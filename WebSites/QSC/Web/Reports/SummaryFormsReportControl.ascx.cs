namespace QSPFulfillment.Reports
{
	...
	/// <summary>
	/// Form control for SummaryFormsReport
	/// </summary>
	/// <remarks>
	/// Created : Madina Saitakhmetova, 09 Aug 2006
	/// </remarks>
	public partial class SummaryFormsReportControl : QSPFulfillment.AcctMgt.Control.AcctMgtControl
	{
		...
		private void RenderReport() 
		{
			...
			SummaryFormBatchReport oSummaryFormBatchReport = new SummaryFormBatchReport();
			result = oSummaryFormBatchReport.Generate(CampaignID, AccountID, FMID, StartDate, EndDate, ApprovedStatusDateFrom, ApprovedStatusDateTo);
