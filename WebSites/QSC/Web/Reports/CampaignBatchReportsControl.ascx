...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="CampaignBatchReportsControl.ascx.cs" Inherits="QSPFulfillment.Reports.CampaignBatchReportsControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<div style="TEXT-ALIGN: center">
	<table id="Table1" cellspacing="0" cellpadding="0" width="500" border="0">
		<tr>
			<td><asp:label id="lblTitle" runat="server" cssclass="CSPageTitle"> CA Batch Reports</asp:label></td>
		</tr>
	</table>
	<br>
