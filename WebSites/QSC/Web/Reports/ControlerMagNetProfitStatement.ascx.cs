namespace QSPFulfillment.Reports
{
	...
	/// </summary>
	public class ControlerMagNetProfitStatement : QSPFulfillment.CustomerService.CustomerServiceControl
	{
		...
		protected QSPFulfillment.CommonWeb.RSGeneration rsGenerationMagNetProfitStatement;
		...
		private void btnPreview_Click(object sender, System.EventArgs e)
		{
			...
			if(Validate())
			{
				...
				rsGenerationMagNetProfitStatement.Generate(parameterValues, REPORT_TIMEOUT);
			}
			else
			{
