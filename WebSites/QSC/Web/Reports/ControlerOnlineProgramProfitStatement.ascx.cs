namespace QSPFulfillment.Reports
{
	...
	/// </summary>
	public class ControlerOnlineProgramProfitStatement : QSPFulfillment.CustomerService.CustomerServiceControl
	{
		...
		protected QSPFulfillment.CommonWeb.RSGeneration rsGenerationOnlineProgramProfitStatement;
		...
		private void btnPreview_Click(object sender, System.EventArgs e)
		{
			...
			if(Validate())
			{
				...
				rsGenerationOnlineProgramProfitStatement.Generate(parameterValues, REPORT_TIMEOUT);
			}
			else
			{
