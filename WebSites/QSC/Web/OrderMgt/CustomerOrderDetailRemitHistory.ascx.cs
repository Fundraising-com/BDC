namespace QSPFulfillment.OrderMgt
{
	...
	/// <summary>
	///		Summary description for CustomerRemitBatch.
	/// </summary>
	public partial  class CustomerOrderDetailRemitHistory : System.Web.UI.UserControl
	{
		...
		protected void List_DataBinding(object sender, System.EventArgs e)
		{
			...
			DG1.DataSource = ds;
			DG1.DataBind();
			DG1.DataMember = "CustomerOrderDetailRemitHistory";
		}
	}
}
