<%@ Page language="c#" Codebehind="PrintMagQueue.aspx.cs" AutoEventWireup="True" Inherits="QSPFulfillment.OrderMgt.PrintMagQueue" %>
	...
	<body leftmargin=0 topmargin=0>
		<CENTER>
			<form id="Form1" method="post" runat="server">
				...
				<P>
					<STRONG><FONT size="3">Magazine Orders Available for Printing</FONT></STRONG></P>
				...
				<asp:Button id="Button1" runat="server" Text="Print Reports" CssClass="Button4" onclick="Button1_Click"></asp:Button>
			</form>
		</CENTER>
	</body>
</HTML>
