...
{
	///<summary>DailySales.</summary>
	public partial class DailySales : QSPFulfillment.CommonWeb.QSPPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				cmd = new SqlCommand("GetMagByUMC", cnMags);
			...
			finally
			{
				...
				cmd2 = new SqlCommand("GetLastYrSubsYTD", cnMags);
...

				{
						...
						//if(reader2["subs"] == System.DBNull.Value)

							//this.lblLastYrYTDSubs.Text = "0";
							//SubsLastYr = 0;
				...
				cmd3 = new SqlCommand("GetCurYrSubsYTD", cnMags);
				...
				SqlCommand cmdCurYr = new SqlCommand("GetWeeklySalesNumbersByTitle", cnMags);
				...
				SqlCommand cmdPriorYr = new SqlCommand("GetWeeklySalesNumbersByTitlePriorYr", cnMags);
				...
				SqlCommand cmdTwoAgo = new SqlCommand("GetWeeklySalesNumbersByTitleTwoYrsAgo", cnMags);
...

		{
			if(e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
				...
				CalcTotalDolrs ( e.Item.Cells[3].Text );
				e.Item.Cells[3].Text = string.Format("{0:c}", Convert.ToDouble(e.Item.Cells[3].Text));
				e.Item.Cells[4].Text = string.Format("{0:#,###}", Convert.ToDouble(e.Item.Cells[4].Text));

			}
			else if(e.Item.ItemType == ListItemType.Footer )
			{
				e.Item.Cells[1].Text="Totals";
				e.Item.Cells[2].Text = string.Format("{0:#,###}", runningTotal);
				e.Item.Cells[3].Text= string.Format("{0:c}", runningDolrs);
