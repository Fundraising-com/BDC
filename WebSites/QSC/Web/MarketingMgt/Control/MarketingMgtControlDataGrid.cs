...
namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public class MarketingMgtControlDataGrid:MarketingMgtControl
	{
		...
		protected virtual void OnInit(EventArgs e,DataGridObject Grid,Label LabelMessage)
		{
			this.dtgMain = Grid;
		...
		public virtual bool HandleCommands 
		{
			get 
			{
				return false;
