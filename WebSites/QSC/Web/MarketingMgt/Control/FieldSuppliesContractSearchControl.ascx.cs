namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public class FieldSuppliesContractSearchControl : ProductContractSearchControl
	{
		...
		private const int COLUMN_CATALOG_CODE = 18;
		private const int COLUMN_CATALOG_NAME = 19;
		private const int COLUMN_SELECT = 21;
		private const int COLUMN_DELETE = 22;
		private const int COLUMN_MODIFY = 23;
