<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AllTypesProductSearchControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.AllTypesProductSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
						...
						<td valign="top">
							<table id="Table1" cellspacing="0" cellpadding="2" width="100%" border="0">
								<tr>
									...
									<td width="216" valign="bottom" style="WIDTH: 216px"><asp:label id="Label3s" runat="server" cssclass="CSPlainText">Name</asp:label><br>
...
<asp:label id="lblMessage" runat="server"></asp:label><cc2:datagridobject id="dtgMain" runat="server" autogeneratecolumns="False" borderwidth="1px" borderstyle="None"
	...
	<columns>
		...
		<asp:templatecolumn headertext="Product Type">
			<itemtemplate>
				<asp:label id="lblProductTypeDescription" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.ProductTypeDescription") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
