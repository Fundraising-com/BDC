namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public partial class IncentivesCumulativeMaintenanceControl : ProductMaintenanceControl
	{
		...
		protected override string PrizeLevel
		{
			get
			{
				return this.tbxPrizeLevel.Text;
			}
			set
			{
				this.tbxPrizeLevel.Text = value;
			}
		}
		...
		protected override int PrizeLevelQuantity
		{
			get
			{
				return this.tbxPrizeLevelQuantity.Value;
			}
			set
			{
				this.tbxPrizeLevelQuantity.Value = value;
			}
		}
