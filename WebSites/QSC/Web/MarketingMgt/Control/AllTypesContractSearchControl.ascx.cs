namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public class AllTypesContractSearchControl : ProductContractSearchControl
	{
		...
		{
			return ProductContractIDFactory.Instance.GetProductContractID(GetMagPriceInstance(e), GetMagPriceInstanceHST(e), GetProductContractType(e));
		}
