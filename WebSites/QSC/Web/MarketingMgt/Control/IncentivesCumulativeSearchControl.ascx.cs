namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public class IncentivesCumulativeSearchControl : ProductSearchControl
	{
		private const int COLUMN_DELETE = 12;
		private const int COLUMN_SELECT = 13;
		private const int COLUMN_EDIT = 14;
