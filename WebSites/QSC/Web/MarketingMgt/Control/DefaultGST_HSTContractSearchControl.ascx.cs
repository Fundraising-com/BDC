namespace QSPFulfillment.MarketingMgt.Control
{
	...
	/// </summary>
	public class DefaultGST_HSTContractSearchControl : ProductContractSearchControl
	{
		private const int COLUMN_CHECKBOX = 0;
		private const int COLUMN_PRODUCTCODEEDIT = 1;
		private const int COLUMN_YEAR = 6;
		private const int COLUMN_SEASON = 7;
		private const int COLUMN_PRODUCT_STATUS = 8;
		private const int COLUMN_CATALOG_CODE = 13;
		private const int COLUMN_CATALOG_NAME = 14;
		private const int COLUMN_SELECT = 16;
		private const int COLUMN_DELETE = 17;
		private const int COLUMN_MODIFY = 18;
