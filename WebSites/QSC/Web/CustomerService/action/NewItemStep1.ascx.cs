namespace QSPFulfillment.CustomerService.action
{
	...
	/// </summary>
	public partial class NewItemStep1 : CustomerServiceActionControl
	{
		...
		{
			this.PreRender += new System.EventHandler(this.NewItemStep1_PreRender);

		}
		#endregion

		protected void NewItemStep1_PreRender(object sender, EventArgs e)
		{
			this.Page.Message = "Please select a product in the list";
		}
