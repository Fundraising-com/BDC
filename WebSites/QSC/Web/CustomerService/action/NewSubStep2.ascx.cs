namespace QSPFulfillment.CustomerService.action
{
	...
	/// </summary>
	public partial class NewSubStep2 : NewItemStepControl
	{
		...
		{			
			NewSubcription newsub = new NewSubcription(this.Page.OrderInfo.CampaignID, this.MagazineInfo.MagInstance, GetNewRenewal(),GetPrice(),GetOverrideCode(),this.Page.CustomerInfo.CustomerInstance, this.MagazineInfo.Price, this.Page.UserID, GetFirstName(), GetLastName(), GetAddress1(), GetAddress2(), GetCity(), GetProvince(), GetPostalCode());
		
			this.Page.BusCustomerOrderDetail.NewItem(newsub, 46001, 39008, this.Page.OrderInfo.CustomerOrderHeaderInstance, this.Page.OrderInfo.TransID);
		}
		...
		{
			return this.ddlNewRenewal.SelectedItem.Value;
		}
		...
		{	
			...
			this.tbxPrice.Text =String.Format("{0:N2}", this.MagazineInfo.Price);
		}
