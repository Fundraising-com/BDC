...
namespace QSPFulfillment.CustomerService.action
{
	...
	/// </summary>
	public partial class NewSubToInvoice : NewItemControl
	{
		...
		protected const string MSG_HEADER = "New subscription to invoice";
		...
		protected override void DoAction()
		{
			...
			this.Page.BusCustomerOrderDetail.NewItem(newsub, 46001, 39020, this.Page.OrderInfo.CustomerOrderHeaderInstance, this.Page.OrderInfo.TransID);
