<%@ Control Language="c#" AutoEventWireup="false" Codebehind="InactiveMagazineLetterBatchMaintenanceControl.ascx.cs" Inherits="QSPFulfillment.CustomerService.InactiveMagazineLetterBatchMaintenanceControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="cc4" Namespace="QSP.WebControl" Assembly="QSP.WebControl" %>
...
<script language="javascript">
	...
	function SetTitleCodeLetterBatchMaintenanceControl(Code,Description)
	{
		var tbxTitleCode = document.getElementById('ctrlLetterBatchMaintenanceControl_tbxTitleCode');
							...
							<table id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<tr>
									<td><asp:label id="Label1s" runat="server" cssclass="CSPlainText"> Template</asp:label><br>
										<cc2:lettertemplateselectiondropdownlist id="ddlLetterTemplateSearch" runat="server" AutoPostBack="true" Required="False"
											InitialValue="-1" InitialText="Please select..."></cc2:lettertemplateselectiondropdownlist></td>
									...
									<td>
										<asp:label id="Label11" runat="server" CssClass="csPlainText">Title Code</asp:label><br>
										<cc4:textboxsearch id="tbxTitleCode" runat="server" ContentType="string" ParameterName="sTitleCode"></cc4:textboxsearch><A id="A1" onclick="javascript:Open('Magazine.aspx?IsNewWindow=true&amp;ID=true&amp;Fct=SetTitleCodeLetterBatchMaintenanceControl&amp;SwitchLetter=true&amp;IsOnlyMagazine=true')"
											href="javascript:;" runat="server"><IMG alt="Find" src="images/find.gif" border="0"></A></td>
									<td vAlign="bottom"><asp:button id="btnSearch" runat="server" cssclass="boxlook" text="Search"></asp:button></td>
								</tr>
								<tr>
									<td><asp:label id="Label3s" runat="server" cssclass="CSPlainText">Type</asp:label><br>
										<cc3:dropdownlistinteger id="ddlLetterBatchTypeSearch" InitialValue="-1" InitialText="Please select..." Runat="server"></cc3:dropdownlistinteger></td>
									...
									<td><asp:label id="Label10" runat="server" cssclass="csPlainText">Reason</asp:label><br>
										<cc3:dropdownlistinteger id="ddlReason" Runat="server">
											<asp:ListItem Value="-1" Selected="True">Please select...</asp:ListItem>
											<asp:ListItem Value="1000">Magazine no longer available</asp:ListItem>
											<asp:ListItem Value="1001">Magazine ceased publication</asp:ListItem>
										</cc3:dropdownlistinteger></td>
									<td valign="bottom">
										...
										<asp:datagrid id="dtgMain" runat="server" cellpadding="3" backcolor="White" borderwidth="1px"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Title Code">
													<ItemTemplate>
														<asp:Label id="Label12" Runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductCode") %>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:BoundColumn DataField="ReasonDescription" HeaderText="Reason"></asp:BoundColumn>
												<asp:TemplateColumn HeaderText="Reason" Visible="False">
													<ItemTemplate>
														<asp:Label id="Label13" Runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Reason") %>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn Visible="False">
