<%@ Page language="c#" Codebehind="SearchParticipantListingReport.aspx.cs" AutoEventWireup="false" Inherits="QSPFulfillment.Finance.SearchParticipantListingReport" %>
<%@ Register TagPrefix="cc2" Namespace="QSPFulfillment.CommonWeb" Assembly="QSPFulfillment"  %>
<%@ Register TagPrefix="cc1" Namespace="skmMenu" Assembly="skmMenu"  %>
<html>
	<head>
		<title>CA Fulfill System - Participant Listing Report</title>
	...
	<body topmargin="0" leftmargin="0">
		<form method="post" runat="server" id="StatementForm">
			...
			<br>
			<center><h3><font face="Verdana" color="#2f4f88">Participant Listing Report</font></h3>
			</center>
			<p></p>
			<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
				<tr>
					...
					<td>
						<asp:label runat="server" id="lblListing" cssclass="ClearTextBoxG" />
					</td>
				</tr>
			</table>
			<table border="0" cellspacing="0" cellpadding="2" width="100%" align="center">
				<tr>
					<td>
						<asp:datagrid onitemdatabound="ParticipantListingReportDG_ItemDataBound" id="ParticipantListingReportDG"
							headerstyle-font-bold="True" allowsorting="true" onsortcommand="ParticipantListingReportDG_Sort"
							...
							pagerstyle-backcolor="#2f4f88" pagerstyle-forecolor="white" onpageindexchanged="ParticipantListingReportDG_Page"
							...
							<columns>
								<asp:templatecolumn headerstyle-verticalalign="Top" itemstyle-verticalalign="Top" headertext="Order ID"
									...
									<itemtemplate>
										...
										<cc2:rsgenerationlinkbutton id="rsGenerationParticipantListing" runat="server" causesvalidation="false" font-underline="True"
											forecolor="RoyalBlue" />
									</itemtemplate>
								</asp:templatecolumn>
