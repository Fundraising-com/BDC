...
<%@ Page language="c#" Codebehind="AgingReportByFM.aspx.cs" AutoEventWireup="false" Inherits="QSPFulfillment.Finance.AgingReportForFM" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<!-- #include file="../Includes/Menu.inc" --><asp:label id="lblAgingReportForFM" style="Z-INDEX: 100; LEFT: 48px; POSITION: absolute; TOP: 40px"
				runat="server" width="368px" font-size="Large" font-names="Verdana"> Aging Report For  FM</asp:label>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 48px; WIDTH: 704px; POSITION: absolute; TOP: 112px; HEIGHT: 109px"
				...
				<TR>
					<TD style="WIDTH: 107px">
						<asp:label id="lblAccountFM" runat="server" Font-Names="verdana" Font-Bold="True" Font-Size="X-Small">Group FM</asp:label></TD>
			...
			<cc2:rsgeneration id="rsGenerationAgingReportByFM" runat="server" reportname="AgingReportByFMID"></cc2:rsgeneration></form>
	</body>
</HTML>
