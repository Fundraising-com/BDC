...
namespace DAL
{
	...
	/// </summary>
	public class AdjustmentTypeData : DBTableOperation
	{
		...
		/// </summary>
		public AdjustmentTypeData() : base(DataBaseName.QSPCanadaFinance) { }
		//----------------------------------------------------------------
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_AdjustmentType_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			Select(cmdToExecute,dtsDataSet, tableName);
		}
		...
		/// <remarks>
		/// </remarks>
		public  void SelectAllForBatches(DataSet dtsDataSet, string tableName)		
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_AdjustmentType_SelectAllForBatches]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			Select(cmdToExecute,dtsDataSet, tableName);
		}
	}
