...
namespace DAL
{
	...
	public class ConnectionProvider : IDisposable
	{
		...
		public static string ConnStrWithNoDataBase = QSPFulfillment.DataAccess.Common.ApplicationConfiguration.ConnectionString;
		#endregion


		public ConnectionProvider() : this(DataBaseName.QSPCanadaOrderManagement) { }

		public ConnectionProvider(DataBaseName DBName)
		{
			// Init the class
			InitClass(DBName);
		}
		...
		/// </summary>
		private void InitClass(DataBaseName DBName)
		{
