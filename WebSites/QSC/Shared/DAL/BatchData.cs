...
namespace DAL
{
	...
	/// </summary>
	public class BatchData : DBTableOperation
	{
		#region Class Member Declarations
		
		private const string PARAM_CAMPAIGNID = "@iCampaignID";
		private const string PARAM_ORDERQUALIFIERID = "@iOrderQualifierID";
		...
		/// </summary>
		public BatchData() : base(DataBaseName.QSPCanadaOrderManagement) { }
		//----------------------------------------------------------------
		...
		/// </remarks>
		public  void SelectOne(DataSet dtsDataSet, string tableName, int ID, DateTime Date)		
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_Batch_SelectOne]";
		...
		/// <remarks>
		/// </remarks>
		public  void SelectAllByCampaignIDAndOrderQualifierID(DataSet dtsDataSet, string tableName, int CampaignID, int OrderQualifierID)		
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[pr_Batch_SelectAllByCampaignIDAndOrderQualifierID]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_CAMPAIGNID, SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, CampaignID));
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_ORDERQUALIFIERID, SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, OrderQualifierID));
			Select(cmdToExecute,dtsDataSet, tableName);
		}
	}
}