...
namespace QSPFulfillment.DataAccess.Common.TableDef
{
	...
	public class PublisherContactProductTable: CommonTable
	{
		public const string TBL_PUBLISHERCONTACT_PRODUCT = "PublisherContact_Product";
		public const string FLD_ID= "ID";
		public const string FLD_PUBLISHERCONTACTID= "PublisherContactID";
		...
		/// </summary>
		public PublisherContactProductTable()
		{
			//
		...
		/// </summary>
		public PublisherContactProductTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{
		}	
		//----------------------------------------------------------------
		// Sub BuildDataTable:
		...
		private void BuildDataTable()
		{
			...
			//
			this.TableName =TBL_PUBLISHERCONTACT_PRODUCT;
			DataColumnCollection columns = this.Columns;
			DataColumn Column = columns.Add(FLD_ID, typeof(Int32));
			Column.AllowDBNull = false;
			Column.DefaultValue = 0;
			columns.Add(FLD_PUBLISHERCONTACTID, typeof(Int32));
