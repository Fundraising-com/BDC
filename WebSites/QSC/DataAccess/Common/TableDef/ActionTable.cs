...
namespace QSPFulfillment.DataAccess.Common.TableDef
{
	...
	public class ActionTable: CommonTable
	{
		public const string TBL_ACTION= "Action";
		...
		public const string FLD_COMMNENTSISREQUIRED = "CommentsIsRequired";
		/// <summary>
		...
		/// </summary>
		public ActionTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{
		}	
		//----------------------------------------------------------------
		// Sub BuildDataTable:
		//   Creates the following datatable:Action//----------------------------------------------------------------
		private void BuildDataTable()
		{
			//
			// Create the Action
			//
			this.TableName =TBL_ACTION;
			...
			columns.Add(FLD_MESSAGE,typeof(string));
			SetConstraint();
		}
