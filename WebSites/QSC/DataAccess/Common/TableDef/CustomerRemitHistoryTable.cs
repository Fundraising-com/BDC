...
namespace QSPFulfillment.DataAccess.Common.TableDef
{
	...
	public class CustomerRemitHistoryTable: CommonTable
	{
		public const string TBL_CUSTOMERREMITHISTORY= "CustomerRemitHistory";
		...
		/// </summary>
		public CustomerRemitHistoryTable()
		{
			//
		...
		/// </summary>
		public CustomerRemitHistoryTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{
		}	
		//----------------------------------------------------------------
		// Sub BuildDataTable:
		//   Creates the following datatable:CustomerRemitHistory//----------------------------------------------------------------
		private void BuildDataTable()
		{
			//
			// Create the CustomerRemitHistory
			//
			this.TableName =TBL_CUSTOMERREMITHISTORY;
			DataColumnCollection columns = this.Columns;
			DataColumn Column = columns.Add(FLD_REMITBATCHID, typeof(Int32));
		...
		{
			this.PrimaryKey = new DataColumn[]{Columns[FLD_REMITBATCHID],Columns[FLD_INSTANCE]};
		}
	}
}