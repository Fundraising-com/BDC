...
[System.ComponentModel.DesignerCategory("Code")]
	...
	public class CommunicationSourceTable: CommonTable
{
public const string TBL_COMMUNICATIONSOURCE= "CommunicationSource";
...
/// </summary>
public CommunicationSourceTable()
{
	//
...
/// </summary>
public CommunicationSourceTable(SerializationInfo info, StreamingContext context) : base(info, context) 
{
}	
//----------------------------------------------------------------
// Sub BuildDataTable:
//   Creates the following datatable:CommunicationSource//----------------------------------------------------------------
private void BuildDataTable()
{
	//
	// Create the CommunicationSource
	//
	this.TableName =TBL_COMMUNICATIONSOURCE;
