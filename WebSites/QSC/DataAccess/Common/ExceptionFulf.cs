...
namespace QSPFulfillment.DataAccess.Common
{
	...
	/// </summary>
	public class ExceptionFulf: ApplicationException
	{
		private string htmlMessage = "";		
		
		public ExceptionFulf()
		{
			//
			// TODO: Add constructor logic here
			//
		}
		public ExceptionFulf(string message): base(message)
		{
		}
		public ExceptionFulf(string message, string HTMLMessage): base(message)
		{
			htmlMessage = HTMLMessage;
		}
		public ExceptionFulf(string message, Exception inner): base(message, inner)
		{
		}
		public ExceptionFulf(string message, string HTMLMessage, Exception inner): base(message, inner)
		{
			htmlMessage = HTMLMessage;			
		}
		public ExceptionFulf(Message messageManager, Exception inner): base(messageManager.ErrorMessage, inner)
		{
			this.HTMLMessage = messageManager.ErrorHTMLMessage;			
		}
		public ExceptionFulf(Message messageManager)
		{
			this.HTMLMessage = messageManager.ErrorHTMLMessage;			
		}
	...
	/// Summary description for QCAPException.
	/// </summary>
	public class ValidationException: ExceptionFulf
	{
