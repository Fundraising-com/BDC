...
namespace QSPFulfillment.DataAccess.PaymentSystem {
    using System;
    ...
    public partial class BatchPaymentSystemWebservice : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public BatchPaymentSystemWebservice() {
            this.Url = System.Configuration.ConfigurationSettings.AppSettings["PaymentSystemURL"];
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAuthRealTime(
                    int ApplicationId, 
                    string CustomerFirstName, 
                    string CustomerLastName, 
                    string CustomerStreet1, 
                    ...
                    object asyncState) {
            return this.BeginInvoke("AuthRealTime", new object[] {
                        ApplicationId,
                        CustomerFirstName,
                        CustomerLastName,
                        CustomerStreet1,
                        ...
                        Descriptor,
                        ClientTransactionId,
                        AppGUID}, callback, asyncState);
        }
        
        /// <remarks/>
        public BPPSTxResponse EndAuthRealTime(System.IAsyncResult asyncResult) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAuthDepositRealTime(
                    int ApplicationId, 
                    string CustomerFirstName, 
                    string CustomerLastName, 
                    string CustomerStreet1, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("AuthDepositRealTime", new object[] {
                        ApplicationId,
                        CustomerFirstName,
                        CustomerLastName,
                        CustomerStreet1,
        ...
        /// <remarks/>
        public BPPSTxResponse EndAuthDepositRealTime(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAuthDepositRealTimeString(
                    int ApplicationId, 
                    string CustomerFirstName, 
                    string CustomerLastName, 
                    string CustomerStreet1, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("AuthDepositRealTimeString", new object[] {
                        ApplicationId,
                        CustomerFirstName,
                        CustomerLastName,
                        CustomerStreet1,
        ...
        /// <remarks/>
        public string EndAuthDepositRealTimeString(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAuthDepositBatch(
                    int ApplicationId, 
                    string CustomerFirstName, 
                    string CustomerLastName, 
                    string CustomerStreet1, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("AuthDepositBatch", new object[] {
                        ApplicationId,
                        CustomerFirstName,
                        CustomerLastName,
                        CustomerStreet1,
        ...
        /// <remarks/>
        public BPPSTxResponse EndAuthDepositBatch(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginDeposit(int ApplicationId, string AppGuid, int ReferringBPPSTxId, int TransactionAmount, string LineItemDescription, string Descriptor, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public BPPSTxResponse EndDeposit(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginFetchResponse(int ApplicationId, string AppGuid, int ReferringBPPSTxId, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("FetchResponse", new object[] {
                        ApplicationId,
                        AppGuid,
                        ReferringBPPSTxId}, callback, asyncState);
        }
        
        /// <remarks/>
        public BPPSTxResponse EndFetchResponse(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRefundPrevious(int ApplicationId, string AppGuid, int ReferringBPPSTxId, int TransactionAmount, string LineItemDescription, string Descriptor, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("RefundPrevious", new object[] {
                        ApplicationId,
                        AppGuid,
                        ReferringBPPSTxId,
                        TransactionAmount,
        ...
        /// <remarks/>
        public BPPSTxResponse EndRefundPrevious(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRefund(
                    int ApplicationId, 
                    string AppGuid, 
                    string CustomerFirstName, 
                    string CustomerLastName, 
        ...
        /// <remarks/>
        public BPPSTxResponse EndRefund(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((BPPSTxResponse)(results[0]));
        }
