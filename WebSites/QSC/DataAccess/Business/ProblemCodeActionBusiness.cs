namespace QSPFulfillment.DataAccess.Business
{
	...
	///     collection Day.
	/// </summary>
	public class ProblemCodeActionBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		dataAccessRef dataAccess = new dataAccessRef();
		public ProblemCodeActionBusiness(Message MessageManager):base(MessageManager)
		{
		
		}
		public ProblemCodeActionBusiness(bool AsMessageManager):base(AsMessageManager)
		{
