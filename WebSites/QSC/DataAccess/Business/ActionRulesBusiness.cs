namespace QSPFulfillment.DataAccess.Business
{
	...
	using dataAccessRef =QSPFulfillment.DataAccess.Data.ActionRulesData;
	using QSPFulfillment.DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class ActionRulesBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		...
		{
			bool IsValid = true;
			IsValid &= IsValid_RequiredField(Row,tableRef.FLD_ACTIONINSTANCE,"ActionInstance");
			IsValid &= IsValid_RequiredField(Row,tableRef.FLD_UNIQUE,"Unique");
			if (!IsValid)
			{
		...
		public override DBInteractionBase DataAccessReference
		{
