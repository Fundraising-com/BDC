namespace QSPFulfillment.DataAccess.Business
{
	...
	using tableRef = QSPFulfillment.DataAccess.Common.TableDef.IncidentStatusTable;
	using dataAccessRef =QSPFulfillment.DataAccess.Data.IncidentStatusData;
	using QSPFulfillment.DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class IncidentStatusBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		dataAccessRef dataAccess = new dataAccessRef();
		public IncidentStatusBusiness(Message MessageManager):base(MessageManager)
		{
		
		}
		public IncidentStatusBusiness(bool AsMessageManager):base(AsMessageManager)
		{
