namespace QSPFulfillment.DataAccess.Business
{
	...
	using tableRef = QSPFulfillment.DataAccess.Common.TableDef.ActionsTable;
	using dataAccessRef =QSPFulfillment.DataAccess.Data.ActionsData;
	using QSPFulfillment.DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class ActionsBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		...
		public void SelectSearch(DataTable Table,int SearchType,string SearchCriteria)
		{
			...
			{	
				ManageError(ex);
				//SetErrorMessageSelect(ERRMSG_SELECT);
			}
		}
