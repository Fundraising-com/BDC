namespace QSPFulfillment.DataAccess.Business
{
	...
	using dataAccessRef =QSPFulfillment.DataAccess.Data.CommunicationSourceData;
	using QSPFulfillment.DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class CommunicationSourceBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		dataAccessRef dataAccess = new dataAccessRef();
		public CommunicationSourceBusiness(Message MessageManager):base(MessageManager)
		{
		
		}
		public CommunicationSourceBusiness(bool AsMessageManager):base(AsMessageManager)
		{
