namespace QSPFulfillment.DataAccess.Business
{
	...
	using tableRef = QSPFulfillment.DataAccess.Common.TableDef.CustomerRemitHistoryAuditTable;
	using dataAccessRef =QSPFulfillment.DataAccess.Data.CustomerRemitHistoryAuditData;
	using DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class CustomerRemitHistoryAuditBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		dataAccessRef dataAccess = new dataAccessRef();
		public CustomerRemitHistoryAuditBusiness(Message MessageManager):base(MessageManager)
		{
		
		}
		public CustomerRemitHistoryAuditBusiness(bool AsMessageManager):base(AsMessageManager)
		{
		...
		private bool IsValids_FieldLength(DataRow Row)
		{
			...
			isValid &= IsValid_FieldLength(Row, tableRef.FLD_ADDRESS1,"Address", tableRef.FLD_ADDRESS1_LENGTH);
