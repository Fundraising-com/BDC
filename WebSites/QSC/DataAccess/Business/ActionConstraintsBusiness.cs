namespace QSPFulfillment.DataAccess.Business
{
	...
	using dataAccessRef =QSPFulfillment.DataAccess.Data.ActionConstraintsData;
	...
	///     collection Day.
	/// </summary>
	public class ActionConstraintsBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		...
		{
			bool IsValid = true;
			IsValid &= IsValid_RequiredField(Row,tableRef.FLD_CURRENTSTATUS,"CurrentStatus");
			IsValid &= IsValid_RequiredField(Row,tableRef.FLD_ACTIONINSTANCETOBEPERFORMED,"ActionInstanceToBePerformed");
			if (!IsValid)
			{
