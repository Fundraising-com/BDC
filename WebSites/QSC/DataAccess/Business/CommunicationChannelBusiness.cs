namespace QSPFulfillment.DataAccess.Business
{
	...
	using tableRef = QSPFulfillment.DataAccess.Common.TableDef.CommunicationChannelTable;
	using dataAccessRef =QSPFulfillment.DataAccess.Data.CommunicationChannelData;
	using QSPFulfillment.DataAccess.Common;
	/// <summary>
	///     This class contains the business rules that are used for a 
	///     collection Day.
	/// </summary>
	public class CommunicationChannelBusiness : QSPFulfillment.DataAccess.Business.BusinessSystem
	{
		dataAccessRef dataAccess = new dataAccessRef();
		public CommunicationChannelBusiness(Message MessageManager):base(MessageManager)
		{
		
		}
		public CommunicationChannelBusiness(bool AsMessageManager):base(AsMessageManager)
		{
		...
		{
			bool isValid = true;
			isValid &= IsValid_FieldLength(Row, tableRef.FLD_DESCRIPTION,"", tableRef.FLD_DESCRIPTION_LENGTH);
			return isValid;
		}
