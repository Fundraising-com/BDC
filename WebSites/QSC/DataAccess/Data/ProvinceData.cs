...
namespace QSPFulfillment.DataAccess.Data
{
	...
	/// </summary>
	internal class ProvinceData : QSPFulfillment.DataAccess.Data.DBTableOperation
	{
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "QSPCanadaCommon.dbo.[pr_Province_SelectByCountryCode]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
