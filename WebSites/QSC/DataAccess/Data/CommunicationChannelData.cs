///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'CommunicationChannel'
// Generated by LLBLGen v1.2.1635.19725 Final
// on: Wednesday, June 23, 2004, 3:58:41 PM
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'CommunicationChannel'.
	/// </summary>
	public class CommunicationChannelData : QSPFulfillment.DataAccess.Data.DBTableOperation
	{
...
private SqlCommand updateCommand;
		...
		/// </summary>
		public CommunicationChannelData()
		{
			// Nothing for now.
		}
//----------------------------------------------------------------
...
protected override SqlCommand GetInsertCommand()
{
	if ( insertCommand == null )
	{
		...
		// 
		insertCommand = new SqlCommand("dbo.[pr_CommunicationChannel_Insert]");
...
protected override SqlCommand GetDeleteCommand()
{
	if ( deleteCommand == null )
	{
		...
		// Construct the command since we don't have it already
		//
		deleteCommand = new SqlCommand("dbo.[pr_CommunicationChannel_Delete]");
...
protected override SqlCommand GetUpdateCommand()
{
	if ( updateCommand == null )
	{
		...
		// Construct the command since we don't have it already
		//
		updateCommand = new SqlCommand("dbo.[pr_CommunicationChannel_Update]");
...
{
get{return tableRef.TBL_COMMUNICATIONCHANNEL;
}
}
public void SelectSearch(DataTable Table,int SearchType,string SearchCriteria)
{
SqlCommand	cmdToExecute = new SqlCommand();
cmdToExecute.CommandText = "dbo.pr_CommunicationChannel_Search";
...
Select(cmdToExecute,Table);
		...
		public  void SelectOne(DataTable Table, Int32 Instance)		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_CommunicationChannel_SelectOne]";
...
Select(scmCmdToExecute,Table);
		...
		public  void SelectAll(DataTable Table)		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_CommunicationChannel_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
Select(scmCmdToExecute,Table);
			}
	}
