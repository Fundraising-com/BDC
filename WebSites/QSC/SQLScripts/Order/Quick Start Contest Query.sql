...
WHERE		campCurrent.DateSubmitted BETWEEN '2015-08-15' AND '2015-10-10'
...
(
	...
	JOIN		FieldManager fm ON fm.FMID = campCurrent.FMID
	JOIN		Campaign campLastYear ON campLastYear.BillToAccountID = campCurrent.BillToAccountID AND campLastYear.Status = 37002 AND campLastYear.StartDate BETWEEN '2014-07-01' AND '2015-06-30'
...
ORDER BY	campCurrent.BillToAccountID
