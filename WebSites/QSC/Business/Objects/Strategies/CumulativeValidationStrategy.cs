...
{
   /// <summary>
   /// Summary description for CumulativeValidationStrategy.
   /// </summary>
   internal class CumulativeValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Cumulative";

        internal CumulativeValidationStrategy(Message messageManager) : base(messageManager) { }
...
//			}
            ...
            {
                CurrentMessageManager.Add(CurrentMessageManager.FormatErrorMessage(Message.ERRMSG_PROGRAM_CANNOT_BE_RUN_WITH_2, new string[] { PROGRAM_NAME, "Large Chart (Pick-A-Prize) with Num's" }));
                isValid = false;
            }
