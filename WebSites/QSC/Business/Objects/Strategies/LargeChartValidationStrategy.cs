...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class LargeChartValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Large Chart (Pick-A-Prize)";

        internal LargeChartValidationStrategy(Message messageManager) : base(messageManager) { }
