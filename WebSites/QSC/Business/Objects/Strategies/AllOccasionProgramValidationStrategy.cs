...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class AllOccasionValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "All Occasion Program";

		internal AllOccasionValidationStrategy(Message messageManager) : base(messageManager) { }
