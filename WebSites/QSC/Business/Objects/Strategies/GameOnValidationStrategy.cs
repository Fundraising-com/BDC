...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class GameOnValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Cumulative (Game On)";

        internal GameOnValidationStrategy(Message messageManager) : base(messageManager) { }
