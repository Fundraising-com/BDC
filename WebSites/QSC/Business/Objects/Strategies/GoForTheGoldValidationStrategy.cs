...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class GoForTheGoldValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Cumulative (Go For The Gold)";

        internal GoForTheGoldValidationStrategy(Message messageManager) : base(messageManager) { }
