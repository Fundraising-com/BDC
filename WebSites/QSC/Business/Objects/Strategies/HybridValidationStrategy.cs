...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
    internal class HybridValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Hybrid";

        internal HybridValidationStrategy(Message messageManager) : base(messageManager) { }
