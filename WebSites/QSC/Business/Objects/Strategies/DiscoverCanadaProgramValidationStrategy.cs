...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class DiscoverCanadaProgramValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Discover Canada";

		internal DiscoverCanadaProgramValidationStrategy(Message messageManager) : base(messageManager) { }
