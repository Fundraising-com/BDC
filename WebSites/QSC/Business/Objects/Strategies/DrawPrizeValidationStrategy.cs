...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class DrawPrizeValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Draw Prize";

		internal DrawPrizeValidationStrategy(Message messageManager) : base(messageManager) { }
