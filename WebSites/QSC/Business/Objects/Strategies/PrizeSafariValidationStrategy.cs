...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class PrizeSafariValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Cumulative (Prize Safari)";

		internal PrizeSafariValidationStrategy(Message messageManager) : base(messageManager) { }
