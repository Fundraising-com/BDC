...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class GiftOnlyProgramValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Gift Only";

		internal GiftOnlyProgramValidationStrategy(Message messageManager) : base(messageManager) { }
