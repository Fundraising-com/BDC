...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class BearProgramValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "BEAR Program";

		internal BearProgramValidationStrategy(Message messageManager) : base(messageManager) { }
		...
		internal override bool Validate(Business.Objects.CampaignProgram campaignProgram, CampaignProgramDataSet dataSet)
		{
			...
			{
			//	CurrentMessageManager.Add(CurrentMessageManager.FormatErrorMessage(Message.ERRMSG_PROGRAM_CANNOT_BE_RUN_WITH_2, new string[] {PROGRAM_NAME, "Prize Dimension"}));
				isValid = false;
			}
