...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
    internal class FreeSubsValidationStrategy : CampaignProgramValidationStrategy
	{
		internal FreeSubsValidationStrategy(Message messageManager) : base(messageManager) { }
