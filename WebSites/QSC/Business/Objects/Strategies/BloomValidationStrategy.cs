...
{
    internal class BloomValidationStrategy : CampaignProgramValidationStrategy
    {
        private const string PROGRAM_NAME = "Bloom";

        internal BloomValidationStrategy(Message messageManager) : base(messageManager) { }
        ...
        internal override bool Validate(Business.Objects.CampaignProgram campaignProgram, CampaignProgramDataSet dataSet)
        {
            ...
            {
                CurrentMessageManager.Add(CurrentMessageManager.FormatErrorMessage(Message.ERRMSG_PROGRAM_NO_STAFF_1, CurrentPrograms.Bloom.ToString()));
                isValid = false;
            }
