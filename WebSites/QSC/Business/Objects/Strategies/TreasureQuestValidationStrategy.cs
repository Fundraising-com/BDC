...
namespace Business.Objects.Strategies
{
	...
	/// </summary>
	internal class TreasureQuestValidationStrategy : CampaignProgramValidationStrategy
	{
		private const string PROGRAM_NAME = "Cumulative (Treasure Quest)";

		internal TreasureQuestValidationStrategy(Message messageManager) : base(messageManager) { }
