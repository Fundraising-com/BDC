...
namespace Business.Reports
{
	...
	/// </summary>
	public class CustomerServiceStatementReport : Report
	{
		private const string REPORT_NAME = "CustomerServiceOrdersStatement";
	  //private const string REPORT_NAME = "/QSP CA SystemsCustomerServiceOrdersStatement";
	  //private const string REPORT_NAME = "CustomerServiceOrdersStatement";

		private bool isFrench = false;

		public CustomerServiceStatementReport() : base() { }
