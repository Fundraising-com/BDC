namespace QSP.WebControl.DataAccess.Common
{
	...
	///     </remarks>
	/// </summary>
	internal class ApplicationConfiguration: IConfigurationSectionHandler
	{
		//
		...
		private const String DATAACCESS_CONNECTIONSTRING_DEFAULT   = @"server=161.230.158.127;database=[DataBase];uid=qspcafulfillment;pwd=fi11m3nt";
