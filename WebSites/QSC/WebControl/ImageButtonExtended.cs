...
namespace QSP.WebControl
{
	...
	Designer(typeof(ImageButtonExtendedDesigner))
	]
	public class ImageButtonExtended : System.Web.UI.WebControls.WebControl, INamingContainer
	{
	...
	public class ImageButtonExtendedDesigner : ControlDesigner
	{
		public override string GetDesignTimeHtml()
		{
			ImageButtonExtended cb = (ImageButtonExtended) Component;
