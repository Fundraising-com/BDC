...
{
    public class ProcessNonInternetFileActivity : ProcessFileBaseActivity
    {
        protected override ProcessBatchNodeActivity CreateAndInitializeBatchNodeActivity()
        {
            ...
            ProcessBatchNodeActivity aBNA = new ProcessBatchNodeActivity(aBN.ParseNonInternetNode
                      , aEN.ParseNonInternetNode
                      , aPartP.ParseNonInternetNode
                      , aPN.ParseNonInternetNode
                      , aAP.ParseInternetNode
                      , aMO.ParseNonInternetNode
                      , null);
