...
namespace GA.BDC.Integration.MessageStructures
{
   ...
   public struct ZGA_BDC_ORDER_ACCT_SEG
   {
      ...
      /// </summary>
      public ZGA_BDC_ORDER_ACCT_SEG(bool isInitializationRequired)
      {
         this = (ZGA_BDC_ORDER_ACCT_SEG)MarshalUtility.CopyByteArrayToStructure(new byte[Marshal.SizeOf(typeof(ZGA_BDC_ORDER_ACCT_SEG))], typeof(ZGA_BDC_ORDER_ACCT_SEG));
