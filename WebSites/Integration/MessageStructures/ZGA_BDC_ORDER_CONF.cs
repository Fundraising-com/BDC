...
#pragma warning disable 282
   public partial struct ZGA_BDC_ORDER_CONF : IInboundIDocStruct
   {
      /// <summary>
      ...
      /// </summary>
      public ZGA_BDC_ORDER_CONF_SEG ZgaBdcOrderConfSeg;
      ...
      /// </summary>
      public ZGA_BDC_ORDER_CONF(bool isInitializationRequired) : this()
      {
         ZgaBdcOrderConfSeg = new ZGA_BDC_ORDER_CONF_SEG(isInitializationRequired);
      }
      
      internal const string IDocTypeAsDefined = "ZGA_BDC_ORDER_CONF";
      internal const string IDocMessageTypeAsDefined = "ZGA_BDC_ORDER_CONF";
