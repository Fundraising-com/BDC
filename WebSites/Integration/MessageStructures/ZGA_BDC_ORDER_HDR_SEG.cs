...
namespace GA.BDC.Integration.MessageStructures
{
   ...
   public struct ZGA_BDC_ORDER_HDR_SEG
   {
      ...
      /// </summary>
      public ZGA_BDC_ORDER_HDR_SEG(bool isInitializationRequired)
      {
         this = (ZGA_BDC_ORDER_HDR_SEG)MarshalUtility.CopyByteArrayToStructure(new byte[Marshal.SizeOf(typeof(ZGA_BDC_ORDER_HDR_SEG))], typeof(ZGA_BDC_ORDER_HDR_SEG));
