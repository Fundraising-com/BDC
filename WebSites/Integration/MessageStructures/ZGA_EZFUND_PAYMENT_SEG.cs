...
namespace GA.BDC.Integration.MessageStructures
{
   ...
   public struct ZGA_EZFUND_PAYMENT_SEG
   {
      ...
      /// </summary>
      public ZGA_EZFUND_PAYMENT_SEG(bool isInitializationRequired)
      {
         this = (ZGA_EZFUND_PAYMENT_SEG)MarshalUtility.CopyByteArrayToStructure(new byte[Marshal.SizeOf(typeof(ZGA_EZFUND_PAYMENT_SEG))], typeof(ZGA_EZFUND_PAYMENT_SEG));
