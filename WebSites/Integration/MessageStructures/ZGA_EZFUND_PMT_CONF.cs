...
{
   /// <summary>
   ///   GA EZFUND Payment Confirmation:
   ///
   ///   GA.EZFUND.Integration.MessageStructures.ZGA_EZFUND_PMT_CONF
   ///      This is an auto-generated structure of the ZGA_EZFUND_PMT_CONF IDoc
   /// </summary>
#pragma warning disable 282
   public partial struct ZGA_EZFUND_PMT_CONF : IInboundIDocStruct
   {
      /// <summary>
      ///   GA EZFUND Payment Confirmation Segment:
      ///
      ///   ZGA_EZFUND_PMT_CONF_SEG segment (required)
      /// </summary>
      public ZGA_EZFUND_PMT_CONF_SEG ZgaEZFUNDPmtConfSeg;
      ...
      /// </summary>
      public ZGA_EZFUND_PMT_CONF(bool isInitializationRequired) : this()
      {
         ZgaEZFUNDPmtConfSeg = new ZGA_EZFUND_PMT_CONF_SEG(isInitializationRequired);
      }
      
      internal const string IDocTypeAsDefined = "ZGA_BDC_PMT_CONF";
      internal const string IDocMessageTypeAsDefined = "ZGA_EZFUND_PMT_CONF";
