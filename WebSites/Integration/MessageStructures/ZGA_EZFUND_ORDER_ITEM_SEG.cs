...
namespace GA.BDC.Integration.MessageStructures
{
   ...
   public struct ZGA_EZFUND_ORDER_ITEM_SEG
    {
      ...
      public bool? Free
      {
        ...
        /// </summary>
        public ZGA_EZFUND_ORDER_ITEM_SEG(bool isInitializationRequired)
      {
         this = (ZGA_EZFUND_ORDER_ITEM_SEG)MarshalUtility.CopyByteArrayToStructure(new byte[Marshal.SizeOf(typeof(ZGA_EZFUND_ORDER_ITEM_SEG))], typeof(ZGA_EZFUND_ORDER_ITEM_SEG));
