...
#pragma warning disable 282
   public partial struct ZGA_EZFUND_PAYMENT : IOutboundIDocStruct
   {
      /// <summary>
      ...
      /// </summary>
      public ZGA_EZFUND_PAYMENT_SEG ZgaEZFUNDPaymentSeg;
      ...
      /// </summary>
      public ZGA_EZFUND_PAYMENT(bool isInitializationRequired) : this()
      {
            ZgaEZFUNDPaymentSeg = new ZGA_EZFUND_PAYMENT_SEG(isInitializationRequired);
      }
      
      internal const string IDocTypeAsDefined = "ZGA_BDC_PAYMENT";
      internal const string IDocMessageTypeAsDefined = "ZGA_EZFUND_PAYMENT";
