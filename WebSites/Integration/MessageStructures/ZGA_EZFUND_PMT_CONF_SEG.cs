...
{
   /// <summary>
   ///   GA.BDC.Integration.MessageStructures.ZGA_BDC_PMT_CONF_SEG
   ///      This is an auto-generated structure of the ZGA_BDC_PMT_CONF_SEG IDoc Segment
   ///       (ZGA_BDC_PMT_CONF IDoc)
   /// </summary>
   [StructLayout(LayoutKind.Sequential, Pack=1)]
   public struct ZGA_EZFUND_PMT_CONF_SEG
   {
      ...
      public string Sapdocnum
      {
         get
         {
            string exportSapdocnum = CleanConvert.ToSignificantString(this._sapdocnum);
            
            return (exportSapdocnum.Length > 0 ? exportSapdocnum : null);
         }
         
         set
         {
            CleanConvert.SetByValByteArrayStringField(ref this._sapdocnum, value);
         }
      }
      ...
      /// </summary>
      public ZGA_EZFUND_PMT_CONF_SEG(bool isInitializationRequired)
      {
         this = (ZGA_EZFUND_PMT_CONF_SEG)MarshalUtility.CopyByteArrayToStructure(new byte[Marshal.SizeOf(typeof(ZGA_EZFUND_PMT_CONF_SEG))], typeof(ZGA_EZFUND_PMT_CONF_SEG));
      ...
      /// </summary>
      public const string SegmentNameAsDefined = "ZGA_BDC_PMT_CONF_SEG000";
