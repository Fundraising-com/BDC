namespace CRMWeb.UserControls
{
	...
	/// </summary>
	public partial class AllAccountsForLead : System.Web.UI.UserControl
	{
		...
		public int GenerateControl(int leadID){
			try{
			...
			return dt.Rows.Count;
				...
				throw new Global.CRMException("",ex,0,"AllAccountsForLead.GenerateControl");
