...
{
    [Table("ORG_MSTR_ATRL_TBL")]
    public partial class org_mstr_atrl_tbl
    {
        [Required]
        [StringLength(8)]
        public string ATRL_ACTION_CDE { get; set; }

        [Required]
        public DateTime ATRL_ACTION_DTE { get; set; }
        ...
        public int ATRL_SEQ_NBR { get; set; }
    }
}
