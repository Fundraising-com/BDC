namespace GA.BDC.Data.MGP.EFRCommon.Models
{
    ...
    public partial class DataProvider : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<advertising>()
                .HasMany(e => e.advertising_listing)
            ...
            modelBuilder.Entity<partner>()
                .HasMany(e => e.partner_attribute_value)
                .WithRequired(e => e.partner)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<partner>()
                .HasMany(e => e.partner_promotion)
                .WithRequired(e => e.partner)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<partner_attribute>()
                .HasMany(e => e.partner_attribute_value)
                .WithRequired(e => e.partner_attribute)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<partner_type>()
                ...
                .WithRequired(e => e.partner_type)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<partner_type>()
                .HasMany(e => e.partner_type_culture)
                .WithRequired(e => e.partner_type)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<profit>()
                .HasMany(e => e.profit_range)
                .WithRequired(e => e.profit)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<promotion_type>()
                ...
                .WithRequired(e => e.promotion_type)
                .WillCascadeOnDelete(false);
        }
    }
}
