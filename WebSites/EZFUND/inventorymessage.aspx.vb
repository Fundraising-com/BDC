...
Public Class InventoryMessage
    ...
    Inherits CWebPage
    Protected WithEvents cmdNo As System.Web.UI.WebControls.LinkButton
    Protected WithEvents cmdBackOrder As System.Web.UI.WebControls.LinkButton
    Protected WithEvents tblInventory As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents CanBackOrder As System.Web.UI.HtmlControls.HtmlTableRow
    Protected WithEvents imgNo As System.Web.UI.WebControls.Image
    Protected WithEvents imgBackOrder As System.Web.UI.WebControls.Image
    Protected WithEvents imgClose As System.Web.UI.WebControls.Image
    Protected WithEvents TrClose As System.Web.UI.HtmlControls.HtmlTableRow
    Protected WithEvents InventoryInfo As System.Web.UI.HtmlControls.HtmlForm
    Protected WithEvents cmdClose As System.Web.UI.WebControls.LinkButton
    Protected WithEvents Td2 As System.Web.UI.HtmlControls.HtmlTableCell
    Protected WithEvents ErrorMessage As System.Web.UI.WebControls.Label
    Protected WithEvents ErrorAlignment As System.Web.UI.HtmlControls.HtmlGenericControl
    Protected WithEvents boConfirm As System.Web.UI.WebControls.Panel
    ...
    Protected WithEvents Confirmation As System.Web.UI.WebControls.Panel
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If Not IsPostBack Then
                    ...
                    Else
                        ...
                        If oItem.Inventory.CanBackOrder Then
                            ...
                            If (StoreFrontConfiguration.AdminStore.Item("AddProductStyle").InnerText <> CStr(AddProductStyle.PopUp)) Then
                                ...
                                If (IsNothing(Session("PageIndex")) = False) Then

                                    cmdBackOrder.Attributes.Add("onclick", "javascript:window.opener.location.href='" & sPage & "?Add=1&Index=" & Session("PageIndex") & "&alertStat=1';" & sReturn)
                                Else
                ...
                imgNo.ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("Cancel").Attributes("Filename").Value
                imgBackOrder.ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("Continue").Attributes("Filename").Value
        ...
        Try
            ...
            Else
                ...
                If (IsNothing(Session("PageIndex")) = False) Then
                    ...
                    RegisterClientScriptBlock("myScript", "<script" _
                                & "  language='JavaScript'>window.opener.location.href='" & sPage & "?Index=" & Session("PageIndex") & "';</script>")
                Else
                    RegisterClientScriptBlock("myScript", "<script" _
                ...
                Image1.ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("Close").Attributes("Filename").Value
