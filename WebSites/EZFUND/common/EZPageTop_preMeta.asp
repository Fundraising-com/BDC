...
If Request.ServerVariables("SERVER_NAME") = "test.ezfund.com" Then
...
Else	
	' --- Development ---
	HOME_URL =				"http://test.ezfund.com/"
End If	

' The log is in this directory
Const LogsPhysPathname =		"C:\inetpub\logs\LogFiles\W3SVC2"
Const IncludesPhysPathname =	"C:\Apps\Installation\GA\BDC\Web\Ezfund\EZFundWebFiles\Includes"
...
EZInfoMailingAddress(2) = "10400 Westoffice Dr"
EZInfoMailingAddress(3) = "Houston, TX 77042"
