...
EZInfoMailingAddress(2) = "1716 Townhurst"
EZInfoMailingAddress(3) = "Houston, TX 77043"
...
Const HolidayStoreASP =		"http://holidayshop.org/signup/index.php?cID=EZF"				' Holiday Store page
...
Const OnlineStoreASP =		"http://www.ezfund.com/SearchResult.aspx?CategoryID=1"	' MAIN Shopping Cart page
Const OnlineStoreCatalogASP = "http://www.ezfund.com/SearchResult.aspx?CategoryID="	' Shopping Cart Catalog
Const OnlineStoreOrderASP = "http://www.ezfund.com/Detail.aspx?ID="	' EZFund Shopping Cart PRODUCT page
Const EZShoppingCartASP =	"http://www.ezfund.com/SearchResult.aspx?CategoryID=1"		' EZFund Shopping Cart page
...
Else
	...
	OtherBrowser = Not (NS3 Or NS4 Or NS5 Or NS6 Or NS7 Or NS8 Or FX0 Or FX1)
	Select Case True
...
' -- META DATA
Dim sPageCtlMetaKeywords: sPageCtlMetaKeywords = ""
Dim sPageCtlMetaDescription: sPageCtlMetaDescription = ""
' -- MENU FOOTER
...
Function ModernBrowser()
    ModernBrowser = (IE4 Or IE5 Or IE6 Or IE7 Or NS4 Or NS6 Or NS7 Or NS8)
End Function

Function BrowserSupportsHover()
    BrowserSupportsHover = (IE4 Or IE5 Or IE6 Or IE7 Or NS4 Or NS6 Or NS7 Or NS8)
End Function

Function BrowserSupportsStyle()
    BrowserSupportsStyle = (IE3 Or IE4 Or IE5 Or IE6 Or IE7 Or NS4 Or NS6 Or NS7 Or NS8)
End Function
