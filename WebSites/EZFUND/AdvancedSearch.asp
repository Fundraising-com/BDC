...
<!--Header End -->        
        ...
        <tr>
          <td class="tdBottomTopBanner">Use the options below to perform a more selective search of our product database.  You can confine your search to only certain Manufacturers, Categories, or Vendors.  You can also choose to search only by items that have been added within a certain time range, or search within a specific price range.
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<input optional=true type="text" style="<%= C_FORMDESIGN %>" name="txtDateAddedStart" size="8" onblur="javascript:convert_date(this)"> <b>And</b> 
                         <input optional=true type="text" style="<%= C_FORMDESIGN %>" name="txtDateAddedEnd" size="8" onblur="javascript:convert_date(this)"></p>
			            <%End If%>
			            <%If C_PriceIsActive <> 0 Then%>
			            <p><b>Price Between:</b><br>
			&nbsp;&nbsp;&nbsp;&nbsp;<input optional=true number=true style="<%= C_FORMDESIGN %>" type="text" name="txtPriceStart" size="8"> <b>To</b>  
                         <input optional=true number=true style="<%= C_FORMDESIGN %>" type="text" name="txtPriceEnd" size="8"></p>
			            <%End If%>
			            <%If C_SaleIsActive <> 0 Then%>
			            <p>&nbsp;&nbsp;&nbsp;<input optional=true type="checkbox" name="txtSale" value="1"><b>Only Sale Items</b>
			            <%End If%>
