...
If Request.Form("affSubmit.x") <> "" or Request.QueryString("AffID") <> "" Then
	...
	If Not (rsAff.EOF And rsAff.BOF) Then
		...
		sSQL = "SELECT orderAmount, orderSTax, orderCTax, orderShippingAmount, orderHandling, orderGrandTotal, orderTradingPartner FROM sfOrders WHERE orderTradingPartner = '" & makeInputSafe(sAffiliateId) & "'"
