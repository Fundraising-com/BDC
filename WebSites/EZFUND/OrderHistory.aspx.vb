...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            For Each con In DataGrid1.Items
                CType(con.FindControl("imgView"), System.Web.UI.WebControls.Image).ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("View").Attributes("Filename").Value()
    ...
    Private Sub DataGrid1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemDataBound
        If (Not (IsNothing(e.Item.FindControl("imgView")))) Then
            CType(e.Item.FindControl("imgView"), System.Web.UI.WebControls.Image).ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("View").Attributes("Filename").Value()
        End If
        If (Not (IsNothing(e.Item.FindControl("imgTrack")))) Then
            CType(e.Item.FindControl("imgTrack"), System.Web.UI.WebControls.Image).ImageUrl = "images/" & dom.Item("SiteProducts").Item("SiteImages").Item("Track").Attributes("Filename").Value()
        End If
    End Sub
