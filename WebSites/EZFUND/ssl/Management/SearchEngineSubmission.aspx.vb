...
Public Class SearchEngineSubmission
    Inherits CWebPage
    ...
    Protected WithEvents valKeywords As System.Web.UI.WebControls.RequiredFieldValidator
    ...
    Protected WithEvents Keywords_RequiredFieldValidator As System.Web.UI.WebControls.RequiredFieldValidator
    Protected WithEvents Desc_RequiredFieldValidator As System.Web.UI.WebControls.RequiredFieldValidator
...
#End Region
    ...
    '## Iwon
    Private Sub Linkbutton11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Linkbutton11.Click
        Me.lblInfo.Text = "<b>Iwon</b> originally launched in October of 1999 and has seen significant growth into a large internet portal, mostly thanks to its cash giveaways for using their services. With over $2 million given away every month to use a search engine, many people have found this search engine an excellent alternative to the major portals. Furthermore, Iwon uses many of the same technologies (Inktomi and Direct Hit) as their rivals making it essentially a reward based search engine similiar to the competition. "
        Me.lblInfo.Visible = True
    End Sub
