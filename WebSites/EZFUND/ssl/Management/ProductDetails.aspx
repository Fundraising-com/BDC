<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProductDetails.aspx.vb" Inherits="StoreFront.StoreFront.ProductDetails"%>
<%@ Register TagPrefix="uc1" TagName="ProductDetailsControl" Src="Controls/ProductDetailsControl.ascx" %>
	...
	<HEAD>
		...
		<script language="javascript">
			...
			function SetValidation()
			{
				...
				if (window.document.Form2.elements["ProductDetails:DetailLinkType"].options[window.document.Form2.elements["ProductDetails:DetailLinkType"].options.selectedIndex].value == "1")
				{
				window.document.Form2.elements["ProductDetails:DetailLink"].required=true;
				window.document.Form2.elements["ProductDetails:DetailLink"].title="Detail Link";
				}
				else
				{
				window.document.Form2.elements["ProductDetails:DetailLink"].required=false;
				}
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<A href="javascript: doHelp(' http://support.storefront.net/mtdocs/products_details.asp ')">
							...
							<TR>
								<TD class="content" vAlign="top" align="middle">
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server" id="Table001">
										<tr>
											<td class="ContentTable" colSpan="17" height="1" width="100%"><IMG height="1" src="images/clear.gif"></td>
										</tr>
										<tr>
											<td class="ContentTableHeader" align="left" colSpan="17">&nbsp;<asp:label id="lblPDName" Runat="server" CssClass="ContentTableHeader">&nbsp;Product Name</asp:label></td>
										</tr>
										<tr>
											...
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
												<A class="content" href="ProductDetails.aspx"><b>&nbsp;Details&nbsp;</b></A>
											</td>
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
											...
											<td class="ContentTableHeader" width="1" id="InvCell1"><IMG src="images/clear.gif" width="1"></td>
										...
										<TR>
											...
											<TD class="content" vAlign="top" align="middle" width="100%" colSpan="15">
												<table class="content" cellSpacing="3" cellPadding="5" width="100%" border="0">
													<tr>
														<td class="content" align="middle">
															<uc1:ProductDetailsControl id="ProductDetails" runat="server"></uc1:ProductDetailsControl></td>
													</tr>
												</table>
											</TD>
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
