<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Default.aspx.vb" Inherits="StoreFront.StoreFront._Default" EnableViewState=True smartNavigation="true"  TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0"%>
	...
	<tr>
   	<td class="Content" valign="top">
		...
		<td width="33%" class="ContentTableHeader">Knowledge Base</td>
       	...
       	<tr> 
       	<td class="Content"> 
			<A href="javascript: doHelp('http://support.storefront.net/mtdocs/index.asp')"><img src="images/help.jpg" border="0"></A> 
      	 	</td>
       	<td class="Content"><strong><a href="http://support.storefront.net/Resources/sf6quickstart/default.asp" style="COLOR: black" target="_blank">Launch the Quick Start Guide</a></strong></td>
		...
		<tr> 
       	...
       	<td class="Content" width="100%" colspan="3">
			...
			<td class="Content">Be a part of an online discussion 
       		 	about StoreFront with StoreFront's exclusive online newsgroup. <br>
      	    	<strong><a href="news://news.storefront.net/storefront.support.general" style="COLOR: black" target="_blank">Access the StoreFront Newsgroup</a></strong>
			</td>
           	</tr>
			</table> 
		</td>
