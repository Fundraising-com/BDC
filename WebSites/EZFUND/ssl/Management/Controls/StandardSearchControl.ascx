...
<table border="0" cellpadding="0" cellspacing="0" width="100%" runat="server" id="searchTable">
	...
	<tr>
		<td colspan="7">
			<asp:DataGrid id="DataGrid2" runat="server" ShowHeader="False" AutoGenerateColumns="False" AllowPaging="True" Width="100%" ItemStyle-Width="100%" BorderWidth="0px" CellPadding="0" GridLines="None">
