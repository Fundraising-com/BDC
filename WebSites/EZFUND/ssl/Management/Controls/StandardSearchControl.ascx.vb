...
Public MustInherit Class StandardSearchControl
...
#Region "Edit Item"
    ...
    Public Sub EditItem(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'If Not (IsNothing(Session("LastSearch"))) Then
        '    StorageClass.DataSource = Session("LastSearch")
        '    Session("LastSearch") = Nothing
        '    DataGrid2.DataSource = StorageClass.DataSource
        'Else
        '    DataGrid2.DataSource = DoSearching()
        'End If
