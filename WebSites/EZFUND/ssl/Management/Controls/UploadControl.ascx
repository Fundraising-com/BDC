	...
	<TABLE align="left">
		<TR>
			<TD class="content">
				...
				<asp:Label id="lblLabel" cssclass="content" runat="server"></asp:Label>&nbsp;
			</TD>
			<TD class="content">
				<asp:textbox id="lblCurrent" cssclass="content" runat="server"></asp:textbox>&nbsp;
			</TD>
			<TD class="content">
	...
	<TABLE cellPadding="4" align="center" border="0">
		...
		<TR>
			<TD vAlign="top" align="left" width="100" colSpan="2">
				<INPUT class="content" id="filename" type="file" name="filename" runat="server">
			</TD>
		</TR>
		<TR>
		...
		<TR>
			<TD vAlign="top" align="middle" colSpan="2">
				<asp:Label id="status" cssclass="ErrorMessages" runat="server"></asp:Label></TD>
		</TR>
	</TABLE>
</asp:panel>
