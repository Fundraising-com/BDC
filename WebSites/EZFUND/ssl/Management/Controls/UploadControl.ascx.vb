...
Public MustInherit Class UploadControl
    Inherits CWebControl
    Protected WithEvents saveSpan As System.Web.UI.WebControls.Label
    Protected WithEvents uploadBtn As System.Web.UI.WebControls.LinkButton
    ...
    Public FileType As _FileType = _FileType.Image
    Protected WithEvents cmdNew As System.Web.UI.WebControls.LinkButton

    Protected WithEvents lblCurrent As System.Web.UI.WebControls.TextBox
    Protected WithEvents pnlCurrent As System.Web.UI.WebControls.Panel
    Protected WithEvents pnlfile As System.Web.UI.WebControls.Panel
    Protected WithEvents CmdCancel As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lblspcr As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents imgNew As System.Web.UI.WebControls.Image
    Protected WithEvents imguploadBtn As System.Web.UI.WebControls.Image
        ...
        If Not IsNothing(filename.PostedFile) Then
            ...
            Try
                ...
                If ISOk(sFile) Then
                    ...
                    If (FileType = _FileType.Pem) Then
    ...
    Private Function FolderExist() As Boolean
        ...
        Select Case FileType
            ...
            Case _FileType.Pem
                ...
                End If
                uploadFolder = uploadFolder & "ssl\_Proc"
                If oFolder.Exists(uploadFolder) = False Then
                    Try
                        oFolder.CreateDirectory(uploadFolder)
                    Catch
        ...
        Return oFolder.Exists(uploadFolder)
