<%@ Control Language="vb" AutoEventWireup="false" Codebehind="freeshipping.ascx.vb" Inherits="StoreFront.StoreFront.freeshipping" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
<asp:label id="ErrorMessage" runat="server" CssClass="ErrorMessages" Visible="False"></asp:label><br>
<br>
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	<tr>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
		<td class="ContentTableHeader">&nbsp;</td>
		<td class="ContentTableHeader" align="left">Free Shipping</td>
		<td class="ContentTableHeader">&nbsp;</td>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="Content">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="Content" noWrap align="right">Activate Free Shipping: &nbsp;</td>
				...
				<TR>
					<TD class="Content" noWrap align="right">Free Shipping Expires:&nbsp;</TD>
