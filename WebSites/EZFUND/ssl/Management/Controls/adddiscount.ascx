		...
		<td class="Content">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<td class="Content" noWrap align="left"><asp:textbox id="txtAmount" Runat="server" Columns="10"></asp:textbox>&nbsp;<asp:radiobutton id="rdoDollar" Runat="server" Text="Dollar" GroupName="AmountType" Checked="True"></asp:radiobutton><asp:radiobutton id="rdoPercent" Runat="server" Text="Percent" GroupName="AmountType"></asp:radiobutton></td>
					<td class="Content" noWrap width="100%">&nbsp;</td>
				</TR>
				<tr>
