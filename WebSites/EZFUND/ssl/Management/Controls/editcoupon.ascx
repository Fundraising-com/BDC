<%@ Control Language="vb" AutoEventWireup="false" Codebehind="editcoupon.ascx.vb" Inherits="StoreFront.StoreFront.editcoupon" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
<asp:label id="ErrorMessage" Visible="False" CssClass="ErrorMessages" runat="server"></asp:label><asp:textbox id="txtApplyToID" Visible="False" runat="server"></asp:textbox><asp:textbox id="txtID" Visible="False" runat="server"></asp:textbox><br>
<br>
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	<tr>
		<td class="Headings" colSpan="5">Edit Coupon</td>
	</tr>
	<tr>
					...
					<td class="Content">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td class="Content" noWrap align="left"><asp:textbox id="txtAmount" Runat="server" Columns="10"></asp:textbox>&nbsp;<asp:radiobutton id="rdoDollar" Runat="server" GroupName="AmountType" Checked="True" Text="Dollar"></asp:radiobutton><asp:radiobutton id="rdoPercent" Runat="server" GroupName="AmountType" Text="Percent"></asp:radiobutton>&nbsp;&nbsp;</td>
								<td class="Content" noWrap width="100%">&nbsp;</td>
							</tr>
							<tr>
