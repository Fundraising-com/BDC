<%@ Control Language="vb" AutoEventWireup="false" Codebehind="addgiftcertificates.ascx.vb" Inherits="StoreFront.StoreFront.addgiftcertificates" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td class="ContentTableHeader" align="left">Add Gift Certificates</td>
		<td class="ContentTableHeader">&nbsp;</td>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</tr>
	<tr>
