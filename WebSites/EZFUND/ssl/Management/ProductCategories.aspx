<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProductCategories.aspx.vb" Inherits="StoreFront.StoreFront.ProductCategories"%>
...
<%@ Register TagPrefix="uc1" TagName="ProductCategoriesControl" Src="Controls/ProductCategoriesControl.ascx" %>
	...
	<body class="GeneralPage" runat="server" id="BodyTag">
		<form id="Form2" method="post" runat="server">
			<table cellspacing="0" class="GeneralTable">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="2">
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<a href="javascript: doHelp(' http://support.storefront.net/mtdocs/products_choosecat.asp ')">
							...
							<tr>
								<td class="content" vAlign="top" align="middle">
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0" runat=server id=Table001>
										...
										<tr>
											<td class="ContentTableHeader" align="left" colSpan="17" width="100%">&nbsp;<asp:label id="lblPDName" Runat="server" CssClass="ContentTableHeader">&nbsp;Product Name</asp:label></td>
										</tr>
										<tr>
											...
											<td class="ContentTableHeader" width="1"><img src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
												<a class="content" href="ProductCategories.aspx"><b>&nbsp;Categories&nbsp;</b></a>
											</td>
											<td class="ContentTableHeader" width="1"><img src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
										...
										<tr>
											...
											<td class="content" vAlign="top" align="middle" colSpan="15">
												<table class="content" cellSpacing="3" cellPadding="5" width="100%" border="0">
													<tr>
														<td class="content" align="middle">
															<uc1:ProductCategoriesControl id="ProductCategories" runat="server"></uc1:ProductCategoriesControl>
														</td>
													</tr>
												</table>
											</td>
