...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PromotionalMail.aspx.vb" Inherits="StoreFront.StoreFront.PromotionalMail" codePage="1252"%>
...
%>
		...
		<style>.tblCoolbar {
	BORDER-RIGHT: buttonshadow 1px solid; PADDING-RIGHT: 1px; BORDER-TOP: buttonhighlight 1px solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: buttonhighlight 1px solid; COLOR: menutext; PADDING-TOP: 1px; BORDER-BOTTOM: buttonshadow 1px solid; BACKGROUND-COLOR: #e2e2e2
}
.bar {
	BORDER-TOP: #99ccff 1px solid; BACKGROUND: #316ac5; WIDTH: 100%; BORDER-BOTTOM: #000000 1px solid; HEIGHT: 20px
}
TD {
...
value='<%#DataBinder.Eval(me, "BaseURL")%>' name=hdnBaseURL>
			<table class="GeneralTable" cellSpacing="0">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<!-- Top Sub Banner Start --> Promotional EMail 
						...
						<table cellSpacing="3" cellPadding="5" width="100%" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button --><A href="javascript: doHelp(' http://support.storefront.net/mtdocs/promotional_email.asp ')"><IMG src="images/help.jpg" border="0"></A>
									<!-- End Help Button --></td>
							</tr>
							<tr>
								<td class="Content">
														...
														<td colspan="2">
															<table class="Content" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr>
																	...
																	<td class="ContentTableHeader" colSpan="3">&nbsp;&nbsp;E-Mail Content</td>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																</tr>
																<tr>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																	<td class="Content" align="middle" colSpan="3" height="10">&nbsp;</td>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																</tr>
																<tr>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																...
																<tr>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																	<td class="Content" align="middle" colSpan="3">&nbsp;</td>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																</tr>
																<tr>
																	<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
																...
																<tr>
																	...
																	<td class="Content" align="left" colSpan="2">&nbsp;&nbsp;
																		<asp:linkbutton id="btnSelectProducts" Runat="server">
																			<asp:Image BorderWidth="0" ID="imgSelectProducts" runat="server" ImageUrl="images/select.jpg" AlternateText="Select Products"></asp:Image>
																		</asp:linkbutton></td>
