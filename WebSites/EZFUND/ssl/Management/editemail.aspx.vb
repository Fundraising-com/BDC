...
Public Class EditEMail
    Inherits CWebPage
    Protected WithEvents pnlSubmenu As System.Web.UI.WebControls.Panel
    Protected WithEvents PageTable As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents PageSubTable As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents PageCell As System.Web.UI.HtmlControls.HtmlTableCell
    Protected WithEvents ErrorMessage As System.Web.UI.WebControls.Label
    Protected WithEvents Message As System.Web.UI.WebControls.Label
    Protected WithEvents lblEmailType As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents lnkWishList As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkWishListComponents As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkCustomer As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkVendor As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkMerchant As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkProducts As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkBilling As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkShipping As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lnkOrderTotal As System.Web.UI.WebControls.LinkButton
    Protected WithEvents P1 As System.Web.UI.HtmlControls.HtmlGenericControl
    Protected WithEvents hdnSSLPath As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents hdnRootPath As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected hdnAction As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents ddFormat As System.Web.UI.WebControls.DropDownList
    Protected WithEvents Table1 As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents editemaildynamic1 As editemaildynamic
    Protected hdnText As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected hdnEMailType As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected strTextBody, strHtmlBody, strEmailType As String
    Protected strSubject As String
    Protected WithEvents Table2 As System.Web.UI.HtmlControls.HtmlTable
    Protected WithEvents lblPanel As System.Web.UI.WebControls.Label
    Protected WithEvents btnSave As System.Web.UI.WebControls.LinkButton
    Protected WithEvents lblEmailTypeHidden As System.Web.UI.WebControls.Label
...
#Region "lnkWishList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkWishList.Click"
    Public Sub lnkWishList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkWishList.Click
        ...
        If objCXMLEMailContent.Format = "HTML" Then ' Need to populate textbox field as well
            ...
            Dim objEmail2 = New CEMailContent()
...
#End Region
    ...
    Public Function EditByType(ByVal type As Long) As CXMLEMailContent
        ...
        Dim objEmail As CXMLEMailContent
        ...
        For Each objEMailContent In arr
            If (objEMailContent.Type = type And objEMailContent.IsActive) Then
                ...
                ' (4) ' Confirm
                ' (11) ' Low Stock Notice
                If (type = 0 Or type = 1 Or type = 2 Or type = 4 Or type = 5 Or type = 6 Or type = 11) Then  ' No submenus to worry about
    ...
    Public Function GetEMailContentUID(ByVal type As Integer, ByVal format As String)
        Dim objEmailContent As New CEMailContent()
    ...
    Public Function getText(ByVal type As Integer) As String
        ...
        ElseIf type = 6 Then
            str = "[OrderID]" & "<br>" & "[OrderTotal]" & "<br>" & "[BillingInfo]" & "<br>" & "[ProductsShippingInfo]" & "<br>" & "[StoreName]" & "<br>" & "[StoreURL]"
        ElseIf type = 7 Then
            str = "[ProductID]" & "<br>" & "[ProductName]" & "<br>" & "[ProductAttributes]" & "<br>" & "[ProductPrice]" & "<br>" & "[ProductQuantity]"
        ElseIf type = 8 Then
