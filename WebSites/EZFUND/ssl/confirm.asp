...
End If 
	...
	If Not Request.QueryString("message") <> "" AND Not Request.Form("custom") <> "" AND Not Request("CSVPOSRESPONSE") <> "" AND Not Request.QueryString("wpresponse") <> "" Then 
			...
			sCustAddress2			= Trim(Request.Form("Address2"))'#477
...
<title><%= C_STORENAME %>-SF Order Confirmation Page</title>
...
<!--Header End -->
    	    ...
    	    <tr>
        	  <td colspan="2" width="100%" align="center" class="tdContent" valign="center">Step 1: Customer Information | Step 2: Payment Information | <b>Step 3: Complete Order</b>
			  </td>
	        </tr>
    	    <tr>
							...
							<table>
								<tr>
				        	   		<td><% If InStr(sShipMethodName,"UPS") Then %><img src="images/logo_s.gif"><% Else %>&nbsp;<% End If %></td><td><font class="Content_Small">
										...
										published rates&nbsp;and may include additional charges levied by the merchant.</font>
									</td>
								</tr>
							</table>
						</td>
