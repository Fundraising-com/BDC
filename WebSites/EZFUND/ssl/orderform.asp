    ...
    <table class="tdContent2" border="0" width="100%" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td width="100%" class="tdContentBar"> Billing Information</td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr><td width="100%" class="tdContent2">  
		    <table class="tdContent2" cellpadding="2" cellspacing="0" width="100%">
			  <tr>
			    <td width="100%" colspan="4" cellpadding="0" cellspacing="0">
			      <table border="0" cellpadding="2" width="100%" class="tdContentBar" cellspacing="0">
			        <tr>
			          <td width="100%" class="tdContentBar"> Shipping Information (If Different from Billing Information)</td>
			        </tr>
			      </table>
			    </td>
			  </tr>
			  ...
			  <tr>
			    ...
			    <td nowrap><select size="1" name="ShipCountry" Style="<%= sFormDesign%>"><option value="<%= sShipCustCountry %>"><%= sShipCustCountryName %></option><%= sCtryList %></select></td>
			  </tr>
			  <tr>
			    <td nowrap align="right" height="15"></td>
			    <td nowrap height="15"></td>
		    ...
		    <table class="tdContent2" cellpadding="0" cellspacing="0" width="100%">
		      <tr>
		        <td width="100%">
		          ...
		          <table border="0" width="100%" cellspacing="0" cellpadding="2">
		            <tr>
		              <td colspan="2" width="100%" class="tdContentBar"> Shipping Method</td>
		            </tr>
		          </table>
		        </td>
		      </tr>    
		      ...
		      <table class="tdContent2" cellpadding="0" cellspacing="0" width="100%">
		        <tr>
		          <td width="100%">
		            <table border="0" width="100%" cellspacing="0" cellpadding="2">
		              <tr>
		                <td colspan="2" width="100%" class="tdContentBar">Special Instructions</td>
		              </tr>
		            </table>
		          </td></tr>
		        <tr> 
...
To specify a password, please enter it below. Otherwise, a password will be generated for you. 
		            ...
		            <table border="0" width="100%" class="tdContent2" align="center">
					    ...
					    <tr>
					      ...
					      <td width="50%"><input type="password" name="Password" maxlength="10" title="Password" style="<%= sFormDesign%>"></td>
					    </tr>
					    <tr>
					      <td width="50%" align="right"><b>Password Confirmation:</b></td>
					      <td width="50%"><input type="password" name="Password2" maxlength="10" title="Password Confirmation" style="<%= sFormDesign%>"></td>
					    </tr>
					    <tr><td colspan="2">&nbsp;</td></tr>
		            </table>
			        </center>	    
