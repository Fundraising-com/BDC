		...
		Forgotten Password Help		
            ...
            <tr>
	          <td class="tdBottomTopBanner2" align="left">
  		        <% If sOutput = "ChangePwd" Then %>
		Please enter in your e-mail, current password, then your new password.
		        <% ElseIf sOutPut = "FailedPwdUpdate" Then%>
		Your current password for this e-mail is not valid.
		        <% ElseIf sOutput = "EmailSent" Then %>
		An e-mail was sent to the address.
		        <% ElseIf sOutput = "NoEmailMatch" Then %>
                No e-mail address was found to match.
		        <% ElseIf sOutput = "FPWD" Then %>
		Please enter your e-mail address and your password will be sent to you immediately via e-mail. 		        <% End If %>
		</td>
	            </tr>	
						            ...
						            <tr>
						              ...
						              <tr>
							            <td width="100%" align="middle" colspan="2">
							              <input type="image" src="<%= C_BTN16 %>" border="0" name="SubmitNewPWD">
							            </td>         
						              </tr>
					                </table>
					              </td>
