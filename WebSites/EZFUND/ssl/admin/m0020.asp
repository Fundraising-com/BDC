...
<%	End If %>     
    ...
    <tr>
    <td align="middle" background="<%= C_BKGRND2 %>" bgcolor="<%= C_BGCOLOR2 %>"><b><font face="<%= C_FONTFACE2 %>" color="<%= C_FONTCOLOR2 %>" SIZE="<%= C_FONTSIZE2 %>">List All Vendors</font></b></td>    
    </tr>
    <tr>
...
<%	
	...
	objRS.Open "sfVendors", cnn, adOpenForwardOnly, adLockReadOnly, adCmdTable
...
%>
            <tr>
            <td width="40%" align="center" bgcolor="<%= sColor %>"><font face="<%= C_FONTFACE4 %>" color="<%= C_FONTCOLOR4 %>" size="<%= C_FONTSIZE4 %>"><%= objRS("vendName") %></font></td>
            <td width="20%" align="center" bgcolor="<%= sColor %>"><font face="<%= C_FONTFACE4 %>" color="<%= C_FONTCOLOR4 %>" size="<%= C_FONTSIZE4 %>"><%= objRS("vendNotes") %></font></td>
            <td width="30%" align="center" bgcolor="<%= sColor %>"><font face="<%= C_FONTFACE4 %>" color="<%= C_FONTCOLOR4 %>" size="<%= C_FONTSIZE4 %>"><a href="m0018.asp?vendID=<%= trim(objRS("vendID")) %>">Edit</a></font></td>
            </tr>
<%	
	objRS.MoveNext
	Loop
