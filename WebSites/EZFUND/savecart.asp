                                ...
                                <table border="0" width="100%" cellpadding="2">
                                  ...
                                  <tr> 
                                    <td width="100%" align="middle" colspan="2"> 
                                      ...
                                      <input type="image" src="<%= C_BTN12 %>" width="108" height="21" border="0" name="SignUp">
                                    </td>
                                  </tr>
                                </table>
                              </td>
              ...
              <form method="POST" action="savecart.asp" id="form2" name="form2">
                <tr> 
                  ...
                  <td width="15%" align="center" class='<%=fontClass%>' valign="top" nowrap> 
                    ...
                    <input type="image" src="<%= C_BTN06 %>" border="0" name="DeleteFromOrder<%= iProductCounter%>">
                    <br>
...
End If
	...
	%>
              <tr> 
                <td width="100%" colspan="5" align="center"> <a href="order.asp"><img src="<%= C_BTN10 %>" alt="View Cart" border="0"></a> 
