	...
	<TR>
		...
		<td vAlign="top" width="50%">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<TD class="Headings" noWrap>Apply&nbsp;a Gift Certificate:</TD>
				</tr>
				<tr>
		...
		<td vAlign="top" width="50%">
			<table id="GiftsApplied" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
				<tr>
					<TD class="Headings" noWrap>Gift Certificates Applied</TD>
				</tr>
				<tr>
								...
								<table runat="server" id="Table4" border="0" cellpadding="0" cellspacing="0" width="100%">
									...
									<tr>
										<td colspan="2" class="Content">
											<%# PriceDisplay2((DataBinder.Eval(Container.DataItem,"DollarOff")-DataBinder.Eval(Container.DataItem,"Remaining"))) %>
											Applied To Order,
											<%# PriceDisplay2(DataBinder.Eval(Container.DataItem,"Remaining")) %>
											Remaining
										</td>
									</tr>
								</table>
