...
Public MustInherit Class CAddressBook
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If (m_objCustomer.AddressList.Count = 0) Then
        ...
        For Each _addr In m_objcustomer.AddressList
            If (_addr.ID <> -1) Then
                _List.Add(_addr)
            End If
        Next
    ...
    Private Sub DataGrid1_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGrid1.PageIndexChanged
        ...
        DataGrid1.DataSource = m_objCustomer.AddressList
        DataGrid1.DataBind()
    End Sub
    ...
    Public Sub DeleteClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        m_objcustomer.DeleteAddress(objAddress)
