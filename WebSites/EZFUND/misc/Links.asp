...
<%
	...
	Dim OurASPPage:		OurASPPage = LinksASP
	Dim sPageHeader:	sPageHeader = "Links"
	...
	Call AddParentNavBar(LinksMenuSection, OurASPPage)
...
Function ExtractRequestParams()		' Extract all params for this request
	...
	Call LoadControlParamsForPage(cLinksPageCde)

	' no params at this time

	Call ConstructServicesMenu()
	Call ConstructMessageBoard(cLinksPageCde)
...
%>
<!--#include virtual="includes/LinksMainPageInclude.asp"-->
<%
End Function
...
Function ConstructServicesMenu()
	...
	' sub-menu
	Call AddSubMenuItem("", "", "", LinksMenuSection)	' NB: create empty sub-menu for this section (in case of DB error!)
	' menu footer
