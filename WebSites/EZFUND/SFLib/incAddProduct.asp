...
Dim rsSelectProd
	sLocalSQL = "SELECT prodName, prodNamePlural, prodMessage, prodAttrNum, prodShipIsActive FROM sfProducts WHERE prodEnabledIsActive=1 AND prodID = '"& makeInputSafe(sProdID) & "'"
