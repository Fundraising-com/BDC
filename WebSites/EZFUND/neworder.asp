		                ...
		                <tr>
		                  <td width="50%" align="center" class="tdContent" valign="center">
					        <table border="0" width="100%" cellpadding="3" cellspacing="1">
						      ...
						      <tr>
						        <td width="100%" align="center"class="tdContent"><font class="Error"><b>Email Match</b></font>
						          <br>Please choose another email account</td>	
						  		        
						      </tr>

						      <% ElseIf sCondition = "WrongCombination" Then %>
						      <tr>
						        <td width="100%" align="center" class="tdContent"><font class="Error"><b>Wrong Combination of email/password</b></font>	        
						          <br>Please try again</td>		
						      </tr>
