...
<!--Header End -->
    ...
    If txtsearchParamMan <> "ALL" Then
		SQL = "SELECT mfgName FROM sfManufacturers WHERE mfgID = " & makeInputSafe(txtsearchParamMan)
	...
	If txtsearchParamVen <> "ALL" Then
		SQL = "SELECT vendName FROM sfVendors WHERE vendID = " & makeInputSafe(txtsearchParamVen)
