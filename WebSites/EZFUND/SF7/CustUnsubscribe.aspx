<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CustUnsubscribe.aspx.vb" Inherits="StoreFront.StoreFront.CustUnsubscribe"%>
...
<HTML>
  <HEAD>
		<TITLE><% writeTitle() %> - Unsubscribe E-Mail</TITLE>
						...
						<table id="PageSubTable" cellSpacing="0" cellPadding="0" width="100%" align="center" border="1" runat="server">
								...
								<td class="Content" vAlign="top" id="ContentCell">
										...
										<table id="Table2" cellSpacing="3" cellPadding="5" width="100%" border="0">
											<tr>
												...
												<td class="content">
													...
													<P id="P1" runat="server" align=center>
														<asp:label id="Message" runat="server" CssClass="Messages" Visible="False">
														</asp:label>
													</P>
												</td>
												</tr>
											...
											<tr>
												<td class="Content">
													Your change of E-Mail setting has been processed:
												</td>
											</tr>
										</table>
									<!-- Content End -->
