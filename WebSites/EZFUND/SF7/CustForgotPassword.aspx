						...
						<table id="PageSubTable" cellSpacing="0" cellPadding="0" width="100%" align="center" border="1" runat="server">
							...
							<tr>
								...
								<td class="Content" vAlign="top" id="ContentCell">
									...
									<h1 class="Headings">Forgot Your Password?</h1>
									...
									<p>Enter the e-mail address associated with your account. Click	submit to have your password e-mailed to you.</p>				
													<TABLE id="Table3" cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD vAlign="top">
																<TABLE id="Table4" cellSpacing="0" cellPadding="0" border="0" class="Content formtbl">
																	<TR>
																		<TD class="name">E-Mail Address:&nbsp;</TD>
																		<TD class="inbox"><asp:textbox id="txtEMail" runat="server" Columns="50" MaxLength=255></asp:textbox></TD>
																	</TR>
																	<TR>
