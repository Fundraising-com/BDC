			...
			<table cellspacing="0" class="GeneralTable">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" width="100%" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Order Details"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							...
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/_.asp ')"><img src="images/help.jpg" border="0"></a>
									<!-- End Help Button --></td>
							</tr>
							<tr>
								<td class="Content">
																...
																<TR>
																	...
																	<TD vAlign="top" width="50%">
																		...
																		<cc1:TotalDisplay id="ShipmentTotalDisplay1" runat="server" HandlingTotalLabel="Handling:" ShippingTotalLabel="Shipping:"
																			...
																			DisplayGrandTotal="False" DisplayGiftCertificateTotal="False" ShowOanda="False"></cc1:TotalDisplay></TD>
																</TR>
															</TABLE>
														</ItemTemplate>
														<SeparatorTemplate>
												...
												<asp:repeater id="rDiscounts" runat="server">
													...
													<FooterTemplate>
														...
														<TR>
															...
															<TD class="Content" style="text-align:right"><%#Format(Me.DiscountTotal, "c")%>&nbsp;&nbsp;&nbsp;</TD>
															<TD class="Content">&nbsp;</TD>
															<TD class="ContentTable" style="WIDTH: 1px"><IMG src="images/clear.gif" width="1"></TD>
														</TR>
														<TR>
...
<%-- end: JDB - Advanced Coupon Functionality --%>
													<cc1:totaldisplay id="TotalDisplay1" runat="server" DisplayTaxShipNotIncluded="False" DisplayOrderTotal="False"
														...
														HandlingTotalLabel="Handling:" ShowOanda="False"></cc1:totaldisplay></td>
											</tr>
										</TBODY>
									</table>
								</td>
