	...
	<ItemTemplate>
		<table cellSpacing="0" cellPadding="0" width="100%" border="0">
			...
			<tr>
				...
				<asp:Repeater ID="rptRecurring" Runat="server">
					<ItemTemplate>
						<table cellSpacing="0" cellPadding="0" width="75%" border="0">
							<TR>
								<TD class="content" colspan="4" width="1"><IMG height="5" src="images/clear.gif"></TD>
							</TR>
							<tr>
								<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
								<td class="ContentTableHeader" align="left" colspan="3">&nbsp;Recurring 
									Transaction  - Order Item <%#DataBinder.Eval(Container.DataItem, "OrderItemID")%></td>
								<td class="ContentTable" height="1"><IMG height="1" src="images/clear.gif"></td>
							</tr>
							<tr>
								<td class="ContentTable" colSpan="4" height="1"><IMG height="1" src="images/clear.gif"></td>
							...
							<tr>
								<td class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></td>
								<td class="content" align="left" width="50%">Message: <%#DataBinder.Eval(Container.DataItem, "Message")%>	</td>
								<td class="ContentTable" height="1"><IMG height="1" src="images/clear.gif"></td>
								<td class="content" noWrap align="left" width="50%">Result: <%#DataBinder.Eval(Container.DataItem, "Result")%>
								</td>
								<td class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></td>
								<td class="content" noWrap align="left" width="50%">ProfileID: <%#DataBinder.Eval(Container.DataItem, "ProfileID")%>	</td>
								<td class="ContentTable" height="1"><IMG height="1" src="images/clear.gif"></td>
								<td class="content" noWrap align="left" width="50%">RP Reference: <%#DataBinder.Eval(Container.DataItem, "RPReference")%>
								</td>
								<td class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></td>
							</tr>
							<tr>
