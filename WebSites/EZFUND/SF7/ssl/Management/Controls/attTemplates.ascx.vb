        ...
        Try
            ...
            If obj.CommandName = "0" Then
                ...
                If Not IsNothing(_AttManager.Attribute) Then
                  ...
                  'sp7
                    _AttManager.DeleteItem(_AttManager.Attribute)
...
'sp7
                    _AttManager.DeleteDetailItem(_AttManager.AttributeDetail)
...
#Region "Public Sub AddDetail(ByVal sender As Object, ByVal e As System.EventArgs)"
    ...
    Public Sub AddDetail(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Dim obj As LinkButton = sender
            _AttManager.Attribute_TO_Edit = CAttributeManagement.AttributeMode.Main
            _AttManager.CurrentEditMode = CAttributeManagement.EditMode.add
            _AttManager.CurrentMainID = CLng(obj.CommandArgument)
            ...
            If Not IsNothing(obj) Then
                If _AttManager.CanEdit = True Then
                    If _AttManager.WorkMode = SystemBase.AttributeWorkMode.Live Then
                        ...
                        AddJavaMSG(btnAdd, JavaMessage.Custom, "Inventory Stock will be overwritten if you have added a new Attribute.  Adding Attribute details does not cause the loss of stock information. Are You Sure You Want to Add Attribute?")
                        'Else
        ...
        If IsNothing(objButton) = False Then
            Select Case MsgType
                ...
                Case JavaMessage.OverWriteInventory
                    objButton.Attributes.Add("onclick", "javascript:return ConfirmCancel('" & "Inventory Stock will be overwritten if you are deleting an Attribute.  Deleting Attribute details does not cause the loss of stock information. Are You Sure You Want to Delete This Item?" & "');")
