...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="addcategory.ascx.vb" Inherits="StoreFront.StoreFront.addcategory" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
<input id="txtLevelHidden" type="hidden" runat="server"> <input id="txtParentIDHidden" type="hidden" runat="server">
<table cellSpacing="0" cellPadding="0" width="100%">
	<tr>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
		<td class="ContentTableHeader" align="left" colSpan="2">&nbsp;Add Category<asp:label id="lblCustomerHeader" CssClass="ContentTableHeader" Runat="server"></asp:label></td>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</tr>
	<TR>
	...
	<TR>
		...
		<TD><asp:textbox id="txtName" runat="server" Width="310px" MaxLength="50"></asp:textbox></TD>
	...
	<TR>
		...
		<TD><uc1:UploadControl id="catUpload" runat="server"></uc1:UploadControl></TD>
		<TD class="Content" width="100%" height="10"></TD>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</TR>
	<TR>
