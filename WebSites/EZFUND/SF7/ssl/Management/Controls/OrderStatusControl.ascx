	...
	<TR>
		...
		<TD class="Content" vAlign="top">
			<table cellSpacing="0" cellPadding="0" width="100%">
				...
				<tr>
					...
					<td class="content" align="right">
						<asp:LinkButton ID="cmdSetPrimary" Runat="server" OnClick="Process" CommandName="0">
							<asp:Image BorderWidth="0" ID="imgSetPrimary" runat="server" ImageUrl="../images/process.jpg"
								AlternateText="Process"></asp:Image>
						</asp:LinkButton>
					</td>
				</tr>
				<tr>
				...
				<%-- 
				<tr>
					<td class="content" align="right">RMS Export Status:</td>
					<td class="content" align="right"><asp:label id="lblRMSStatus" Runat="server" CssClass="content"></asp:label></td>
					<td class="content" align="right">
						<asp:LinkButton ID="cmdResetRMS" Runat="server" OnClick="ResetRMS">
							<asp:Image BorderWidth="0" ID="Image1" runat="server" ImageUrl="../images/clear.jpg" AlternateText="Reset"></asp:Image>
						</asp:LinkButton>
					</td>
				</tr>
				<tr>
				...
				<tr id="BOPayment" runat="server">
					...
					<td class="content" align="right">
						<asp:LinkButton ID="cmdsetBackOrder" Runat="server" OnClick="Process" CommandName="1">
							<asp:Image BorderWidth="0" ID="imgsetBackOrder" runat="server" ImageUrl="../images/process.jpg"
								AlternateText="Process"></asp:Image>
						</asp:LinkButton>
					</td>
					<td class="content">&nbsp;</td>
