<%@ Control Language="vb" AutoEventWireup="false" Codebehind="StateTaxControl.ascx.vb" Inherits="StoreFront.StoreFront.StateTaxControl" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
