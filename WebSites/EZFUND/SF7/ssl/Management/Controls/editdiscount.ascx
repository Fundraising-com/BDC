<%@ Control Language="vb" AutoEventWireup="false" Codebehind="editdiscount.ascx.vb" Inherits="StoreFront.StoreFront.editdiscount" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
<asp:label id="ErrorMessage" runat="server" CssClass="ErrorMessages" Visible="False"></asp:label>
<asp:TextBox id="txtApplyToID" Visible="False" runat="server"></asp:TextBox>
<asp:TextBox id="txtID" Visible="False" runat="server"></asp:TextBox><br>
<br>
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	<tr>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
		<td class="ContentTableHeader">&nbsp;</td>
		<td class="ContentTableHeader" align="left">Edit Store-Wide Discount</td>
		<td class="ContentTableHeader">&nbsp;</td>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="Content">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								...
								<td class="Content">
									<asp:DropDownList ID="Dropdownlist2" Runat="server" AutoPostBack=True>
										<asp:ListItem Value="0">Apply to each product</asp:ListItem>
				...
				<tr>
					<TD class="Content" noWrap align="right" height="15">Apply Discount To:&nbsp;</TD>
					<TD class="Content" noWrap align="left" height="15"><asp:dropdownlist id="ddlApplyTo" runat="server" AutoPostBack="True">
						...
						<asp:LinkButton ID="btnSelect" Runat="server" Visible="False">
							<asp:Image BorderWidth="0" ID="imgSelect" runat="server" ImageUrl="../images/select.jpg" AlternateText="Select"
								Visible="False"></asp:Image>
						</asp:LinkButton>
					</TD>
					<TD class="Content" noWrap width="100%" align="center" height="15"></TD>
				</tr>
				<TR>
