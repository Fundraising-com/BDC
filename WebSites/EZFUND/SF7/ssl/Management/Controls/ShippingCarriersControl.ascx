...
<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TBODY>
		...
		<asp:Panel Runat="server" ID="CPPanel">
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="1"><IMG src="images/canadapost.jpg"></TD>
			...
			<TR>
				...
				<TD class="content" align="left" colSpan="3">
					<asp:TextBox id="CPUserName" MaxLength="255" runat="server"></asp:TextBox></TD>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			</TR>
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
		...
		<asp:Panel Runat="server" ID="UPSPanel">
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="1"><IMG src="images/logo_s.gif"></TD>
      ...
      Tools.</asp:Label></TD>
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="4">UPS®, UPS &amp; Shield Design® and 
		...
		<asp:Panel Runat="server" ID="FEPanel">
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="1"><IMG src="images/fedex.jpg"></TD>
			...
			<TR>
				...
				<TD class="content" align="left" colSpan="3">
					<asp:TextBox id="FedExUserName" MaxLength="255" runat="server"></asp:TextBox></TD>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			</TR>
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
		...
		<asp:Panel Runat="server" ID="USPSPanel">
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="1"><IMG src="images/usps.jpg"></TD>
				<TD class="content" align="left" colSpan="3">Use the Postal Service as a shipping 
					...
					boxes. <A href="http://www.uspswebtools.com/registration/" target="_blank">Click 
						Here</A> to sign up for an account.
				</TD>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD class="content" align="left" colSpan="3">
					<asp:TextBox id="USPSUserName" MaxLength="255" runat="server"></asp:TextBox></TD>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			</TR>
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
		...
		<asp:Panel Runat="server" ID="LTLPanel">
			...
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
				<TD class="content" align="center" colSpan="1"><IMG src="images/freightquote.jpg"></TD>
			...
			<TR>
				...
				<TD class="content" align="left">
					<asp:TextBox id="LTLUserName" MaxLength="255" runat="server"></asp:TextBox></TD>
				<TD class="content" align="right">Password:</TD>
				<TD class="content" align="left">
					<asp:TextBox id="LTLPassword" MaxLength="255" runat="server"></asp:TextBox></TD>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			</TR>
			<TR>
				<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
