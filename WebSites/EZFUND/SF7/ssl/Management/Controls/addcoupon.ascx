		...
		<td width="100%" colSpan="3">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					...
					<TD class="Content" noWrap align="left" valign="top"><asp:dropdownlist id="ddlApplyTo" runat="server" AutoPostBack="True">
					...
					<TD class="Content" noWrap width="100%" align="center">
					</TD>
				</tr>
			</table>
		</td>
