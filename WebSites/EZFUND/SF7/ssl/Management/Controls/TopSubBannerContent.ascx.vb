...
Partial Class TopSubBannerContent
...
#End Region
    ...
    Public Sub BindFields()
        ...
        If CurrentArea = "TopSubBanner" Then
            ...
            If dt.Rows.Count > 0 AndAlso IsDBNull(dt.Rows(0).Item("DisplayStyle")) = False Then
                ...
                ElseIf dt.Rows(0).Item("DisplayStyle") = DisplayStyle.PageName Then
                    Me.PageName.Checked = True
                ElseIf dt.Rows(0).Item("DisplayStyle") = DisplayStyle.NavLinks Then
                    Me.NavigationalObjects.Checked = True
                End If
        ...
        Else
            ...
            If dt.Rows.Count > 0 Then
                If Me.chkDisplayDynamicContent.Checked Then
                    ...
                    ElseIf Me.PageName.Checked Then
                        dt.Rows(0).Item("DisplayStyle") = DisplayStyle.PageName
                    ElseIf Me.NavigationalObjects.Checked Then
                        dt.Rows(0).Item("DisplayStyle") = DisplayStyle.NavLinks
                    End If
                Else
