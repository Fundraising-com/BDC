...
#Region "Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load"
	   ...
	   Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        UploadControl1.FileType = UploadControl.m_FileType.DownLoad
        ...
        Else
            Try
                ...
                For i = 0 To ddDetailOrder.Items.Count - 1
                    If i = _AttManager.AttributeDetail.Order Then
                ...
                If _AttManager.WorkMode = SystemBase.AttributeWorkMode.Live Then
                    ...
                    AddJavaMSG(cmdSave, JavaMessage.Custom, "Inventory Stock will be overwritten if you are adding a new attribute with new details. Are You Sure You Want to Save Changes?")
                    'End If
        ...
        Try
            ...
            Select Case _AttManager.CurrentEditMode
                    ...
                    If MakeNewDetail() Then
                        If IsNothing(arNEWDetails) = False Then
                            For Each objNewDetail In arNEWDetails
                                ...
                                _AttManager.Attribute.AttributeDetails.Insert(objNewDetail.Order, objNewDetail)
                            Next
                        End If
                ...
                Case CAttributeManagement.EditMode.edit
                    If MakeNewDetail() Then
                        'Sp7 - Changed here - 
                        '#2808 - commented lines were removed
                        _AttManager.Attribute.AttributeDetails.Remove(_AttManager.AttributeDetail)
                        _AttManager.Attribute.AttributeDetails.Insert(_AttManager.AttributeDetail.Order, _AttManager.AttributeDetail)
                        _AttManager.Save()
                        'end Change
                        Session("AttributeManager") = _AttManager
                        Session("NewDetails") = Nothing
            ...
            If Detail_OKTOADD() Then
                If txtDetailName.Text.Trim.Length <> 0 Then
                    ...
                    If _AttManager.WorkMode = AttributeWorkMode.Template Then
                        ...
                        'Else
                        '    If obj.UID < 1 Then
                        '        'obj.UID = (_AttManager.NewDetailID - 1)
                        '    End If
                    ...
                    obj.Order = Me.ddDetailOrder.SelectedItem.Text - 1
