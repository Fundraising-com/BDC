...
<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TBODY>
		...
		<tr>
			<td class="Content" width="20%" colspan="2">&nbsp;Price:&nbsp;<%# Price() %></td>
			<td class="Content" width="80%" colspan="6">&nbsp;Cost:&nbsp;<%# Cost() %></td>
		</tr>
		<tr>
			<TD class="Content" width="1" colSpan="6">&nbsp;</TD>
		</tr>
		...
		<!-- Tee 7/16/2007 clearance pricing -->
		<TR>
			<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
			<td class="content" align="right" colSpan="1">Activate 
				Clearance:&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td class="content" align="left" colSpan="1"><asp:checkbox id="cbClearance" runat="server"></asp:checkbox><input id="hidListPrice" type="hidden" runat="server">
				<input id="hidCost" type="hidden" runat="server">
			</td>
			<td class="content" align="right" colSpan="1">Clearance 
				Price:&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td class="content" align="left" colSpan="1"><asp:textbox id="tbClearance" runat="server"></asp:textbox></td>
			<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
		</TR>
		<tr>
			<TD class="ContentTable" width="1"><IMG src="images/clear.gif" width="1"></TD>
		...
		<TR>
			<td class="content" align="right" width="75%" colSpan="6"><asp:linkbutton id="cmdSave" Runat="server">
