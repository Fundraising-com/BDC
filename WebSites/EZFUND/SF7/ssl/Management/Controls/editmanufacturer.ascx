...
<table cellSpacing="0" cellPadding="0" width="100%">
	...
	<!-- Tee 7/13/2007 added manufacturer activation -->
	<TR>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	...
	<TR>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
		<TD class="Content" colspan="3"><asp:CheckBox CssClass="Content" ID="cbActivate" Runat="server" Text="&nbsp;Activate Manufacturer"></asp:CheckBox></TD>
		<TD class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></TD>
	</TR>
	<!-- end Tee -->
	<TR>
