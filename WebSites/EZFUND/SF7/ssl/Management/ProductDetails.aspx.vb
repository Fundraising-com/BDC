...
Partial Class ProductDetails
    ...
    Protected WithEvents ProductDetails As ProductDetailsControl
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If RestrictedPages(Tasks.ProductDetails) = True Then
        ...
        Try
            ...
            CType(ProductDetails.FindControl("cmdSave"), LinkButton).Attributes.Add("onclick", "return SetValidation();")
        ...
        Catch ex As Exception
            Session("DetailError") = "Class ProductDetails Error=" & ex.Message
        ...
        Get
            ...
            Select Case iProductType
                Case 2 'merchant bundles
                    Return String.Format(HELP_URL_FORMAT, "merchbdl_sbs2")
                Case 4 'customer bundles
                    Return String.Format(HELP_URL_FORMAT, "custbdl_sbs2")
                Case Else 'products
                    Return String.Format(HELP_URL_FORMAT, "products_details")
            End Select
