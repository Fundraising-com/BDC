						...
						<table cellSpacing="3" cellPadding="5" width="100%" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button --><A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/reports_sd.asp ')"><IMG src="images/help.jpg" border="0"></A>
									<!-- End Help Button --></td>
							</tr>
							<tr>
								<td class="Content">
							...
							<tr>
								<td><asp:datagrid id="DataGrid1" runat="server" PageSize="10" AutoGenerateColumns="False" ShowHeader="False"
										AllowPaging="True" Width="100%" BorderWidth="0px" CellPadding="0">
										<Columns>
											<asp:TemplateColumn>
												<ItemTemplate>
