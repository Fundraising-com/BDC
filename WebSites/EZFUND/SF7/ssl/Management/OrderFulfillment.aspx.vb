...
Partial Class OrderFulfillment
    ...
    Protected WithEvents FulFillmentControl1 As FulFillmentControl
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        Try
            CType(FulFillmentControl1.FindControl("cmdGetOrders"), LinkButton).Attributes.Add("onclick", "return SetValidationView();")
            CType(FulFillmentControl1.FindControl("cmdLocateOrder"), LinkButton).Attributes.Add("onclick", "return SetValidationLocate();")
        ...
        Catch ex As Exception
            Session("DetailError") = "Class OrderFulfillment Error=" & ex.Message
