...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PurchaseBundles.aspx.vb" Inherits="StoreFront.StoreFront.PurchaseBundles" %>
			...
			<table class="GeneralTable" cellSpacing="0">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Purchase StoreFront Bundles Module"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
