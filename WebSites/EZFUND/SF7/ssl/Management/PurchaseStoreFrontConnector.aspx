<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PurchaseStoreFrontConnector.aspx.vb" Inherits="StoreFront.StoreFront.PurchaseStoreFrontConnector" %>
			...
			<table class="GeneralTable" cellSpacing="0">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Purchase StoreFront Connector Module"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
