<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProductImport.aspx.vb" Inherits="StoreFront.StoreFront.ProductImport" codePage="1252" validateRequest="False" %>
			...
			<table cellspacing="0" class="GeneralTable">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Products Import"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/products_import.asp ')">
