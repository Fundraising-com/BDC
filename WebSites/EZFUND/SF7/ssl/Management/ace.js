...
function editEmail()
{
	...
	{
		// products
		s1 = new Array("ProductID","ProductName","ProductAttributes","ProductPrice","ProductQuantity","RecurringAmount","Payperiod","Term")
		s2 = new Array("Product ID","Product Name","Product Attributes","Product Price","Product Quantity","RecurringAmount","Payperiod","Term")
		rows = 8;
	}
	...
	else if (sEMailType == "12")
	{
		// Ebay Checkout Notification 
		s1 = new Array("ListingNumber", "ProductName" , "BuyerUserID" , "Price", "QuantitySold", "SubTotal", "MerchantEmailAddress", "StoreName", "CheckOutUrl")
		s2 = new Array("Listing Number", "Product Name", "Buyer ID" , "Price" , "Quantity Sold", "SubTotal", "Merchant Email Address", "Store Name", "Check Out Url")
		rows = 9;
	}
