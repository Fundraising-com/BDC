							...
							<table width="100%" cellSpacing="3" cellPadding="5" border="0">
								...
								<tr>
									<td class="Content" align="right">
										<!-- Help Button -->
										<a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/olpayproc_ov.asp ')">
								...
								<tr>
									<td class="content" vAlign="top" align="center" colSpan="2">
										<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td class="ContentTable" colSpan="7" height="1" width="100%">
													<img height="1" src="images/clear.gif"></td>
											</tr>
											<tr>
												<td class="content" vAlign="top" align="center" colSpan="2">
													<p id="P1" runat="server"><font color="#ff0000">
															<asp:label id="Label1" runat="server" Visible="False" CssClass="ErrorMessages"></asp:label>
														</font>
													</p>
													<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
														<tr>
															<td class="Content" colSpan="9" height="1" width="100%">
																<img height="1" src="images/clear.gif"></td>
														</tr>
														<tr>
															...
															<td class="ContentTableHeader" width="1"><img src="images/clear.gif" width="1"></td>
															<td class="Content" align="center"><a class="content" href="PaymentProcessors.aspx"><b>Online Processing</b></a></td>
															<td class="ContentTableHeader" width="1"><img src="images/clear.gif" width="1"></td>
															<td class="Content" align="center">&nbsp;&nbsp;&nbsp;
															<%= IIF(restrictedPages(tasks.Encryption)=true,"<span class=DisableLink>Encryption</span>","<a class=content href='Encryption.aspx'>Encryption</a>")%>&nbsp;&nbsp; 
																&nbsp;</td>
															<td class="ContentTableHeader" width="1"><img src="images/clear.gif" width="1"></td>
