...
Partial Class ProductMarketing
    Inherits CWebPage
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If MyBase.RestrictedPages(Tasks.Marketing) = True Then
        ...
        Catch ex As Exception
            Session("DetailError") = "Class ProductMarketing Error=" & ex.Message
        ...
        Get
            ...
            Select Case iProductType
                Case 2 'merchant bundles
                    Return String.Format(HELP_URL_FORMAT, "merchbdl_sbs5")
                Case 4 'customer bundles
                    Return String.Format(HELP_URL_FORMAT, "custbdl_sbs5")
                Case Else 'products
                    Return String.Format(HELP_URL_FORMAT, "products_marketing")
            End Select
