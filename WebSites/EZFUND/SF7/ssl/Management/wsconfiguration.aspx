<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wsconfiguration.aspx.vb" Inherits="StoreFront.StoreFront.wsconfiguration" %>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/ws_config.asp  ')"><img src="images/help.jpg" border="0"></A>
									<!-- End Help Button -->
								</td>
							</tr>
							<tr>
									...
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											...
											<td class="ContentTableHeader" width="1">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%">
												<a class="content" href="wsconfiguration.aspx"><b>Configuration</b></a>
											</td>
											<td class="ContentTableHeader" width="1">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%"><a class="content" href="wsunsentorders.aspx">Unsent Orders</a>
											</td>
											<td class="ContentTableHeader" width="1">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%">&nbsp;
										...
										<TR>
											...
											<TD class="content" vAlign="top" align="center" colSpan="9">
												<table class="content" cellSpacing="3" cellPadding="5" width="100%" border="0">
													<tr>
														<td class="content" align="center">
															<uc1:WSConfControl id="WSConfControl1" runat="server"></uc1:WSConfControl>
														</td>
													</tr>
												</table>
											</TD>
