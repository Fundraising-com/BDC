<%@ Register TagPrefix="uc1" TagName="AddEditUserRoles" Src="Controls/AddEditUserRoles.ascx" %>
<%@ Register TagPrefix="uc1" TagName="StandardSearchControl" Src="Controls/StandardSearchControl.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Roles" Src="Controls/Roles.ascx" %>
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManageUserRoles.aspx.vb" Inherits="StoreFront.StoreFront.ManageUserRoles" %>
...
%>
		...
		<script language="javascript">
			...
			{
			window.document.Form2.elements["AddEditUserRoles1:txtname"].required=true;
			window.document.Form2.elements["AddEditUserRoles1:txtname"].title="Role Name";
			...
			<table class="GeneralTable" cellSpacing="0">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Manage Roles"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
						...
						<table cellSpacing="3" cellPadding="5" width="100%" border="0">
							<tr>
								<td class="Content" align="right" colspan="3">
									<!-- Help Button --><A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/roles_ov.asp ')"><IMG src="images/help.jpg" border="0"></A>
									<!-- End Help Button --></td>
							</tr>
							<tr>
							...
							<TR>
								<TD class="content" vAlign="top" align="center" colSpan="3">
										...
										<tr>
											...
											<td width="100%" class="content">
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														<td width="100%"><uc1:AddEditUserRoles id="AddEditUserRoles1" runat="server"></uc1:AddEditUserRoles></td>
													</tr>
													<tr>
														<td width="100%"><uc1:Roles id="Roles1" runat="server" width="100%"></uc1:Roles></td>
													</tr>
												</table>
											</td>
											<td class="contenttable"><img src="images/clear.gif"></td>
