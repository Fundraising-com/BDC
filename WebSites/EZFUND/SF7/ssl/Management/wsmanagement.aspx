<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wsmanagement.aspx.vb" Inherits="StoreFront.StoreFront.wsmanagement" %>
<%@ Register TagPrefix="uc1" TagName="WSControl" Src="Controls/WSMangCtrl.ascx" %>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/ws_management.asp  ')"><img src="images/help.jpg" border="0"></A>
									<!-- End Help Button -->
								</td>
							</tr>
							<tr>
							...
							<TR>
								<TD class="content" vAlign="top" align="center">
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="ContentTableHeader" width="1" height="13">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%" height="13">
												<a class="content" href="wsmanagement.aspx"><b>Credentials</b></a>
											</td>
											<td class="ContentTableHeader" width="1" height="13">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%" height="13">
											...
											<td class="ContentTableHeader" width="1" height="13">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%" height="13">
											<a class="content" href="wsunsentorders.aspx">Unsent Orders</a>
											</td>
											<td class="ContentTableHeader" width="1" height="13">
												<img src="images/clear.gif" width="1"></td>
											<td class="Content" align="center" width="25%" height="13">&nbsp;
										...
										<TR>
											...
											<TD class="content" vAlign="top" align="center" colSpan="9">
												<table class="content" cellSpacing="3" cellPadding="5" width="100%" border="0">
													<tr>
														<td class="content" align="center">
															<uc1:WSControl id="WSControl1" runat="server"></uc1:WSControl>
														</td>
													</tr>
												</table>
											</TD>
