...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MappedURLs.aspx.vb" Inherits="StoreFront.StoreFront.MappedURLs" smartNavigation="true" %>
<%@ Register TagPrefix="uc1" TagName="TopSubBanner" Src="CommonControls/TopSubBanner.ascx" %>
<%@ Register TagPrefix="uc1" TagName="TopBanner" Src="CommonControls/TopBanner.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Instruction" Src="../CommonControls/Instruction.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftColumnNav" Src="CommonControls/LeftColumnNav.ascx" %>
<%@ Register TagPrefix="ucl" TagName="MappedURLsControl" Src="Controls/MappedURLsControl.ascx" %>
			...
			<table cellspacing="0" class="GeneralTable">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="TopSubBanner2" runat="server" Title="Mapped URLs"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button --><a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/urlmap_ov.asp ')"><img src="images/help.jpg" border="0"></a>
									<!-- End Help Button --></td>
							</tr>
							<tr>
								<td class="Content">
										...
										<tr>
											...
											<td class="Content" align="left">
												<table class="Content" cellpadding="5" width="100%">
													<tr>
														<td class="Content">
															<ucl:MappedURLsControl id="MappedURLsControl1" runat="server"></ucl:MappedURLsControl>
														</td>
													</tr>
												</table>
											</td>
