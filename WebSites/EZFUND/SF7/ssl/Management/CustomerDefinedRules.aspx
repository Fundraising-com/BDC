...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CustomerDefinedRules.aspx.vb" Inherits="StoreFront.StoreFront.CustomerDefinedRules"%>
<%@ Register TagPrefix="uc1" TagName="CustomerDefinedRulesControl" Src="Controls/CustomerDefinedRulesControl.ascx" %>
				...
				<tr>
					...
					<td class="Content" vAlign="top">
						...
						<table cellSpacing="3" cellPadding="5" width="100%" border="0">
								...
								<td class="content" vAlign="top" align="center" width="100%">
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											...
											<TD class="Content" id="tcEditCustDefinedRules" align="center" runat="server"><%= IIF(restrictedPages(tasks.CustomerDefinedRules)=true,"<span class=DisableLink>&nbsp;&nbsp;Customer Defined Rules&nbsp;&nbsp;</span>","<a class=content href='CustomerDefinedRules.aspx'><b>&nbsp;Customer Defined Rules&nbsp;</b></a>")%></TD>
											<%-- end Tee --%>
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
										</tr>
										<tr>
												...
												<table class="content" cellSpacing="3" cellPadding="5" width="100%" border="0">
													<tr>
														<td class="content" align="center">
															...
															<p>
															<uc1:CustomerDefinedRulesControl id="CustomerDefinedRulesControl1" runat="server"></uc1:CustomerDefinedRulesControl>
															</p>
														</td>
													</tr>
												</table>
							...
							<tr>
								<td class="content" height="1"><img height="1" src="images/clear.gif"></td>
							</tr>
						</table>
					<!-- Content End --></td>
				</tr>
