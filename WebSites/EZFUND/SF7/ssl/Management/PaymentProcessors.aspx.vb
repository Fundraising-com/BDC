...
Partial Class PaymentProcessors
    Inherits CWebPage
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If MyBase.RestrictedPages(Tasks.OnlineProcessing) = True Then
    ...
    ' begin: jdb - ECheck Limitation
    Private Sub PaymentProcessors_DisplayError(ByVal sender As Object, ByVal e As System.EventArgs) Handles PaymentProcessors.DisplayError
        Me.ErrorMessage.Visible = True
        Me.ErrorMessage.Text = sender
    End Sub
    ' end: jdb - ECheck Limitation
