<%@ Page Language="vb" AutoEventWireup="false" Codebehind="affiliatepaymentlist.aspx.vb" Inherits="StoreFront.StoreFront.affiliatepaymentlist"%>
<%@ Register TagPrefix="uc1" TagName="AffiliatePaymentlistCtrl" Src="Controls/AffiliatePaymentlistCtrl.ascx" %>
...
<td class="LeftColumn" id="LeftColumnCell">
	...
	<td class="Content" vAlign="top">
		...
		<td class="Content" align="right">
			<!-- Help Button -->
			<A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/afftpp_pp.asp ')"><img src="images/help.jpg" border="0"></A>
			<!-- End Help Button -->
		</td>
		</tr>
		<tr>
		...
		<TD class="content" vAlign="top" align="middle">
			...
			<td class="Content" align="middle"><A class="content" href="affiliatepayments.aspx"><b>Manage Payments</b></A></td>
			<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
			<td class="Content" align="middle"><A class="content" href="affiliatelist.aspx">Manage Affiliates</A></td>
			<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
			<td class="Content" align="middle"><A class="content" href="addaffliate.aspx">Add Affiliates</A></td>
			<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
			...
			<TD class="content" vAlign="top" align="middle" colSpan="7">
				...
				<tr>
				<td class="content" align="middle"><uc1:affiliatepaymentlistctrl id="AffiliatePaymentlistCtrl1" runat="server"></uc1:affiliatepaymentlistctrl></td>
				</tr>
				</table>
			</TD>
			<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
