<%@ Page Language="vb" AutoEventWireup="false" Codebehind="addaffliate.aspx.vb" Inherits="StoreFront.StoreFront.addaffliate"%>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<A href="javascript: doHelp(' http://support.storefront.net/mtdocs70/afftpp_cn_man.asp ')">
								...
								<TD class="content" vAlign="top" align="middle" colSpan="2">
									<table class="content" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											...
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
												<A class="content" href="addaffliate.aspx"><b>Add Affiliates</b></A>
											</td>
											<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
											<td class="Content" align="middle">
