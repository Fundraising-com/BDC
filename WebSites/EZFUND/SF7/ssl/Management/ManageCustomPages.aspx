<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManageCustomPages.aspx.vb" ValidateRequest="false" Inherits="StoreFront.StoreFront.ManageCustomPages"%>
<%@ Register TagPrefix="uc1" TagName="TopSubBanner" Src="CommonControls/TopSubBanner.ascx" %>
<%@ Register TagPrefix="uc1" TagName="TopBanner" Src="CommonControls/TopBanner.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Instruction" Src="../CommonControls/Instruction.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftColumnNav" Src="CommonControls/LeftColumnNav.ascx" %>
<%@ Register TagPrefix="cc1" Namespace="StoreFront.UITools" Assembly="UITools" %>
<%@ Register TagPrefix="uc1" TagName="addeditcustompages" Src="Controls/addeditcustompages.ascx" %>
			...
			<table cellspacing="0" class="GeneralTable">
				...
				<tr>
					<td class="TopSubBanner" id="TopSubBannerCell" colSpan="3">
						<uc1:TopSubBanner id="Topsubbanner2" runat="server" Title="Manage Custom Page"></uc1:TopSubBanner>
					</td>
				</tr>
				<tr>
						...
						<table width="100%" cellSpacing="3" cellPadding="5" border="0">
							<tr>
								<td class="Content" align="right">
									<!-- Help Button -->
									<a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/pages_addedit.asp ')">
										...
										<tr>
											...
											<td class="Content" align="left">
												<table class="Content" cellpadding="5" width="100%">
													<tr>
														<td class="Content">
															<uc1:addeditcustompages id="Addeditcustompages1" runat="server"></uc1:addeditcustompages>
														</td>
													</tr>
												</table>
											</td>
