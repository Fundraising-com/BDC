...
Partial Class ProductDiscounts
    ...
    Protected WithEvents ProductDiscounts As ProductDiscountsControl
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If MyBase.RestrictedPages(Tasks.Discounts) = True Then
        ...
        Try
            ...
            CType(ProductDiscounts.FindControl("cmdSave"), LinkButton).Attributes.Add("onclick", "return SetValidation();")
        ...
        Get
            ...
            Select Case iProductType
                Case 2 'merchant bundles
                    Return String.Format(HELP_URL_FORMAT, "merchbdl_sbs4")
                Case 4 'customer bundles
                    Return String.Format(HELP_URL_FORMAT, "custbdl_sbs4")
                Case Else 'products
                    Return String.Format(HELP_URL_FORMAT, "products_discounts")
            End Select
