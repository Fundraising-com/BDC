<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CSRCustAddressBook.aspx.vb" Inherits="StoreFront.StoreFront.CSRCustAddressBook" %>
									...
									<table cellSpacing="3" cellPadding="5" width="100%" border="0">
										<tr>
								            <td class="Content" align="right">
									            <!-- Help Button -->
									            <a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/csr_addressbook.asp  ')">
										...
										<tr>
											<td class="Content" width="100%">
												...
												<ajax:AjaxPanel id="AjaxPanel1" width="100%" runat="server">
													<uc1:CSRAddressBook id="CSRAddressBook1" runat="server" width="100%"></uc1:CSRAddressBook>
												</ajax:AjaxPanel>
											</td>
										</tr>
									</table>
