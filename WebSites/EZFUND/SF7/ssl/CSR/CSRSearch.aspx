<%@ Page validaterequest="false" Language="vb" AutoEventWireup="false" Codebehind="CSRSearch.aspx.vb" Inherits="StoreFront.StoreFront.CSRSearch" %>
<%@ Register TagPrefix="uc1" TagName="CSRSearchControl" Src="Controls/CSRSearchControl.ascx" %>
									...
									<table cellSpacing="3" cellPadding="5" width="100%" border="0">
										<tr>
								            <td class="Content" align="right">
									            <!-- Help Button -->
									            <a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/csr_search.asp  ')">
										...
										<tr>
											<td class="Content" width="100%">
												...
												<ajax:AjaxPanel id="AjaxPanel1" width="100%" runat="server">
													<uc1:CSRSearchControl id="Search1" runat="server" width="100%"></uc1:CSRSearchControl>
												</ajax:AjaxPanel>
											</td>
										</tr>
									</table>
