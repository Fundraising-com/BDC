<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CSRAddressLabel.ascx.vb" Inherits="StoreFront.StoreFront.CSRAddressLabel" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
