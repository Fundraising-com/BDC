<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CSRConfirmControl.ascx.vb" Inherits="StoreFront.StoreFront.CSRConfirmControl" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
<%@ Register TagPrefix="uc1" TagName="AddressLabel" Src="CSRAddressLabel.ascx" %>
<%@ Register TagPrefix="cc1" Namespace="StoreFront.UITools" Assembly="UITools" %>
<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR>
		<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
		<TD class="ContentTableHeader">&nbsp;</TD>
		<TD class="ContentTableHeader" colSpan="3">Order&nbsp;Number:&nbsp;&nbsp;<asp:label ID="OrderNumber" Runat="server"></asp:label></TD>
		<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
	</TR>
	<TR>
	...
	<TR>
		<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
		<TD class="ContentTableHeader">&nbsp;</TD>
		<TD class="ContentTableHeader" colSpan="3">Billing Information
		</TD>
		<td class="ContentTableHeader" width="1"><IMG src="images/clear.gif" width="1"></td>
	</TR>
	<TR>
	...
	<TR>
		...
		<TD class="Content" vAlign="top" width="50%"><uc1:addresslabel id="BillingAddress" runat="server"></uc1:addresslabel>
			<br>
			<asp:Label Runat="server" ID="lblEmail" CssClass="content"></asp:Label></TD>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
		...
		<td class="Content" align="right" width="50%"><cc1:totaldisplay id="TotalDisplay1" runat="server" DisplayTaxShipNotIncluded="False" DisplayOrderTotal="False"
				DisplayCountryTaxTotal="true" DisplayDiscountTotal="true" DisplayHandlingTotal="False" DisplayLocalTaxTotal="true" DisplayMerchandiseTotal="False"
				...
				HandlingTotalLabel="Handling:" SubHandlingTotalLabel="Handling:"></cc1:totaldisplay></td>
	</tr>
</table>
