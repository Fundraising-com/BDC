<%@ Register TagPrefix="uc1" TagName="CSRGiftWrapControl" Src="Controls/CSRGiftWrapControl.ascx" %>
<%@ Register TagPrefix="ajax" Namespace="MagicAjax.UI.Controls" Assembly="MagicAjax" %>
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CSRGiftWraps.aspx.vb" Inherits="StoreFront.StoreFront.CSRGiftWraps" %>
									...
									<table cellSpacing="3" cellPadding="5" width="100%" border="0">
										<tr>
								            <td class="Content" align="right">
									            <!-- Help Button -->
									            <a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/csr_giftwraps.asp  ')">
										...
										<tr>
											<td class="Content" width="100%">
												...
												<ajax:AjaxPanel id="AjaxPanel1" width="100%" runat="server">
													<uc1:CSRGiftWrapControl id="GiftWrap1" runat="server" width="100%"></uc1:CSRGiftWrapControl>
												</ajax:AjaxPanel>
											</td>
										</tr>
									</table>
