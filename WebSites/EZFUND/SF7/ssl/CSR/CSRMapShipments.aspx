<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CSRMapShipments.aspx.vb" Inherits="StoreFront.StoreFront.CSRMapShipments" %>
<%@ Register TagPrefix="uc1" TagName="CSRMapShipmentsControl" Src="Controls/CSRMapShipmentsControl.ascx" %>
...
window.opener.Form.item("FillShipping").value="1"
									...
									<table cellSpacing="3" cellPadding="5" width="100%" border="0">
										<tr>
								            <td class="Content" align="right">
									            <!-- Help Button -->
									            <a href="javascript: doHelp(' http://support.storefront.net/mtdocs70/csr_mapshipments.asp  ')">
										...
										<tr>
											<td class="Content" width="100%">
												...
												<ajax:AjaxPanel id="AjaxPanel1" width="100%" runat="server">
													<uc1:CSRMapShipmentsControl id="GiftWrap1" runat="server" width="100%"></uc1:CSRMapShipmentsControl>
												</ajax:AjaxPanel>
											</td>
										</tr>
									</table>
