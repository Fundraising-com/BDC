    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (m_objcustomer.IsSignedIn = False) Then
            ...
            If (Request.QueryString("Affiliate") <> "") Then
                Response.Redirect("CustSignInCheckout.aspx?ReturnPage=MultiShip.aspx&WebID=" & MyBase.m_objCustomer.GetSessionID & "&Affiliate=" & Request.QueryString("Affiliate"))
            Else
                Response.Redirect("CustSignInCheckout.aspx?ReturnPage=MultiShip.aspx&WebID=" & MyBase.m_objCustomer.GetSessionID)
            End If
        End If
        ...
        Try
            ...
            imgManage.ImageUrl = dom.Item("SiteProducts").Item("SiteImages").Item("ManageAddresses").Attributes("Filepath").Value
            ...
            For Each con In Repeater1.Items
                CType(con.FindControl("imgNewManage"), System.Web.UI.WebControls.Image).ImageUrl = dom.Item("SiteProducts").Item("SiteImages").Item("AddAddress").Attributes("Filepath").Value
            Next
