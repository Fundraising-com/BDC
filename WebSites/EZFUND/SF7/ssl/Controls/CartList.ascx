...
<ul class="cartnav">
	<li class="account"><a href="<%=StoreFrontConfiguration.SiteURL%>custprofilemain.aspx?WebID=<%=Session("WebID")%>">My Account</a></li>
	<li class="viewcart"><a href="<%=StoreFrontConfiguration.SiteURL%>shoppingcart.aspx?WebID=<%=Session("WebID")%>">View Cart</a></li>
	<li class="checkout"><a href="<%=StoreFrontConfiguration.SiteURL%>shoppingcart.aspx?WebID=<%=Session("WebID")%>">Checkout</a></li>
</ul>
<ul class="shopcart">
