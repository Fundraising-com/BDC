...
function popUpPreview(spage)
{
	var sFeatures, h, w, myThanks, i, top, left
	h = window.screen.availHeight 
	w = window.screen.availWidth 
	...
	sFeatures = "height=" + 750 + ",width=" + 800 + ",screenY=" + h + ",screenX=" + w + ",top=" + top + ",left=" + left + ",resizable,scrollbars=no,location=no"
	myThanks = window.open(spage,"",sFeatures)
}
