...
<%@ Register TagPrefix="uc1" TagName="HomePageTemplate1" Src="Controls/HomePageTemplate1.ascx" %>
<%@ Register TagPrefix="uc1" TagName="HomePageTemplate2" Src="Controls/HomePageTemplate2.ascx" %>
<%@ Register TagPrefix="uc1" TagName="HomePageTemplate3" Src="Controls/HomePageTemplate3.ascx" %>
						...
						<table id="PageSubTable" cellSpacing="0" cellPadding="0" width="100%" align="center" border="1"
							...
							<tr>
								...
								<td class="Content" vAlign="top" id="ContentCell">
									<!-- Content Start -->
									<uc1:HomePageTemplate1 id="HomePageTemplate11" runat="server" visible="False"></uc1:HomePageTemplate1>
									<uc1:HomePageTemplate2 id="Homepagetemplate21" runat="server" visible="False"></uc1:HomePageTemplate2>
									<uc1:HomePageTemplate3 id="Homepagetemplate31" runat="server" visible="False"></uc1:HomePageTemplate3>
									<!-- Content End -->
								</td>
