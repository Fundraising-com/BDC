...
#Region "Private Sub Page_Load()"
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Me.IsRewrittenURL Then
            ...
            Me.SearchTemplate2PageIndex = iCurrentPageIndex
...
#End Region
    ...
    Private Sub BindSearchData()
        ...
        MyBase.PageIndex = Me.mPageIndex
        ' begin: JDB - Search Filters
        Dim oSearchFilters As Hashtable = Me.SearchFiltersControl1.GetSearchFilters
        ...
        End If
        SetSearchLabels()
        SetResultsDisplay(m_objSearchEngine)
...
#Region "Private Sub SetResultsDisplay()"
    ...
    Private Sub SetResultsDisplay(ByVal m_objSearchEngine As CSearchEngine)
    ...
    Private Sub DataGrid1_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid1.ItemCreated
        ...
        If (e.Item.ItemType = ListItemType.Pager) Then
            ...
            If Me.IsRewrittenURL Then
                ...
                If Me.SearchTemplate2PageIndex > 0 Then
                    oLink = New HtmlAnchor
                    oLink.HRef = "../" + StoreFrontConfiguration.GetCategoryLink(iCategoryId, sCategoryName, Me.SearchTemplate2PageIndex)
                ...
                End If
                If Me.SearchTemplate2PageIndex < Me.DataGrid1.PageCount - 1 Then
                    oSpace = New Literal
                    oSpace.Text = "&nbsp;"
                    objCell.Controls.Add(oSpace)

                    oLink = New HtmlAnchor
                    oLink.HRef = "../" + StoreFrontConfiguration.GetCategoryLink(iCategoryId, sCategoryName, Me.SearchTemplate2PageIndex + 2)
            ...
            Else
                ...
                If (SearchTemplate2PageIndex > 0) Then
                    objSpace = New Label
                    objSpace.Text = "&nbsp;"
                ...
                End If
                If (SearchTemplate2PageIndex < DataGrid1.PageCount - 1) Then
                    objSpace = New Label
                    objSpace.Text = "&nbsp;"
...
#Region "Private Sub DataGrid1_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGrid1.PageIndexChanged"
    ...
    Private Sub DataGrid1_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DataGrid1.PageIndexChanged
        SearchTemplate2PageIndex = e.NewPageIndex
        MyBase.PageIndex = SearchTemplate2PageIndex
        Me.BindSearchData()
    End Sub
    ...
    Private Sub DataGrid1_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.ItemCommand
        If (e.CommandSource.GetType Is GetType(LinkButton)) Then
            ...
            If (objButton.Text.IndexOf("Next") <> -1) Then
                DataGrid1.CurrentPageIndex = SearchTemplate2PageIndex + 1
            ElseIf (objButton.Text.IndexOf("Previous") <> -1) Then
                DataGrid1.CurrentPageIndex = SearchTemplate2PageIndex - 1
            End If
            SearchTemplate2PageIndex = DataGrid1.CurrentPageIndex
            Me.BindSearchData()
        End If
    End Sub
        ...
        Try
            If objItem.Inventory.InventoryTracked Then
                ...
                If (IsNothing(dgItem.FindControl("StockInfo")) = False) Then
                    ...
                    objInventoryLink.Attributes.Add("OnClick", "return DisplayStockStatus('" & objInventoryLink.UniqueID & "');")
                    'end Tee
                End If
            Else
                If (IsNothing(dgItem.FindControl("trStockStatus")) = False) Then
...
#Region "Sub DisplayFromDefaults(ByVal dgItem As DataGridItem)"
    Protected Sub DisplayFromDefaults(ByVal dgItem As DataGridItem)
        ...
        If Not (dgItem.DataItem Is Nothing) Then
            tempCartItem = dgItem.DataItem
            If IsNothing(dgItem.FindControl("btnAddToCart")) = False Then
                CType(dgItem.FindControl("btnAddToCart"), LinkButton).CommandName = tempCartItem.ProductID
            End If
            If (m_bDisplayPriceSalePrice = False) Then
                ...
                End If
                'Verisign Recurring Billing
                'If the product is subscription type hide the regular price label
                If tempCartItem.ProductType = ProductType.Subscription OrElse _
                    ...
                    End If
                    If (IsNothing(dgItem.FindControl("lblRegularPriceDisplay")) = False) Then
                        CType(dgItem.FindControl("lblRegularPriceDisplay"), Label).Visible = False
                    End If
                    If (IsNothing(dgItem.FindControl("tdSubscriptionPrice")) = False) Then
                        dgItem.FindControl("tdSubscriptionPrice").Visible = True
                    End If
                    If (IsNothing(dgItem.FindControl("tdRecurringPrice")) = False) Then
                        dgItem.FindControl("tdRecurringPrice").Visible = True
                    End If
                End If
                'Verisign Recurring Billing
            Else
                ...
                If (IsNothing(dgItem.FindControl("lblRecurringPriceDisplay")) = False) Then
                    CType(dgItem.FindControl("lblRecurringPriceDisplay"), Label).Text = PriceDisplay2(tempRecurringPrice) & " " & SystemBase.ProductHelperModule.GetPaymentPeriodName(tempCartItem.PaymentPeriod) ' recurring period
                End If
                'Verisign Recurring Billing
                If (IsNothing(dgItem.FindControl("lblRegularPriceDisplay")) = False) Then
                ...
                If tempCartItem.IsOnSale And tempSalePrice < tempRegPrice Then
                    If tempCustomPrice < tempSalePrice And tempCustomPrice <> 0 Then
                        ...
                        If tempCartItem.ProductType = ProductType.Subscription OrElse _
                            ...
                            tempCartItem.ProductType = ProductType.CustomizedSubscription Then
                            If (IsNothing(dgItem.FindControl("tdSubscriptionPrice")) = False) Then
                                dgItem.FindControl("tdSubscriptionPrice").Visible = False
                            End If
                            If (IsNothing(dgItem.FindControl("tdRecurringPrice")) = False) Then
                                dgItem.FindControl("tdRecurringPrice").Visible = True
                            End If
...
#Region "Private Sub GetCustomPricing(ByVal objGridItem As DataGridItem)"
    ...
    Public Sub MakePriceLabelsVisible(ByVal dgItem As DataGridItem)
        ...
        If (IsNothing(dgItem.FindControl("lblSubscriptionPrice")) = False) Then
            dgItem.FindControl("lblSubscriptionPrice").Visible = False
        End If
        If (IsNothing(dgItem.FindControl("lblRecurringPrice")) = False) Then
            dgItem.FindControl("lblRecurringPrice").Visible = False
        End If
        'Verisign Recurring Billing
    End Sub
...
#Region "SP8"
    ...
    Protected Overrides Sub LoadViewState(ByVal savedState As Object)
        ...
        Me.SearchTemplate2PageIndex = savedState(1)
    ...
    Protected Overrides Function SaveViewState() As Object
        ...
        myState(1) = Me.SearchTemplate2PageIndex
        myState(2) = Me.objStorage
        Return myState
    End Function

    Public Property SearchTemplate2PageIndex() As Integer
        Get
            Return mPageIndex
        End Get
