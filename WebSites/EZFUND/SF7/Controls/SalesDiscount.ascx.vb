...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For Each con In DataList1.Items
            CType(con.FindControl("imgCouponRemove"), System.Web.UI.WebControls.Image).ImageUrl = dom.Item("SiteProducts").Item("SiteImages").Item("Remove").Attributes("Filepath").Value
        Next
    ...
    Private Sub DataList1_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles DataList1.ItemCreated
        ...
        If (IsNothing(objButton) = False) And (IsNothing(dom) = False) Then
            objButton.ImageUrl = dom.Item("SiteProducts").Item("SiteImages").Item("Remove").Attributes("Filepath").Value
        End If
    End Sub
End Class
