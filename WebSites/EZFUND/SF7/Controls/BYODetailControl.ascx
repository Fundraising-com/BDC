<%@ Control Language="vb" AutoEventWireup="false" Codebehind="BYODetailControl.ascx.vb" Inherits="StoreFront.StoreFront.BYODetailControl" TargetSchema="http://schemas.microsoft.com/intellisense/nav4-0" %>
      ...
      src='<%# DataBinder.Eval(Me,"ImageString") %>'></asp:panel>
		...
		<TD class="Content" vAlign="top" width="100%">
            ...
            ID:&nbsp;</asp:label><%# DataBinder.Eval(Product,"ProductCode") %></TD>
				...
				<TR id="trStockInfo">
					<TD class="Content" vAlign="top"><asp:linkbutton id=StockInfo onclick=StockButton_Click Runat="server" Text="Stock Status" CommandName='<%#DataBinder.Eval(Product,"ProductID") %>'>
						</asp:linkbutton></TD>
				</TR>
				<TR>
...
<br>
<table id="SeperatorLine" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
	<tr>
