...
<div class="search">
	<ul>
		...
		<li class="button"><asp:LinkButton id="btnSearch" Runat="server"><asp:Image BorderWidth="0" ID="imgSearch" Runat="server" AlternateText="Search" ImageAlign="AbsBottom"></asp:Image></asp:LinkButton></li>
		<li class="advsearch"><a href="<%=StoreFrontConfiguration.SiteURL%>Search.aspx?Advanced=1">Advanced Search</a></li>
	</ul>
</div>