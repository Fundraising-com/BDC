...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            DynaCart.DataBind()
        End If
        DynaCart.RemoveImg = dom.Item("SiteProducts").Item("SiteImages").Item("Remove").Attributes("Filepath").Value
        DynaCart.SavedCartImg = dom.Item("SiteProducts").Item("SiteImages").Item("SaveCart").Attributes("Filepath").Value
        DynaCart.ReOrderImg = dom.Item("SiteProducts").Item("SiteImages").Item("ReOrder").Attributes("Filepath").Value
        DynaCart.GiftWrapImg = dom.Item("SiteProducts").Item("SiteImages").Item("GiftWrap").Attributes("Filepath").Value
    ...
    'begin: GJV - issue # 257 - customize labels using the values defined in merchant tools
    Private Function CustomizeLabel(ByVal sID As String, ByVal sDefault As String) As String

        Dim sLabel As String = StoreFrontConfiguration.Labels.Item(sID).InnerText()

        If Not sLabel.Trim.Equals(String.Empty) Then
            Return sLabel.Trim
        End If
    ...
    End Function
    Public Function CustomizeProductLabel(ByVal sDefault As String) As String
        Return CustomizeLabel("lblProductName", sDefault)
    End Function
    Public Function CustomizePriceLabel(ByVal sDefault As String) As String
        Return CustomizeLabel("lblPrice", sDefault)
    End Function
    Public Function CustomizeStatusLabel(ByVal sDefault As String) As String
        Return CustomizeLabel("lblStockInfo", sDefault)
    End Function
    'end: GJV - issue # 257
