...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OrderTracking.aspx.vb" Inherits="StoreFront.StoreFront.OrderTracking"%>
<%@ Register TagPrefix="uc1" TagName="TrackingForOrder" Src="Controls/TrackingForOrder.ascx" %>
...
<HTML>
	<HEAD>
		<title><% writeTitle() %> - Order Tracking</title>
							...
							<tr>
								...
								<td class="Content" vAlign="top" id="ContentCell">
										...
										<table cellSpacing="3" cellPadding="5" width="100%" border="0">
											<tr>
												<td class="Instructions" width="100%">
													<!-- Instruction Start -->
											...
											<tr>
												<td class="Content" width="100%">
													<P id="ErrorAlignment" runat="server" align=center>
														<asp:Label id="ErrorMessage" runat="server" CssClass="ErrorMessages" Visible="False">
														</asp:Label>
													</P>
													<P id="MessageAlignment" runat="server">
														<asp:label id="Message" runat="server" Visible="False" CssClass="Messages">
														</asp:label>
													</P>
												</td>
											</tr>
											<TR>
												<TD class="Content" align="left" width="100%">
													<uc1:TrackingForOrder id="TrackingForOrder1" runat="server" Order=<%# databinder.eval(me,"Order")%> AddressID='<%# databinder.eval(me,"AddressID")%>'></uc1:TrackingForOrder></TD>
											</TR>
										</table>
									<!-- Content End -->
								</td>
