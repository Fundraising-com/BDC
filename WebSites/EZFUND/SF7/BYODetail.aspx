<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BYODetail.aspx.vb" Inherits="StoreFront.StoreFront.BYODetail" %>
<%@ Register TagPrefix="uc1" TagName="BYODetailControl" Src="Controls/BYODetailControl.ascx" %>
									...
									<table cellSpacing="3" cellPadding="5" width="100%" border="0">
										<tr>
											<td class="Content">
												...
												<uc1:BYODetailControl id="BYODetailControl" runat="server"></uc1:BYODetailControl>
												</td>
										</tr>
									</table>
									<!-- Content End -->
