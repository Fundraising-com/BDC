...
var s_account="rdefrrecaudarfondosdev";
...
s.linkInternalFilters="javascript:,localhost,recaudarfondoswebdev,recaudarfondos,recaudarfondosweb,recaudar-fondos.com,www.recaudar-fondos.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Form Analysis Config */
s.formList="editorForm,friendForm,collectionForm,a"
...
+"'')+'://'+(s.ssl?'somtrkpix':'omtrkpix')+'.rd.com/b/ss/'+s.un+'/1/H"
