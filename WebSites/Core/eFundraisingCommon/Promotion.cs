...
namespace GA.BDC.Core.eFundraisingCommon
{
	...
	/// </summary>
	public class Promotion : BusinessBase.BusinessBase
	{
		#region Constructors
		public Promotion()
		{
		...
		#region Fields
       // private Promotion _promoInfo = new Promotion();
        ...
        public static Promotion GetPromotionBYABID(string abid, string aaid)
        {
            EFRCommonDatabase dbo = new EFRCommonDatabase();
            return dbo.GetPromotionBYABID(abid, aaid);
        }
        ...
        {
             EFRCommonDatabase dbo = new EFRCommonDatabase();
			 return dbo.InsertNewPromo(partner, promoType, promoName, displayable, abid);
