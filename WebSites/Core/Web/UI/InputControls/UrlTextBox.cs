...
namespace GA.BDC.Core.Web.UI.InputControls
{
	...
	*/
	...
	/// </summary>
	[DesignerAttribute(typeof(UrlTextBoxDesigner), typeof(IDesigner))]
	[DefaultEvent("Click")]
	public class UrlTextBox : BaseInputControl {
		public UrlTextBox() {
	...
	/// </summary>
	public class UrlTextBoxDesigner : ControlDesigner {
		public UrlTextBoxDesigner() {
