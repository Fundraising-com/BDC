...
{
    [Serializable]
    public class TopSupporterStats : StatsBase
    {
        ...
        #region Constructor
        public TopSupporterStats() : this(1, string.Empty, 0, 0M, 0M, System.DateTime.MinValue) { }
        public TopSupporterStats(int counter, string name, int subsSold, decimal totalAmount, decimal totalDonationAmount, DateTime createDate) 
        {
            _counter = counter;
            _name = name;
            _subsSold = subsSold;
        ...
        public static List<StatsBase> Load(eSubsGlobalEnvironment env)
        {
            ...
            return dbo.GetParticipantZoneStatsByReportType(ParticipantZone_ReportName.TOP_SUPPORTERS, env.Event.EventID, env.EventParticipation.EventParticipationID);
        }
        #endregion
    }
}
