...
namespace GA.BDC.Core.ESubsGlobal.ContentViewer {
	...
	public class OffendingKeyWord {

		private string _message;

		private Keywords _keywords = null;

		public OffendingKeyWord() : this(null) { }
		public OffendingKeyWord(string message) {
			_message = message;
		}
		...
		public virtual string GenerateXML() {
			...
			IdentXML(_keywords.GenerateXML()) + 
			"</OffendingKeyWord>\r\n";
		}
		#endregion
		...
		public virtual void Load(XmlNode childNodes) {
			foreach(XmlNode node in childNodes) {
				if(node.Name.ToLower() == "message") {
					SetXmlValue(ref _message, node.InnerText);
				}
				if(node.Name.ToLower() == "keywords") {
