...
namespace GA.BDC.Core.ESubsGlobal.Payment {
	...
	public enum PaymentStatusCategory : int
	{
		InProcess = 1,
		Sent = 2,
		UnCashed = 3,
	...
	public class PaymentStatus {
		...
		public PaymentStatus() : this(int.MinValue) { }
		public PaymentStatus(int paymentStatusId) : this(paymentStatusId, null) { }
		public PaymentStatus(int paymentStatusId, string description) {
		...
		public static PaymentStatus[] GetPaymentStatuss() {
			DataAccess.ESubsGlobalDatabase dbo = new DataAccess.ESubsGlobalDatabase();
			return dbo.GetPaymentStatuss();
		}
		...
		public static PaymentStatus GetPaymentStatusByID(int id) {
			DataAccess.ESubsGlobalDatabase dbo = new DataAccess.ESubsGlobalDatabase();
			return dbo.GetPaymentStatusByID(id);
		}
		public static PaymentStatus GetPaymentStatusByPaymentID(int id)
		{
			DataAccess.ESubsGlobalDatabase dbo = new DataAccess.ESubsGlobalDatabase();
			return dbo.GetPaymentStatusByPaymentID(id);
		}
		public int Insert() {
			DataAccess.ESubsGlobalDatabase dbo = new DataAccess.ESubsGlobalDatabase();
			return dbo.InsertPaymentStatus(this);
		}

		public int Update() {
			DataAccess.ESubsGlobalDatabase dbo = new DataAccess.ESubsGlobalDatabase();
			return dbo.UpdatePaymentStatus(this);
		}
		#endregion
