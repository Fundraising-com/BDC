...
namespace GA.BDC.Core.efundraisingCore.DataAccess
{
	...
	/// </summary>
	public class EFundDatabase : GA.BDC.Core.Data.Sql.DatabaseObject
	{
		public EFundDatabase()
		{
            SetConnectionString(Config.EFundWebConnectionString);
            SetDataProvider(Config.EFundWebDataProvider);
		}
        ...
        // use EFundraingCRM.DataAccess.GA.BDC.CoreCRMDatabase.
