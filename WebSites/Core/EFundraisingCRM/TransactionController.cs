...
using GA.BDC.Core.EFundraisingCRM.DataAccess;
...
namespace GA.BDC.Core.EFundraisingCRM
{
	...
	public class TransactionController : EFundraisingCRMLogic
	{
		...
		public void InsertPaymentsAndCommentsAndUpdateSales(PaymentCollection payments, SaleCollection sales, CommentsCollection comments)
		{
			EFundraisingCRMDatabase dbo = new EFundraisingCRMDatabase();
			//dbo.InsertPaymentsAndCommentsAndUpdateSales(payments, sales, comments);
		}
