...
namespace GA.BDC.Core.EFundraisingCRM
{
	...
	/// </summary>
	public abstract class EFundraisingCRMCollectionBase : GA.BDC.Core.Collections.BusinessCollectionBase {
		...
		public virtual void SortByProperty(string propertyName)
		{
			...
			{
            (this.List[i] as GA.BDC.Core.BusinessBase.BusinessBase).sortByPropertyName = propertyName;
			}
			Sort();
		...
		public virtual void SortByProperty(string propertyName, bool inAscending)
		{
			...
			{
            (this.List[i] as GA.BDC.Core.BusinessBase.BusinessBase).sortByPropertyName = propertyName;
            (this.List[i] as GA.BDC.Core.BusinessBase.BusinessBase).sortByAscending = inAscending;
			}
			Sort();
		}
