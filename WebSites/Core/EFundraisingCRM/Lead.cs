...
namespace GA.BDC.Core.EFundraisingCRM {
	...
	public class Lead: EFundraisingCRMDataObject {
	    ...
	    {
	        return string.Format("Lead Id: {0}", leadId);
	    }
		...
		{
			DataAccess.EFundraisingCRMDatabase dbo = new GA.BDC.Core.EFundraisingCRM.DataAccess.EFundraisingCRMDatabase();
	...
	public class LeadCollection : GA.BDC.Core.Collections.BusinessCollectionBase
	{
