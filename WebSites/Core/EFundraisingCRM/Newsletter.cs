...
namespace GA.BDC.Core.EFundraisingCRM {
	...
	public class Newsletter: EFundraisingCRMDataObject {
        ...
        public DataTable DownloadMailingList(int partnerID, string beginDate, string endDate, string countrySelected)
        {
            DataAccess.EFundraisingCRMDatabase dbo = new DataAccess.EFundraisingCRMDatabase();
            return dbo.RetrieveDataFromMailListTables(partnerID, beginDate, endDate, countrySelected);
        }
