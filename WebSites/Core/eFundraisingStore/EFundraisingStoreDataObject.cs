...
namespace GA.BDC.Core.eFundraisingStore
{
	...
	//To determine what result is returned from a non query



	public abstract class eFundraisingStoreDataObject : eFundraisingStoreObject
	{
		public eFundraisingStoreDataObject()
		{
