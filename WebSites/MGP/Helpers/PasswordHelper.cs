    ...
    public class PasswordHelper
    {
		...
		protected char GetRandomCharacter() {            
			...
			if ( true == this.ExcludeSymbols ) {
				upperBound = PasswordHelper.UBoundDigit;
			}
		...
		public int Minimum {
			...
			set { 
				this.minSize = value;
				if ( PasswordHelper.DefaultMinimum > this.minSize ) {
					this.minSize = PasswordHelper.DefaultMinimum;
				}
			}
		}
		...
		public int Maximum {
			...
			set { 
				...
				if ( this.minSize >= this.maxSize ) {
					this.maxSize = PasswordHelper.DefaultMaximum;
				}
			}
		}
