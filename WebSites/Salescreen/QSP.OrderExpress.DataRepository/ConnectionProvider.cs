...
namespace QSPForm.DataRepository
{
	...
	public class ConnectionProvider : IDisposable
	{
		...
		private void InitClass()
		{
			...
			_dBConnection.ConnectionString = QSPForm.Common.QSPFormConfiguration.SynchConnectionString;
		...
		public bool BeginTransaction(string transactionName, System.Data.IsolationLevel iso)
		{
			try
			{
				if(_isTransactionPending)
				...
				// begin the transaction and store the transaction object.
				_currentTransaction = _dBConnection.BeginTransaction(iso, transactionName);
				_isTransactionPending = true;
				_savePoints.Clear();
				return true;
			}
