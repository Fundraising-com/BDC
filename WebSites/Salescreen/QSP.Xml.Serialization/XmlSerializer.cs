...
namespace QSP.Xml.Serialization
{

    /// <summary>
    /// Serializes and deserializes objects into and from XML documents. The QSP.Xml.Serialization.XmlSerializer enables you to control how objects are encoded into XML. 
    /// </summary>
    public class XmlSerializer
    {
        ...
        /// </summary>
        /// <param name="type">The type of the object that this QSP.Xml.Serialization.XmlSerializer can serialize.</param>
