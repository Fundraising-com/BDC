...
namespace QSP.Site.MyFeedback
{
	...
	/// </summary>
	internal sealed class SqlSessionManager
	{
		#region Fields
		...
		static SqlSessionManager()
		{
			...
			configuration.SetProperty(NHibernate.Cfg.Environment.ConnectionString, System.Configuration.ConfigurationManager.ConnectionStrings["QSP.Site.MyFeedback"].ConnectionString);
