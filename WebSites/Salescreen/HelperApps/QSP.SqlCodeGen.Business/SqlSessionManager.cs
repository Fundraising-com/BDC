...
namespace QSP.SqlCodeGen.Business
{
	...
	public sealed class SqlSessionManager
	{
		...
		{
			SqlSessionManager.Configuration.SetProperty(NHibernate.Cfg.Environment.ConnectionString, connectionString);
			sessionFactory = configuration.BuildSessionFactory();
		}

		public static void SetDialect(string dialect)
		{
			SqlSessionManager.Configuration.SetProperty(NHibernate.Cfg.Environment.Dialect, dialect);
			sessionFactory = configuration.BuildSessionFactory();
		}

		public static void SetConnectionDriver(string driver)
		{
			SqlSessionManager.Configuration.SetProperty(NHibernate.Cfg.Environment.ConnectionDriver, driver);
			sessionFactory = configuration.BuildSessionFactory();
		}
