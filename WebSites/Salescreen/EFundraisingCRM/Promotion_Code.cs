...
namespace efundraising.EFundraisingCRM {
	...
	public class PromotionCode: EFundraisingCRMDataObject {
        ...
        private string promotionExternalCode;


		public PromotionCode() : this(int.MinValue) { }
		public PromotionCode(int promotionCodeID) : this(promotionCodeID, null) { }
		public PromotionCode(int promotionCodeID, string promotionCodeDesc) : this(promotionCodeID,promotionCodeDesc, null) { }
        public PromotionCode(int promotionCodeID, string promotionCodeDesc, string promotionExternalCode)
        {
			this.promotionCodeID = promotionCodeID;
			this.promotionCodeDesc = promotionCodeDesc;
            this.promotionExternalCode = promotionExternalCode;
		}
        ...
        public string PromotionExternalCode
        {
            set { promotionExternalCode = value; }
            get { return promotionExternalCode; }
        }
		#endregion
	}
}
