...
//					}
			...
			
		{
			...
			if (saleId == int.MinValue)
			{
				...
				{					
					efundraising.Diagnostics.Logger.LogError("DoSaleTallySalePackByStudent: Cannot SaveTallySalePackByStudent", ex);
				}
				return newSale;
			}
			else
			{
				...
				if (theSale != null)
				{
					...
					{
						efundraising.Diagnostics.Logger.LogError("UpdateAndInsertSalesItemsPackByParticipants: Cannot Update Sale", ex);
					}
					return theSale;
				}
				return null;
