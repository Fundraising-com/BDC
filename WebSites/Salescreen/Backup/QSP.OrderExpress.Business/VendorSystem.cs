...
namespace QSPForm.Business
{
	...
	using dataAccessRef = QSPForm.Data.Vendor;
	...
	public class VendorSystem : BusinessSystem
	{
		...
		//   Validates a specific Vendor Ownership Table field against his maxlength 
		// Returns:
