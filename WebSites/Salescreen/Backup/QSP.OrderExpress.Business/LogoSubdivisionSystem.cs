...
namespace QSPForm.Business
{
	...
	using dataAccessRef = QSPForm.Data.LogoSubdivision;
	...
	public class LogoSubdivisionSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public LogoSubdivisionSystem()
		{
		...
		{
			dataDef dTbl;
			dTbl = objDataAccess.SelectAllByLogoID(LogoID);		
			return dTbl;		
		}
