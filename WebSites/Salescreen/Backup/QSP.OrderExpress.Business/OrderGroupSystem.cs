...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.OrderGroupTable;
	using dataAccessRef = QSPForm.Data.Order_group;
	...
	public class OrderGroupSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public OrderGroupSystem()
		{
