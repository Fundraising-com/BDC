...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.CatalogGroupTable;
	using dataAccessRef = QSPForm.Data.CatalogGroup;
	...
	public class CatalogGroupSystem : BusinessSystem
	{
		...
		//   Validates a specific CatalogGroup Ownership Table field against his maxlength 
		// Returns:
...
//		public dataDef SelectAll_Search(int SearchType, String Criteria, int CatalogGroupType, string SubdivisionCode)
//		{			
//			dataDef dTbl;
//			
//			//
//			// Get the user DataTable from the DataLayer
//			//				
//			dTbl = objDataAccess.SelectAll_Search(SearchType, Criteria, CatalogGroupType, SubdivisionCode);				
//			
//			return dTbl;			
//		}				
