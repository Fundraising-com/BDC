...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.CustomerTable;
	using dataAccessRef = QSPForm.Data.Customer;
	...
	public class CustomerSystem : BusinessSystem
	{
		...
		//   Validates a specific Customer Ownership Table field against his maxlength 
		// Returns:
...
//			}
		...
		{			
			...
			// Get the user DataTable from the DataLayer
			//
			dTbl = objDataAccess.SelectAllWaccount_idLogic(ID);				
			
			return dTbl;
			
		}	
		
		public dataDef SelectAllByFM_ID(string FM_ID)
		{			
			dataDef dTbl;			
			//
			// Get the user DataTable from the DataLayer
			//
			dTbl = objDataAccess.SelectAllWfm_idLogic(FM_ID);				
