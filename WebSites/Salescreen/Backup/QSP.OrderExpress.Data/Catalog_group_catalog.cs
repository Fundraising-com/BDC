///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'catalog_group'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'catalog_group group'.
	/// </summary>
	public class CatalogGroupCatalog : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@icatalog_group_catalog_id";
		...
		private const string SQL_PROC_DELETE = "pr_catalog_group_catalog_Delete";
		private const string SQL_PROC_INSERT = "pr_catalog_group_catalog_Insert";
		private const string SQL_PROC_UPDATE = "pr_catalog_group_catalog_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_catalog_group_catalog_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_catalog_group_catalog_SelectAll";
		...
		{
			get{return dataDef.TBL_CATALOG_GROUP_CATALOG;}
		}
		...
		public dataDef SelectAllWcatalog_idLogic(int CatalogID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_catalog_group_catalog_SelectAllWcatalog_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			
			cmdToExecute.Parameters.Add(new SqlParameter("@icatalog_id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CatalogID));
		...
		public dataDef SelectAllWcatalog_group_idLogic(int CatalogGroupID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_catalog_group_catalog_SelectAllWcatalog_group_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			
			cmdToExecute.Parameters.Add(new SqlParameter("@icatalog_id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CatalogGroupID));
...
//		public dataDef SelectAllWcatalog_group_idLogic(int CatalogGroupCatalogID)
//		{
//			dataDef Table = new dataDef();
//
//			SqlCommand	cmdToExecute = new SqlCommand();
//			cmdToExecute.CommandText = "dbo.pr_catalog_group_SelectAllWcatalog_group_idLogic";
//			cmdToExecute.CommandType = CommandType.StoredProcedure;
//			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_CATALOG_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CatalogGroupCatalogID));
//			
//					
//			Select(cmdToExecute,Table);
//			
...
//			dataDef Table = new dataDef();
//			SqlCommand	cmdToExecute = new SqlCommand();
//			cmdToExecute.CommandText = "dbo.pr_catalog_group_SelectAll_Search";
//			cmdToExecute.CommandType = CommandType.StoredProcedure;
//			if (AccountType > 0)
