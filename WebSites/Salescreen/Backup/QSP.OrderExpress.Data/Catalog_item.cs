...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'catalog_item'.
	/// </summary>
	public class CatalogItem : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@icatalog_item_id";
		public const string PARAM_CATALOG_ID ="@icatalog_id";
		public const string PARAM_PRODUCT_ID ="@iproduct_id";
		public const string PARAM_CODE ="@scatalog_item_code";
		public const string PARAM_NAME ="@scatalog_item_name";	
		...
		protected override SqlCommand GetInsertCommand()
		{
			if ( insertCommand == null )
			{
				...
				sqlParams.Add(new SqlParameter(PARAM_PRODUCT_ID, SqlDbType.Int));
				...
				sqlParams[PARAM_PRODUCT_ID].SourceColumn = dataDef.FLD_PRODUCT_ID;
		...
		{
			get{return dataDef.TBL_CATALOG_ITEM;}
		}
		...
		public dataDef SelectAllWcatalog_idLogic(int CatalogID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_catalog_item_SelectAllWcatalog_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
		...
		public dataDef SelectAllWproduct_idLogic(int ProductID)
		{
			dataDef Table = new dataDef();

			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_catalog_item_SelectAllWproduct_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PRODUCT_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ProductID));
