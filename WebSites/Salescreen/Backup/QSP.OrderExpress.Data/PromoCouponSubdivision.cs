...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class PromoCouponSubdivision : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iPromo_Coupon_subdivision_id";
		public const string PARAM_SUBDIVISION_CODE = "@ssubdivision_code";
		public const string PARAM_PROMO_COUPON_ID = "@iPromo_Coupon_id";
		
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_INSERT = "pr_QSPForm_Promo_Coupon_Subdivision_Insert";
		private const string SQL_PROC_UPDATE = "pr_QSPForm_Promo_Coupon_Subdivision_Update";
		private const string SQL_PROC_DELETE = "pr_QSPForm_Promo_Coupon_Subdivision_Delete";
		private const string SQL_PROC_SELECT_ONE = "pr_QSPForm_Promo_Coupon_Subdivision_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_QSPForm_Promo_Coupon_Subdivision_SelectAll";
		private const string SQL_PROC_SELECT_ALL_BY_Promo_Coupon_ID = "pr_QspForm_Promo_Coupon_Subdivision_SelectAllByPromo_CouponID";
		...
		private void FillParams(SqlParameterCollection param)
		{
			...
			param.Add(new SqlParameter(PARAM_PROMO_COUPON_ID,SqlDbType.Int));
		...
		private void MapColumn(SqlParameterCollection param)
		{
			...
			param[PARAM_PROMO_COUPON_ID].SourceColumn = dataDef.FLD_Promo_Coupon_ID;
			param[PARAM_SUBDIVISION_CODE].SourceColumn = dataDef.FLD_SUBDIVISION_CODE;
		}

		protected override string TableName
		{
			get{return dataDef.TBL_PROMO_COUPON_SUBDIVISION;}
		}
		...
		public dataDef SelectAll_Search(string Criteria, string FSM_ID)
		{
			...
			cmdToExecute.CommandText = "dbo.pr_QSPForm_Promo_Coupon_SelectAll_Search";
		...
		public new dataDef SelectOne(int Promo_CouponSubdivisionID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ONE;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, Promo_CouponSubdivisionID));
			Select(cmdToExecute,Table);
			return Table;
		}
		public dataDef SelectAllByPromoCouponID(int Promo_CouponID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ALL_BY_Promo_Coupon_ID;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PROMO_COUPON_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, Promo_CouponID));
			Select(cmdToExecute,Table);
			return Table;
		}
