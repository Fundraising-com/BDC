...
using dataDef = QSPForm.Common.DataDef.FormGroupTable;

namespace QSPForm.Data
{
	/// <summary>
	/// Purpose: Data Access class for the table 'Form_group'.
	/// </summary>
	public class Form_group : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iform_group_id";
		public const string PARAM_FORM_GROUP_NAME = "@sform_group_name";
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_DELETE = "pr_form_group_Delete";
		private const string SQL_PROC_INSERT = "pr_form_group_Insert";
		private const string SQL_PROC_UPDATE = "pr_form_group_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_form_group_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_form_group_SelectAll";
		...
		protected override SqlCommand GetInsertCommand()
		{
			if ( insertCommand == null )
			{
				...
				sqlParams.Add(new SqlParameter(PARAM_FORM_GROUP_NAME, SqlDbType.VarChar, 100));
				...
				sqlParams[PARAM_FORM_GROUP_NAME].SourceColumn = dataDef.FLD_FORM_GROUP_NAME;
		...
		{
			get{return dataDef.TBL_FORM_GROUP;}
		}
		...
		public dataDef SelectAllWentity_type_idLogic(int EntityTypeID, int ProgramTypeID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_form_group_SelectAllWentity_type_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
		...
		{						
			return SelectAllWentity_type_idLogic(EntityTypeID, 0);			
		}
		...
		public dataDef SelectAllWprogram_type_idLogic(int ProgramTypeID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_form_group_SelectAllWprogram_type_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter("@iprogram_type_id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ProgramTypeID));
