///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'order_status_change'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'order_status_change'.
	/// </summary>
	public class Order_status_change : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iorder_status_change_id";
		...
		private const string SQL_PROC_DELETE = "pr_order_status_change_Delete";
		private const string SQL_PROC_INSERT = "pr_order_status_change_Insert";
		private const string SQL_PROC_UPDATE = "pr_order_status_change_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_order_status_change_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_order_status_change_SelectAll";
		...
		{
			get{return dataDef.TBL_ORDER_STATUS_CHANGE;}
		}
		...
		public dataDef SelectAllWorder_idLogic(int CampaignID)
		{
			dataDef Table = new dataDef();

			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_order_status_change_SelectAllWorder_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_ORDER_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CampaignID));
