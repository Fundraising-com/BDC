...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class Customer : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@icustomer_id";
		...
		private const string SQL_PROC_DELETE = "pr_customer_Delete";
		private const string SQL_PROC_INSERT = "pr_customer_Insert";
		private const string SQL_PROC_UPDATE = "pr_customer_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_customer_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_customer_SelectAll";
		...
		{
			get{return dataDef.TBL_CUSTOMER;}
		}
		
		//We create a new method when we want to the return type variable
		public new dataDef SelectOne(int CustomerID)
		{
			...
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CustomerID));
		...
		public dataDef SelectAllWaccount_idLogic(int AccountID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_customer_SelectAllWaccount_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
		...
		public dataDef SelectAllWfm_idLogic(string FSM_ID)
		{
			dataDef Table = new dataDef();

			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_customer_SelectAllWfm_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter("@sfm_id", SqlDbType.VarChar, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, FSM_ID));
