...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class Promo : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@ipromo_id";
		public const string PARAM_PROMO_COUPON_ID = "@ipromo_coupon_id";
		public const string PARAM_PROMO_NAME = "@spromo_name";
		...
		public const string PARAM_START_DATE ="@dalabeling_start_date";
		public const string PARAM_END_DATE ="@dalabeling_end_date";
        ...
        public const string PARAM_FORMAT = "@iformat_id";
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_INSERT = "pr_QSPForm_promo_Insert";
		private const string SQL_PROC_UPDATE = "pr_QSPForm_promo_Update";	
		private const string SQL_PROC_DELETE = "pr_QSPForm_promo_Delete";
		private const string SQL_PROC_SELECT_ONE = "pr_QSPForm_promo_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_QSPForm_promo_SelectAll";
		...
		private void FillParams(SqlParameterCollection param)
		{
			...
			param.Add(new SqlParameter(PARAM_PROMO_NAME,SqlDbType.VarChar, 50));
			...
			param.Add(new SqlParameter(PARAM_START_DATE, SqlDbType.DateTime));
			param.Add(new SqlParameter(PARAM_END_DATE, SqlDbType.DateTime));
			param.Add(new SqlParameter(PARAM_ENABLED, SqlDbType.Bit));
			param.Add(new SqlParameter(PARAM_APPROVED, SqlDbType.Bit));
			param.Add(new SqlParameter(PARAM_APPROVE_CODE, SqlDbType.VarChar, 50));
		...
		private void MapColumn(SqlParameterCollection param)
		{
			...
			param[PARAM_PROMO_NAME].SourceColumn = dataDef.FLD_PROMO_NAME;
			...
			param[PARAM_START_DATE].SourceColumn = dataDef.FLD_START_DATE;
			param[PARAM_END_DATE].SourceColumn = dataDef.FLD_END_DATE;
			param[PARAM_ENABLED].SourceColumn = dataDef.FLD_ENABLED;
			param[PARAM_APPROVED].SourceColumn = dataDef.FLD_APPROVED;
			param[PARAM_APPROVE_CODE].SourceColumn = dataDef.FLD_APPROVE_CODE;
