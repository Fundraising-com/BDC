...
namespace QSPForm.Common.DataDef
{
	...
	public class PromoCouponSubdivisionTable : DataTable, System.Collections.IEnumerable
	{		
		
		public const string TBL_PROMO_COUPON_SUBDIVISION = "QSPForm_Promo_Coupon_subdivision";
		public const string FLD_PKID = "Promo_Coupon_subdivision_id";
		...
		public PromoCouponSubdivisionTable() : 
			base(TBL_PROMO_COUPON_SUBDIVISION) 
		{
			this.InitClass();
		}
		    
		public PromoCouponSubdivisionTable(DataTable table) : 
		...
		/// </summary>
		public PromoCouponSubdivisionTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}		
		...
		{			
			...
			//
			this.TableName = TBL_PROMO_COUPON_SUBDIVISION;
