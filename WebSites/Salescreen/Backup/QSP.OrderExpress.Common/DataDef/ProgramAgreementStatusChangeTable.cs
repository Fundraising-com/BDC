...
namespace QSPForm.Common.DataDef
{
	...
	public class ProgramAgreementStatusChangeTable : DataTable, System.Collections.IEnumerable
	{
		//
		//ProgramAgreement Header constants
		// 
		/// <value>The constant used for ProgramAgreement table. </value>
		public const String TBL_PROGRAM_AGREEMENT_STATUS_CHANGE = "program_agreement_status_change";
		/// <value>The constant used for PKId field in the ProgramAgreement table. </value>
		public const String FLD_PKID = "program_agreement_status_change_id";
        ...
        /// <value>The constant used for the program_agreement "Status ID" field in the ProgramAgreement table. </value>
		...
		public ProgramAgreementStatusChangeTable() : 
                base(TBL_PROGRAM_AGREEMENT_STATUS_CHANGE) {
            this.InitClass();
        }
		    
        public ProgramAgreementStatusChangeTable(DataTable table) : 
        ...
        public override DataTable Clone() {
            ProgramAgreementStatusChangeTable cln = ((ProgramAgreementStatusChangeTable)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        
        protected override DataTable CreateInstance() {
            return new ProgramAgreementStatusChangeTable();
        }
        ...
        private void InitClass() {	
			...
			//
			this.TableName = TBL_PROGRAM_AGREEMENT_STATUS_CHANGE;
