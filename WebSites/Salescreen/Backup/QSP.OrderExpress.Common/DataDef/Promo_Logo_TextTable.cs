...
namespace QSPForm.Common.DataDef
{
	...
	public class Promo_Logo_TextTable : DataTable, System.Collections.IEnumerable
	{		
		
		public const string TBL_Promo_Logo_Text = "QSPForm_Promo_logo_Text";
		public const string FLD_PKID = "Promo_Logo_Text_id";
		...
		public Promo_Logo_TextTable() : 
			base(TBL_Promo_Logo_Text) 
		{
			this.InitClass();
		}
		    
		public Promo_Logo_TextTable(DataTable table) : 
		...
		/// </summary>
		public Promo_Logo_TextTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}		
		...
		{			
			...
			//
			this.TableName = TBL_Promo_Logo_Text;
