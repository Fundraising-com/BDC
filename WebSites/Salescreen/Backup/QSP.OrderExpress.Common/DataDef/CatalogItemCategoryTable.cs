...
namespace QSPForm.Common.DataDef
{
	...
	public class CatalogItemCategoryTable : DataTable
	{
		//
		//Order Header constants
		// 
		/// <value>The constant used for catalog_item_category table. </value>
		public const String TBL_CATALOG_ITEM_CATEGORY = "catalog_item_category";
		/// <value>The constant used for PKId field in the CatalogItemCategory table. </value>
		public const String FLD_PKID = "catalog_item_category_id";
		/// <value>The constant used for the catalog_item_category name field in the Order table. </value>
		public const String FLD_NAME = "catalog_item_category_name";
		/// <value>The constant used for catalog_item_category Unit field in the Order table. </value>
		public const String FLD_CATALOG_GROUP_ID = "catalog_group_id";
		/// <value>The constant used for catalog_item_category Unit field in the Order table. </value>
		public const String FLD_CATALOG_ID = "catalog_id";
		/// <value>The constant used for catalog_item_category Unit field in the Order table. </value>
		public const String FLD_PARENT_ID = "parent_catalog_item_category_id";
		...
		public CatalogItemCategoryTable() : base(TBL_CATALOG_ITEM_CATEGORY) 
		{
			this.InitClass();
		}
		    
		public CatalogItemCategoryTable(DataTable table) : base(table.TableName) 
		{
		...
		{
			CatalogItemCategoryTable cln = ((CatalogItemCategoryTable)(base.Clone()));
			cln.InitVars();
			return cln;
		}
		...
		{
			return new CatalogItemCategoryTable();
		}
		...
		{	
			...
			//
			this.TableName = TBL_CATALOG_ITEM_CATEGORY;
