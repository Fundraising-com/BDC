...
Comments               : " + Comments;
			...
			SendMail.AsyncSend(Config.SmtpServer,
                "service@efundraising.com", "jason.farrell@qsp.com", 
				"", "", "", "", subject, body, "");
#else		
            SendMail.AsyncSend(Config.SmtpServer, "service@efundraising.com", fcEmail, "xavier_desaunettes@qsp.com", "jason_farrell@qsp.com", "", "", subject, body, "");
#endif
        }
...
Comments               : " + Comments;
			...
			SendMail.AsyncSend(Config.SmtpServer, 
				...
				"efr-sale-support@qsp.com", "jason_farrell@qsp.com", "", "", subject, body, "");
#endif
        }
