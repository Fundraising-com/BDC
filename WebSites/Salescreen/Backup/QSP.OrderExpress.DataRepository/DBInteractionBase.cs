...
namespace QSPForm.DataRepository
{
	...
	public abstract class DBInteractionBase// : ICommonDBAccess //: ServicedComponent,
	{
		...
		public DBInteractionBase()
		{
			...
			_mainConnection.ConnectionString = QSPForm.Common.QSPFormConfiguration.SynchConnectionString;
	...
	//					_configReader.GetValue("Main.ConnectionString", typeof(System.String)).ToString();
		...
		protected bool ExecuteCmd(SqlCommand Command)
		{
			...
			{	
				...
				Command.CommandTimeout = QSPForm.Common.QSPFormConfiguration.SynchCommandTimeOut;
				if(_mainConnectionIsCreatedLocal)
				{
					// Open connection.
		...
		protected int UpdateBatch(SqlDataAdapter adapter,DataTable Table)
		{
			...
			try
			{		
				adapter.InsertCommand.CommandTimeout = QSPForm.Common.QSPFormConfiguration.SynchCommandTimeOut;				
				adapter.UpdateCommand.CommandTimeout = QSPForm.Common.QSPFormConfiguration.SynchCommandTimeOut;
				adapter.DeleteCommand.CommandTimeout = QSPForm.Common.QSPFormConfiguration.SynchCommandTimeOut;
				if(_mainConnectionIsCreatedLocal)
				{
					// Open connection.
					adapter.InsertCommand.Connection = _mainConnection;					
