...
namespace efundraising.EFundraisingCRM {
	...
	public class ClientAddress: EFundraisingCRMDataObject {
        ...
        public ClientAddress(int addressId, string clientSequenceCode, int clientId, string addressType, string streetAddress, string stateCode, string countryCode, string city, string zipCode, string attentionOf, string matchingCode, int addressZoneId, string phone1, string phone2) : this(addressId, clientSequenceCode, clientId, addressType, streetAddress, stateCode, countryCode, city, zipCode, attentionOf, matchingCode, addressId, phone1, phone2, null) { }
        public ClientAddress(int addressId, string clientSequenceCode, int clientId, string addressType, string streetAddress, string stateCode, string countryCode, string city, string zipCode, string attentionOf, string matchingCode, int addressZoneId, string phone1, string phone2, string location) {
