...
namespace efundraising.EFundraisingCRM.Linq
{
	...
	[Table(Name="dbo.payment_invoice")]
	public partial class payment_invoice
	{
		...
		[Column(Storage="_payment_invoice_id", DbType="Int NOT NULL")]
		...
		[Column(Storage="_payment_id", DbType="Int")]
		...
		[Column(Storage="_invoice_id", DbType="Int")]
		...
		[Column(Storage="_payment_type_id", DbType="Char(10)")]
	...
	[Table(Name="dbo.adjustment_invoice")]
    ...
    partial void Onupdate_user_idChanged();
		...
		[Column(Storage="_adjustment_invoice_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_adjustment_id", DbType="Int NOT NULL")]
		...
		[Association(Name="adjustment_fulf_adjustment_invoice", Storage="_adjustment_fulf", ThisKey="adjustment_id", OtherKey="adjustment_id", IsForeignKey=true)]
		...
		[Association(Name="invoice_adjustment_invoice", Storage="_invoice", ThisKey="invoice_id", OtherKey="invoice_id", IsForeignKey=true)]
    ...
    partial void Onfulf_account_idChanged();
		...
		[Column(Storage="_adjustment_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int adjustment_id
		{
			get
			{
		...
		[Column(Storage="_adjustment_type_id", DbType="Int NOT NULL")]
		...
		[Column(Storage="_adjustment_date", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_transaction_date", DbType="DateTime")]
		...
		[Column(Storage="_is_created_by_ar_sync", DbType="Bit")]
		...
		[Column(Storage="_fulf_ar_sequence_line", DbType="Int")]
		...
		[Association(Name="adjustment_fulf_adjustment_invoice", Storage="_adjustment_invoices", ThisKey="adjustment_id", OtherKey="adjustment_id")]
    ...
    partial void Onfulf_account_idChanged();
		...
		[Column(Storage="_payment_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_payment_date", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_payment_type_id", DbType="Int")]
		...
		[Column(Storage="_payment_code_id", DbType="Int")]
		...
		[Column(Storage="_credit_card_id", DbType="Int")]
		...
		[Column(Storage="_bank_check_id", DbType="Int")]
    ...
    partial void Onfulf_account_idChanged();
		...
		[Column(Storage="_invoice_date", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_invoice_status_id", DbType="Int")]
		...
		[Column(Storage="_noncommission_amount", DbType="Decimal(18,2)")]
		...
		[Association(Name="invoice_adjustment_invoice", Storage="_adjustment_invoices", ThisKey="invoice_id", OtherKey="invoice_id")]
		public EntitySet<adjustment_invoice> adjustment_invoices
		{
			get
			{
