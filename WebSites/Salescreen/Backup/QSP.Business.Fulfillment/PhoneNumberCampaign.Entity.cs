...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`phone_number_campaign`")]
	public partial class PhoneNumberCampaign
	{
		#region Constants
        public const string PhoneNumberCampaignEntity = "PhoneNumberCampaign";
		public const string PhoneNumberCampaignIdProperty = "PhoneNumberCampaignId";
		...
		#region Fields
		protected int phoneNumberCampaignId = 0;
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""PhoneNumberCampaignId"" column=""`phone_number_campaign_id`"">
			<generator class=""native"">
			</generator>
		</id>")]

		public virtual int PhoneNumberCampaignId
		{
			get { return this.phoneNumberCampaignId; }
			set { this.phoneNumberCampaignId = value; }
		}
        ...
        public static List<PhoneNumberCampaign> GetPhoneNumberCampaignList(ICriteria criteria)
        {
            return (List<PhoneNumberCampaign>)criteria.List<PhoneNumberCampaign>();
        }

		public static PhoneNumberCampaign GetPhoneNumberCampaign(int phoneNumberCampaignId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<PhoneNumberCampaign>(phoneNumberCampaignId);
			}
		}

		public static List<PhoneNumberCampaign> GetPhoneNumberCampaignList()
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PhoneNumberCampaign));
		...
		public static List<PhoneNumberCampaign> GetPhoneNumberCampaignList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PhoneNumberCampaign));
		...
		public static List<PhoneNumberCampaign> GetPhoneNumberCampaignList(string sortExpression)
		{
			return GetPhoneNumberCampaignList(sortExpression, -1, -1);
		}

		public static void InsertPhoneNumberCampaign(PhoneNumberCampaign obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdatePhoneNumberCampaign(PhoneNumberCampaign obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeletePhoneNumberCampaign(PhoneNumberCampaign obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static PhoneNumberCampaign PopulatePhoneNumberCampaign(IDataReader r)
		{
			PhoneNumberCampaign obj = new PhoneNumberCampaign();
			obj.PhoneNumberCampaignId = (int)r["phone_number_campaign_id"];
		...
		public override bool Equals(object obj)
		{
			...
			PhoneNumberCampaign castObj = (PhoneNumberCampaign)obj;
			return (castObj != null && this.phoneNumberCampaignId == castObj.PhoneNumberCampaignId);
		}
		...
		{
			return 29 * (1 + this.phoneNumberCampaignId.GetHashCode());
		}
		#endregion
	}
}
