...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`postal_address_account`")]
	public partial class PostalAddressAccount
	{
		#region Constants
        public const string PostalAddressAccountEntity = "PostalAddressAccount";
		public const string PostalAddressAccountIdProperty = "PostalAddressAccountId";
		...
		#region Fields
		protected int postalAddressAccountId = 0;
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""PostalAddressAccountId"" column=""`postal_address_account_id`"">
			<generator class=""native"">
			</generator>
		</id>")]

		public virtual int PostalAddressAccountId
		{
			get { return this.postalAddressAccountId; }
			set { this.postalAddressAccountId = value; }
		}
        ...
        public static List<PostalAddressAccount> GetPostalAddressAccountList(ICriteria criteria)
        {
            return (List<PostalAddressAccount>)criteria.List<PostalAddressAccount>();
        }

		public static PostalAddressAccount GetPostalAddressAccount(int postalAddressAccountId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<PostalAddressAccount>(postalAddressAccountId);
			}
		}

		public static List<PostalAddressAccount> GetPostalAddressAccountList()
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PostalAddressAccount));
		...
		public static List<PostalAddressAccount> GetPostalAddressAccountList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PostalAddressAccount));
		...
		public static List<PostalAddressAccount> GetPostalAddressAccountList(string sortExpression)
		{
			return GetPostalAddressAccountList(sortExpression, -1, -1);
		}

		public static void InsertPostalAddressAccount(PostalAddressAccount obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdatePostalAddressAccount(PostalAddressAccount obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeletePostalAddressAccount(PostalAddressAccount obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static PostalAddressAccount PopulatePostalAddressAccount(IDataReader r)
		{
			PostalAddressAccount obj = new PostalAddressAccount();
			obj.PostalAddressAccountId = (int)r["postal_address_account_id"];
		...
		public override bool Equals(object obj)
		{
			...
			PostalAddressAccount castObj = (PostalAddressAccount)obj;
			return (castObj != null && this.postalAddressAccountId == castObj.PostalAddressAccountId);
		}
		...
		{
			return 29 * (1 + this.postalAddressAccountId.GetHashCode());
		}
		#endregion
	}
}
