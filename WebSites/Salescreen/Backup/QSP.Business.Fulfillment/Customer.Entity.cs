...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`customer`")]
	public partial class Customer
	{
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(Customer));
                return c;
            }
        }

        public static List<Customer> GetCustomerList(ICriteria criteria)
        {
            return (List<Customer>)criteria.List<Customer>();
        }
		...
		public static List<Customer> GetCustomerList()
		{
			...
			{
				ICriteria c = session.CreateCriteria(typeof(Customer));
				return (List<Customer>)c.List<Customer>();
			}
		}

		public static List<Customer> GetCustomerList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(Customer));
		...
		public static List<Customer> GetCustomerList(string sortExpression)
		{
			return GetCustomerList(sortExpression, -1, -1);
		}

		public static void InsertCustomer(Customer obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdateCustomer(Customer obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeleteCustomer(Customer obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static Customer PopulateCustomer(IDataReader r)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return (castObj != null && this.customerId == castObj.CustomerId);
		}
		...
		{
			return 29 * (1 + this.customerId.GetHashCode());
		}
		#endregion
	}
}
