...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`to_do`")]
	public partial class ToDo
	{
		#region Constants
        public const string ToDoEntity = "ToDo";
		public const string ToDoIdProperty = "ToDoId";
		public const string ToDoNameProperty = "ToDoName";
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""ToDoId"" column=""`to_do_id`"">
			<generator class=""native"">
			</generator>
		</id>")]

		public virtual int ToDoId
		{
			get { return this.toDoId; }
			set { this.toDoId = value; }
		}

		[Property(Column="`to_do_name`")]
		public virtual string ToDoName
		{
			get { return this.toDoName; }
			set { this.toDoName = value; }
		}
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(ToDo));
                return c;
            }
        }

        public static List<ToDo> GetToDoList(ICriteria criteria)
        {
            return (List<ToDo>)criteria.List<ToDo>();
        }
		...
		public static ToDo GetToDo(int toDoId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<ToDo>(toDoId);
			}
		}
		...
		public static List<ToDo> GetToDoList()
		{
			...
			{
				ICriteria c = session.CreateCriteria(typeof(ToDo));
				return (List<ToDo>)c.List<ToDo>();
			}
		}

		public static List<ToDo> GetToDoList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(ToDo));
		...
		public static List<ToDo> GetToDoList(string sortExpression)
		{
			return GetToDoList(sortExpression, -1, -1);
		}

		public static void InsertToDo(ToDo obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdateToDo(ToDo obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeleteToDo(ToDo obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static ToDo PopulateToDo(IDataReader r)
		{
			ToDo obj = new ToDo();
			obj.ToDoId = (int)r["to_do_id"];
			obj.ToDoName = (string)r["to_do_name"];
			...
			obj.IsComplete = (r["is_complete"] == DBNull.Value) ? null : (bool?)r["is_complete"];
		...
		public override bool Equals(object obj)
		{
			...
			ToDo castObj = (ToDo)obj;
			return (castObj != null && this.toDoId == castObj.ToDoId);
		}
		...
		{
			return 29 * (1 + this.toDoId.GetHashCode());
		}
		#endregion
	}
}
