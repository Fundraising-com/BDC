...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`contact`")]
	public partial class Contact
	{
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(Contact));
                return c;
            }
        }

        public static List<Contact> GetContactList(ICriteria criteria)
        {
            return (List<Contact>)criteria.List<Contact>();
        }
		...
		public static Contact GetContact(int contactId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<Contact>(contactId);
			}
		}
		...
		public static List<Contact> GetContactList()
		{
			...
			{
				ICriteria c = session.CreateCriteria(typeof(Contact));
				return (List<Contact>)c.List<Contact>();
			}
		}

		public static List<Contact> GetContactList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(Contact));
		...
		public static List<Contact> GetContactList(string sortExpression)
		{
			return GetContactList(sortExpression, -1, -1);
		}
        ...
        protected static Contact PopulateContact(IDataReader r)
		{
			Contact obj = new Contact();
			obj.ContactId = (int)r["contact_id"];
			obj.ContactName = (string)r["contact_name"];
		...
		public override bool Equals(object obj)
		{
			...
			return (castObj != null && this.contactId == castObj.ContactId);
		}
		...
		{
			return 29 * (1 + this.contactId.GetHashCode());
		}
		#endregion
	}
}
