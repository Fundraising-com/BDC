...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`postal_address_control_character_issue`")]
	public partial class PostalAddressControlCharacterIssue
	{
		#region Constants
        public const string PostalAddressControlCharacterIssueEntity = "PostalAddressControlCharacterIssue";
		...
		protected bool? residentialArea = null;
		...
		#region Constructors
		public PostalAddressControlCharacterIssue() 
		{
		}
		#endregion
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(PostalAddressControlCharacterIssue));
                return c;
            }
        }

        public static List<PostalAddressControlCharacterIssue> GetPostalAddressControlCharacterIssueList(ICriteria criteria)
        {
            return (List<PostalAddressControlCharacterIssue>)criteria.List<PostalAddressControlCharacterIssue>();
        }

		public static PostalAddressControlCharacterIssue GetPostalAddressControlCharacterIssue(int postalAddressId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<PostalAddressControlCharacterIssue>(postalAddressId);
			}
		}

		public static List<PostalAddressControlCharacterIssue> GetPostalAddressControlCharacterIssueList()
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PostalAddressControlCharacterIssue));
				return (List<PostalAddressControlCharacterIssue>)c.List<PostalAddressControlCharacterIssue>();
			}
		}

		public static List<PostalAddressControlCharacterIssue> GetPostalAddressControlCharacterIssueList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(PostalAddressControlCharacterIssue));
		...
		public static List<PostalAddressControlCharacterIssue> GetPostalAddressControlCharacterIssueList(string sortExpression)
		{
			return GetPostalAddressControlCharacterIssueList(sortExpression, -1, -1);
		}

		public static void InsertPostalAddressControlCharacterIssue(PostalAddressControlCharacterIssue obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdatePostalAddressControlCharacterIssue(PostalAddressControlCharacterIssue obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeletePostalAddressControlCharacterIssue(PostalAddressControlCharacterIssue obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static PostalAddressControlCharacterIssue PopulatePostalAddressControlCharacterIssue(IDataReader r)
		{
			PostalAddressControlCharacterIssue obj = new PostalAddressControlCharacterIssue();
		...
		public override bool Equals(object obj)
		{
			...
			PostalAddressControlCharacterIssue castObj = (PostalAddressControlCharacterIssue)obj;
