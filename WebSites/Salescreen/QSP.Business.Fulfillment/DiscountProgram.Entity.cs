...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`Discount_Program`")]
	public partial class DiscountProgram
	{
		#region Constants
        public const string DiscountProgramEntity = "DiscountProgram";
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""DiscountProgramId"" column=""`Discount_Program_Id`"">
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(DiscountProgram));
                return c;
            }
        }

        public static List<DiscountProgram> GetDiscountProgramList(ICriteria criteria)
        {
            return (List<DiscountProgram>)criteria.List<DiscountProgram>();
        }

		public static DiscountProgram GetDiscountProgram(int discountProgramId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<DiscountProgram>(discountProgramId);
			}
		}

		public static List<DiscountProgram> GetDiscountProgramList()
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(DiscountProgram));
				return (List<DiscountProgram>)c.List<DiscountProgram>();
			}
		}

		public static List<DiscountProgram> GetDiscountProgramList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(DiscountProgram));
		...
		public static List<DiscountProgram> GetDiscountProgramList(string sortExpression)
		{
			return GetDiscountProgramList(sortExpression, -1, -1);
		}

		public static void InsertDiscountProgram(DiscountProgram obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdateDiscountProgram(DiscountProgram obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeleteDiscountProgram(DiscountProgram obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static DiscountProgram PopulateDiscountProgram(IDataReader r)
		{
		...
		public override bool Equals(object obj)
		{
			...
			DiscountProgram castObj = (DiscountProgram)obj;
			return (castObj != null && this.discountProgramId == castObj.DiscountProgramId);
		}
		...
		{
			return 29 * (1 + this.discountProgramId.GetHashCode());
		}
		#endregion
	}
}
