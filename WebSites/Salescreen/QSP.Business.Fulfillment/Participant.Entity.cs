...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`participant`")]
	public partial class Participant
	{
		#region Constants
        public const string ParticipantEntity = "Participant";
		...
		public const string StudentCodeProperty = "StudentCode";
		#endregion
		...
		protected string studentCode = null;
		#endregion
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""ParticipantId"" column=""`participant_id`"">
		...
		[Property(Column="`Student_Code`")]
		public virtual string StudentCode
		{
        ...
        public static ICriteria CreateCriteria()
        {
            ...
            {
                ICriteria c = session.CreateCriteria(typeof(Participant));
                return c;
            }
        }

        public static List<Participant> GetParticipantList(ICriteria criteria)
        {
            return (List<Participant>)criteria.List<Participant>();
        }
		...
		public static Participant GetParticipant(int participantId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<Participant>(participantId);
			}
		}
		...
		public static List<Participant> GetParticipantList()
		{
			...
			{
				ICriteria c = session.CreateCriteria(typeof(Participant));
				return (List<Participant>)c.List<Participant>();
			}
		}

		public static List<Participant> GetParticipantList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(Participant));
		...
		public static List<Participant> GetParticipantList(string sortExpression)
		{
			return GetParticipantList(sortExpression, -1, -1);
		}

		public static void InsertParticipant(Participant obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdateParticipant(Participant obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeleteParticipant(Participant obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static Participant PopulateParticipant(IDataReader r)
		{
			...
			obj.StudentCode = (r["Student_Code"] == DBNull.Value) ? null : (string)r["Student_Code"];
		...
		public override bool Equals(object obj)
		{
			...
			Participant castObj = (Participant)obj;
			return (castObj != null && this.participantId == castObj.ParticipantId);
		}
		...
		{
			return 29 * (1 + this.participantId.GetHashCode());
		}
		#endregion
	}
}
