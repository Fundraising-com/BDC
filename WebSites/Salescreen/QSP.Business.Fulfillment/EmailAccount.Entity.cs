...
{
	[Serializable]
	[Class(Schema="`dbo`", Table="`email_account`")]
	public partial class EmailAccount
	{
		#region Constants
        public const string EmailAccountEntity = "EmailAccount";
		public const string EmailAccountIdProperty = "EmailAccountId";
		...
		#region Fields
		protected int emailAccountId = 0;
		...
		#region Properties
		[RawXml(Content=@"
		<id name=""EmailAccountId"" column=""`email_account_id`"">
			<generator class=""native"">
			</generator>
		</id>")]

		public virtual int EmailAccountId
		{
			get { return this.emailAccountId; }
			set { this.emailAccountId = value; }
		}
        ...
        public static List<EmailAccount> GetEmailAccountList(ICriteria criteria)
        {
            return (List<EmailAccount>)criteria.List<EmailAccount>();
        }

		public static EmailAccount GetEmailAccount(int emailAccountId)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				return session.Get<EmailAccount>(emailAccountId);
			}
		}

		public static List<EmailAccount> GetEmailAccountList()
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(EmailAccount));
		...
		public static List<EmailAccount> GetEmailAccountList(string sortExpression, int maximumRows, int startRowIndex)
		{
			using (ISession session = SqlSessionManager.OpenSession())
			{
				ICriteria c = session.CreateCriteria(typeof(EmailAccount));
		...
		public static List<EmailAccount> GetEmailAccountList(string sortExpression)
		{
			return GetEmailAccountList(sortExpression, -1, -1);
		}

		public static void InsertEmailAccount(EmailAccount obj)
		{
			if (obj != null)
				obj.Insert();
		}

		public static void UpdateEmailAccount(EmailAccount obj)
		{
			if (obj != null)
				obj.Update();
		}

		public static void DeleteEmailAccount(EmailAccount obj)
		{
			if (obj != null)
				obj.Delete();
		}

        protected static EmailAccount PopulateEmailAccount(IDataReader r)
		{
			EmailAccount obj = new EmailAccount();
			obj.EmailAccountId = (int)r["email_account_id"];
		...
		public override bool Equals(object obj)
		{
			...
			EmailAccount castObj = (EmailAccount)obj;
			return (castObj != null && this.emailAccountId == castObj.EmailAccountId);
		}
		...
		{
			return 29 * (1 + this.emailAccountId.GetHashCode());
		}
		#endregion
	}
}
