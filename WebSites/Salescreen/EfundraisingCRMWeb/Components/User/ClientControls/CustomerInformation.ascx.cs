        ...
        private void SetClientAddressPhone(efundraising.EFundraisingCRM.Client cl)
        {
           ...
           if (cl.DayPhone != null && cl.DayPhone.Trim() != string.Empty)
           {
                ...
                try
                {
                    ...
                    if (!cl.DayPhone.Contains("-"))
                    {
                        formattedPhone = string.Format("{0:###-###-####}", long.Parse(cl.DayPhone));
                        string[] split = formattedPhone.Split('-');
            ...
            if (cl.EveningPhone != null && cl.EveningPhone.Trim() != string.Empty)
            {
                try
                {
                    var formattedEvePhone = string.Empty;
                    if (!cl.EveningPhone.Contains("-"))
                    {
                        formattedEvePhone = string.Format("{0:###-###-####}", long.Parse(cl.EveningPhone));
                        string[] split = formattedEvePhone.Trim().Split('-');
