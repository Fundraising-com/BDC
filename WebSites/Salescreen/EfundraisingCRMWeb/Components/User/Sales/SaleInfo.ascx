...
<table cellSpacing="0" cellPadding="1" width="296" style="WIDTH: 296px; HEIGHT: 149px">
	<tr vAlign="top" height="20">
		<td class="NormalText" style="WIDTH: 130px; HEIGHT: 12px">Consultant 
			Name</td>
    ...
    <tr vAlign="top" height="20">
		<td class="NormalText" style="WIDTH: 130px; HEIGHT: 6px">Ext Consult 
			Name</td>
		<td style="HEIGHT: 6px" vAlign="top"><asp:textbox id="extConsultantNnameTextBox" Text=" N/A" CssClass="NormalText normalTextBox" Runat="server"
            ReadOnly="True" BorderStyle="Solid" Width="160px"></asp:textbox></td>
	</tr>
	<tr vAlign="top" height="20">
	...
	<tr vAlign="top" height="20">
		...
		<td vAlign="top"><asp:textbox id="waybillNoTextBox" 
                CssClass="NormalText normalTextBox" Runat="server" BorderStyle="Solid"></asp:textbox></td>
	</tr>
</table>
