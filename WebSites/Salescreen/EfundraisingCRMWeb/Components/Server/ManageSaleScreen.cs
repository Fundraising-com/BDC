...
namespace EFundraisingCRMWeb.Components.Server
{
    ...
    public class ManageSaleScreen : System.Web.UI.Page
    {
        ...
        static ManageSaleScreen()
	    {
            Logger = LogManager.GetLogger(typeof(ManageSaleScreen));
	    }
...
*/
         ...
         public static decimal GetSalesItemProfitPercentage(SalesItem salesItem)
        {
            ...
            {
                Logger.Error("Sales Screen: GetSalesItemProfitPercentage - " + salesItem, ex);
            }
        ...
        public static int GetQtyFree(int scratchBookID, int quantitySold)
        {
            ...
            {
                Logger.Error("Sales Screen: GetQtyFree. sbID = " + scratchBookID + " - QtySold = " + quantitySold, ex);
            }
        ...
        //get gst , pst, hst
        public static void CalculateTaxes(decimal totalAmount, ref decimal hst, ref decimal gst, ref decimal pst, int clientID, string clientSeqCode)
        {
            try
            {
            ...
            {
                Logger.Error("Sales Screen: CalculateTaxes. ClientID = " + clientSeqCode + clientID, ex);
            }
        ...
        public static decimal GetGST(int clientID, string clientSeqCode)
        {
            ...
            {
                Logger.Error("Sales Screen: GetGST. ClientID = " + clientSeqCode + clientID, ex);
            }
            return GST;
        ...
        {  
            ...
            {
                Logger.Error("Sales Screen: GetPST. ClientID = " + clientSeqCode + clientID, ex);
            }
            return PST;
        ...
        //only get hst
        public static decimal GetHST(int clientID, string clientSeqCode)
        {
            decimal HST = 0;
            try
            {
            ...
            {
                Logger.Error("Sales Screen: GetHST. ClientID = " + clientSeqCode + clientID, ex);
            }
            return HST;
        ...
        public static decimal GetItemPrice(ScratchBook sb, decimal profitPercentage, int totalQty)
        {

            decimal raisingPotential = 0;
            decimal itemPrice = 0;
            try
            {
                if (profitPercentage == 0)
                {
                    //business rules for AdditionalColorImprints on tshirts
                    if (sb.ScratchBookId == 4237 || sb.ScratchBookId == 4244 || sb.ScratchBookId == 4245 || sb.ScratchBookId == 4246 || sb.ScratchBookId == 4247 || sb.ScratchBookId == 4326
                        || sb.ScratchBookId == 4327 || sb.ScratchBookId == 4328 || sb.ScratchBookId == 4329 || sb.ScratchBookId == 4330)
                    {
                        itemPrice = GetAdditionalColorImprintPrice(totalQty);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (sb.ScratchBookId == 4179 || sb.ScratchBookId == 4180)
                    {
                        if (totalQty <= 11)
                        {
                            itemPrice = 20;
                        }
                        else if (totalQty >= 12 && totalQty <= 23)
                        {
                            itemPrice = 17;
                        }
                        else if (totalQty >= 24 && totalQty <= 47)
                        {
                            itemPrice = 16;
                        }
                        else
            ...
            {
                Logger.Error("Sales Screen: GetItemPrice - " + sb, ex);
            }
        ...
        //business rules for AdditionalColorImprints on tshirts
        public static decimal GetAdditionalColorImprintPrice(int qt)
        {
            ...
            return Convert.ToDecimal(surchargePrice);
        ...
        public static decimal GetSalesItemTotalProfit(SalesItem salesItem)
        {
            ...
            {
                Logger.Error("Sales Screen: GetSalesItemtotalProfit - " + salesItem, ex);
            }
        ...
        public static DateTime GetMaxDeliveryDate(DataTable productList, DateTime schShipDate)
        {
            ...
            {
                Logger.Error("Sales Screen: GetMaxDeliveryDate - " + productList, ex);
            }
        ...
        public static DateTime GetDeliveryDate(int scratchbookID, DateTime schShipDate)
        {
            ...
            {
                Logger.Error("Sales Screen: GetDeliveryDate - sbID=" + scratchbookID, ex);
            }
        ...
        public static DateTime GetShippingDate(int scratchbookID, DateTime schDelDate)
        {
            ...
            {
                Logger.Error("Sales Screen: GetShippingDate - sbID=" + scratchbookID, ex);
            }
        ...
        public static int GetMaxDeliveryDays(DataTable productList)
        {
            ...
            {
                Logger.Error("Sales Screen: GetMaxDeliveryDays - " + productList, ex);
            }
        ...
        public static int GetDeliveryDays(int scratchbookID)
        {
            ...
            {
                Logger.Error("Sales Screen: GetDeliveryDays - sbID=" + scratchbookID, ex);
            }
        ...
        public static decimal GetTotalShippingFees(DataTable productList, ref DataTable classTotals, decimal customShipping)
        {
            ...
            try
            {
                    ...
                    bool TBProcessed = false;
                    bool KBCAProcessed = false;
                    bool CAcaProcessed = false;
                    bool AFRProcessed = false;
                    bool CandlesProcessed = false;
                    ...
                    foreach (DataRow row in productList.Rows)
                    {
                        ...
                        if (System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ITEM_QTY] == null && nbItems >= minQty)
                        {
                            
                            System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ITEM_QTY] = nbItems;
                        }
                        ...
                        if (customShipping >= 0)
                        {
                            ...
                            if (Convert.ToInt32(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ITEM_QTY]) == Convert.ToInt32(row["NbItems"]))
                            { 
                            ...
                            {
                                 System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ITEM_QTY] = nbItems;
                                var totalAmount = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "TotalAmount", productClassID.ToString()));
                                
                                //GET SHIPPINGFEE for product class
                                ...
                                if (f._ShippingFee != Convert.ToDecimal(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_SHIPPING_FEE]))
                                {
                                    totalShipping = f._ShippingFee;
                                }
                                else
                                {
                                    totalShipping = customShipping;
                            ...
                            //System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ITEM_QTY] = null;
                        ...
                        else
                        {
                            ...
                            int frozenFoodTBID = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("FrozenFoodTBShortAmount", "productClassID"));
                            int KBCAID = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("KBcaShortAmount", "productClassID"));
                            int CADcaShortAmount = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("CADcaShortAmount", "productClassID"));
                            int HeritageCDN = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("CandlesShortAmount", "productClassID"));
                            int AFRID = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("AFRShortAmount", "productClassID"));
                            ...
                            else if (productClassID == KBCAID)
                            {
                                ...
                                totalAmount = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "TotalAmount", productClassID.ToString()));
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                                decimal cost = Convert.ToDecimal(GetValueFromWebConfig("KBcaShortAmount", "value"));
                                int min = Convert.ToInt32(GetValueFromWebConfig("KBcaShortAmount", "min"));

                                decimal KBCAShipping = totalQty * cost;
                                 if (totalQty >= 16)
                                    {
                                        totalShipping = 20; 
                                ...
                                SetValueToDataTable(classTotals, "ProductClassID", "TotalShipping", productClassID.ToString(), KBCAShipping.ToString());
                            }
                            ...
                            //}
                            //tasty batter EXCEPTION
                            else if (productClassID == frozenFoodTBID)
                            {
                                if (TBProcessed)
                                {
                                    continue;
                                ...
                                totalAmount = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "TotalAmount", productClassID.ToString()));
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                                decimal cost = Convert.ToDecimal(GetValueFromWebConfig("FrozenFoodTBShortAmount", "value"));
                                int min = Convert.ToInt32(GetValueFromWebConfig("FrozenFoodTBShortAmount", "min"));

                                decimal TBShipping = 0;
                                if (totalQty < 336)
                                {
                                    totalShipping = totalQty * Convert.ToDecimal(0.70);
                                    TBShipping = totalShipping;

                                }
                               
                                SetValueToDataTable(classTotals, "ProductClassID", "TotalShipping", productClassID.ToString(), TBShipping.ToString());
                            }


                            //Heritage candles EXCEPTION
                            else if (productClassID == HeritageCDN)
                            {
                                if (CandlesProcessed)
                                {
                                    continue;
                                }
                                CandlesProcessed = true;
                                totalAmount = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "TotalAmount", productClassID.ToString()));
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                                decimal cost = Convert.ToDecimal(GetValueFromWebConfig("CandlesShortAmount", "value"));
                                int min = Convert.ToInt32(GetValueFromWebConfig("CandlesShortAmount", "min"));

                                decimal TBShipping = 0;
                                if (totalQty < 120)
                                {
                                    totalShipping = totalQty * cost;
                                    TBShipping = totalShipping;
                            ...
                            else if (productClassID == AFRID)
                            {
                                ...
                                totalAmount = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "TotalAmount", productClassID.ToString()));
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                                decimal cost = Convert.ToDecimal(GetValueFromWebConfig("AFRShortAmount", "value"));
                                int min = Convert.ToInt32(GetValueFromWebConfig("AFRShortAmount", "min"));

                                decimal AFRShipping = 0;
                                if (totalQty < 336)
                                {
                                    totalShipping = totalQty * Convert.ToDecimal(0.70);
                                    AFRShipping = totalShipping;

                                }

                                SetValueToDataTable(classTotals, "ProductClassID", "TotalShipping", productClassID.ToString(), AFRShipping.ToString());
                            }

                            
                            
                            else if (productClassID == 36)
                            {
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                            ...
                            //cadburt canadian EXCEPTION
                            else if (productClassID == CADcaShortAmount)
                            {
                                if (CAcaProcessed)
                                {
                                    continue;
                                ...
                                totalQty = Convert.ToDecimal(GetValueFromDataTable(classTotals, "ProductClassID", "Quantity", productClassID.ToString()));
                                //decimal cost = Convert.ToDecimal(GetValueFromWebConfig("FrozenFoodTBShortAmount", "value"));
                                //int min = Convert.ToInt32(GetValueFromWebConfig("CADcaShortAmount", "min"));

                                decimal TBShipping = 0;
                                if (totalQty < 10)
                                {
                                    totalShipping = totalQty * Convert.ToDecimal(25.00);
                                    TBShipping = totalShipping;
                            ...
                            else
                            {
                                ...
                                var newSaleshippingFee = Convert.ToDecimal(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_SHIPPING_FEE]);
                                var newSaleID = Convert.ToInt32(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_ID]);
                                 ...
                                 //GET SHIPPINGFEE for product class
                                  ...
                                  if (newSaleID > 0)
                                  {
                                      totalShipping = newSaleshippingFee;
                                   }
                                  else 
                                  {
                                       decimal fee = 0;
            ...
            {
                Logger.Error("Sales Screen: GetTotalShippingFees - " + productList, ex);
            }
        ...
        public static bool ValidateMinQty(ref DataTable classTotals, ref string message)
        {
            ...
            {
                Logger.Error("Sales Screen: VaidateMinQty - " + classTotals, ex);
            }
        ...
        public static bool ValidateMinQtyPackage(ref DataTable packageTotals, ref string message)
        {
            ...
            {
                Logger.Error("Sales Screen: VaidateMinQty - " + packageTotals, ex);
            }
        ...
        public static void CalculateTaxes(decimal amount,int clientID, string clientSeqCode, ref decimal hst, ref decimal pst, ref decimal gst)
        {
        ...
        public static void CalculateTaxesByProductClass(DataTable classTotals, int clientID, string clientSeqCode, ref decimal totalHST,  ref decimal totalGST, ref decimal totalPST, decimal adjustment, ref decimal hstOnAdj, ref decimal pstOnAdj,ref decimal gstOnAdj)
        {
            try
            {
                ...
                foreach (DataRow row in classTotals.Rows)
                {
                    ...
                    if (adjustment < 0)
                    {
                        ...
                        totalAmount = totalAmount - (adjustment * -1);
                    }
                    else
                    {
                    ...
                    row["TotalGST"] = gst;
                    //set pst
                    row["TotalPST"] = (totalAmount + totalShipping) * (pstRate / 100); //(totalAmount + gst + totalShipping + charge) * (pst / 100);
                    row["TotalHST"] = (totalAmount + totalShipping) * (hstRate / 100); 
         

                    totalGST += Convert.ToDecimal(row["TotalGST"]);
                    totalPST += Convert.ToDecimal(row["TotalPST"]);
                    totalHST += Convert.ToDecimal(row["TotalHST"]);
            ...
            {
                Logger.Error("Sales Screen: CalculateTaxesByProductClass", ex);
            }
       ...
       /* public static void GetProfitRateMinMax(int productId,ref int min, ref int max)
        ...
        public static string GetValueFromDataTable(DataTable dt, string KeyColumn, string ValueColumn, string whereCriteria)
        {
            ...
            {
                Logger.Error("Sales Screen: GetValueFromDataTable", ex);
            }
            return amt;
        }
        ...
        public static void SetValueToDataTable(DataTable dt, string KeyColumn, string ValueColumn, string whereCriteria, string newValue)
        {
            ...
            {
                Logger.Error("Sales Screen: SetValueToDataTable", ex);
            }
        ...
        public static bool IsConsultant()
        {
            ...
            {
                Logger.Error("Sales Screen: IsConsultant", ex);
            }
        ...
        public static bool IsInGroup(Roles role)
        {
            ...
            bool impersonate = Convert.ToBoolean(GetValueFromWebConfig("UserGroup", "impersonate"));
            string group = GetValueFromWebConfig("UserGroup", "value").ToString();
            Logger.Debug("managesalecreen IsInGroup group - " + group);  
            ...
            Logger.Debug("managesalecreen IsInGroup userName - " + userName);

            Logger.Debug("managesalecreen IsInGroup - " + role + "=" + ManageSaleScreen.Roles.gCAEFR_Intranet_SaleSupport);
            ...
            Logger.Debug("managesalecreen IsInGroup users - " + users);
            ...
            if (!found)
            {
                ...
                else
                {
                    ...
                    Components.Server.User.Roles roles = (Components.Server.User.Roles)System.Web.HttpContext.Current.Session[Global.SessionVariables.ROLES];
                    Logger.Debug("managesalecreen roles - " + roles);
                    r = roles.GetAllRoles();
                    Logger.Debug("managesalecreen roles - " + r);
                    foreach (Components.Server.User.Role rrole in r)
                    {
                        if (rrole.Name == role.ToString())
                        {
                            found = true;
                            Logger.Debug("managesalecreen found - " + found);
                        }
                    }
                }
            }
            ...
            {
                Logger.Error("Sales screen: IsInGroup - " + ex);
            }
        ...
        public static bool IsMIS()
        {
            ...
            {
                Logger.Error("Sales Screen: IsMIS", ex);
            }
            return isMIS;
        ...
        public static int GetRootIDFromWebConfig()
        {
            ...
            {
                Logger.Error("Sales Screen: GetRootIDFromWebConfig", ex);
            }
        ...
        public static void MakeReadOnly(Control parentControl)
        {
            ...
            {
                Logger.Error("Sales Screen: makeReadOnly", ex);
            }
        }
        ...
        public static string CalculateNewDatesForProductList(ref DateTime schShipDate, ref DateTime schDelDate, ref DateTime paymentDueDate, int paymentTermID, DataTable productList, int saleID, int clientID, string clientSeq)
        {
            ...
            {
                Logger.Error("Sales Screen: Calculate New Dates" + CHRerror, ex);
            }
        ...
        public static void SubmitAdjustmentToDb(efundraising.EFundraisingCRM.Linq.Adjustment adjustDIS)
        {

            try
            {
               // EFRProdConnectionString System.Configuration.ConfigurationManager. ConnectionStrings["EFRProdConnectionString"].ConnectionString; 

                using (eFundraisingProdDataContext dc = new eFundraisingProdDataContext(ConfigurationManager.ConnectionStrings["EFRProdConnectionString"].ConnectionString))
                {
                    using (var transaction = new TransactionScope())
                    {

                        eFundraisingProdDataContext adjs = new eFundraisingProdDataContext();
                        
                       // efundraising.EFundraisingCRM.Linq.Adjustment adjs = new efundraising.EFundraisingCRM.Linq.Adjustment();

                       efundraising.EFundraisingCRM.Linq.Adjustment adjust =  adjs.Adjustments.FirstOrDefault(p => p.Sales_ID == adjustDIS.Sales_ID && p.Adjustment_No == adjustDIS.Adjustment_No);
                        
                       // var resultsFound = (from a in dc.Adjustments where a.Sales_ID == adjustDIS.Sales_ID && a.Adjustment_No == adjustDIS.Adjustment_No select a).FirstOrDefault();


                        if (adjust == null)
                        {
                            efundraising.EFundraisingCRM.Linq.Adjustment adjustAdd = new efundraising.EFundraisingCRM.Linq.Adjustment();
                            adjustAdd.Sales_ID = adjustDIS.Sales_ID;
                            adjustAdd.Adjustment_No = adjustDIS.Adjustment_No;
                            adjustAdd.Reason_ID = adjustDIS.Reason_ID;
                            adjustAdd.Adjustment_Date = adjustDIS.Adjustment_Date;
                            adjustAdd.Adjustment_Amount = Convert.ToDecimal(adjustDIS.Adjustment_Amount);
                            adjustAdd.Comment = null;
                            adjustAdd.Adjustment_On_Shipping = null;
                            adjustAdd.Adjustment_On_Taxes = Convert.ToDecimal(adjustDIS.Adjustment_On_Taxes);
                            adjustAdd.Adjustment_On_Sale_Amount = Convert.ToDecimal(adjustDIS.Adjustment_On_Sale_Amount);
                            adjustAdd.Create_Date = adjustDIS.Adjustment_Date;
                            adjustAdd.Create_User_ID = adjustDIS.Create_User_ID;
                            adjustAdd.Ext_Adjustment_Id = null;
                            adjustAdd.charge_id = adjustDIS.charge_id;
                            adjs.Adjustments.InsertOnSubmit(adjustAdd);
                            
                           
                        }
                        else 
                        {
                            adjust.Adjustment_Amount = Convert.ToDecimal(adjustDIS.Adjustment_Amount);
                            adjust.Adjustment_Date = adjustDIS.Adjustment_Date;
                            adjust.charge_id = adjustDIS.charge_id;
                            adjust.Adjustment_On_Taxes = Convert.ToDecimal(adjustDIS.Adjustment_On_Taxes);
                            adjust.Adjustment_On_Sale_Amount = Convert.ToDecimal(adjustDIS.Adjustment_On_Sale_Amount);
                            
                        
                        }
                        
                        //dc.Adjustments.InsertOnSubmit(adjs);
                        try
                        {
                            adjs.SubmitChanges();
                        ...
                        {
                            adjs.ChangeConflicts.ResolveAll(RefreshMode.KeepChanges);
                        }
