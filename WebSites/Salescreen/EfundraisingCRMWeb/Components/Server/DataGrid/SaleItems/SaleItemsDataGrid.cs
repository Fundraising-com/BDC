...
namespace EFundraisingCRMWeb.Components.Server.DataGrid.SaleItems
{
    ...
    public class SaleItemsDataGrid
    {
        ...
        static SaleItemsDataGrid()
        {
            Logger = LogManager.GetLogger(typeof(SaleItemsDataGrid));
        }
        ...
        public static DataTable CreateDataTableSaleItems(SalesItemCollection saleItems)
        {
            ...
            try
            {
                ...
                foreach (SalesItem salesItem in saleItems)
                {
                    ...
                    if (Convert.ToInt32(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_SHIPPING_FEE]) > 0)
                    {
                        dr["ShippingFee"] = Convert.ToInt32(System.Web.HttpContext.Current.Session[Global.SessionVariables.SALES_SHIPPING_FEE]);
                    }
            ...
            {
                Logger.Error("Error in CreateDataTableSaleItems", ex);
            }
