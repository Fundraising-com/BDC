...
namespace EFundraisingCRMWeb.App_Data
{
    using System.Web.Security;
    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(Object sender, EventArgs e)
        {
            ...
            efundraising.ESubsGlobal.Common.CountryCollections CC = efundraising.ESubsGlobal.Common.CountryCollections.AllCountries();
            Application.Add(esubGlobalCountriesKey, CC);
        ...
        protected void Application_Error(Object sender, EventArgs e)
        {
                ...
                )
            {
                ...
                efundraising.Diagnostics.Logger.LogError("Unhandled Error", ex);
        ...
        {
            ArrayList arList = (ArrayList)Session[ListReportFileDumps];
            if (arList != null)
            {
        ...
        public static GroupType GetGroupTypeByLeadID(int leadId)
        {
            ...
            if (Global.groupTypeHastable[leadId] == null)
                Global.groupTypeHastable[leadId] = efundraising.EFundraisingCRM.GroupType.GetGroupTypeByLeadID(leadId);
            return Global.groupTypeHastable[leadId] as efundraising.EFundraisingCRM.GroupType;
        }
        ...
        public static Supplier GetSupplierByID(System.Web.HttpApplicationState theAppState, int supId)
        {
            if (theAppState.Get(getSupplierByID) == null)
                theAppState.Set(getSupplierByID, efundraising.EFundraisingCRM.Supplier.GetSuppliers());

            efundraising.EFundraisingCRM.Supplier[] suppls = (efundraising.EFundraisingCRM.Supplier[])theAppState.Get(getSupplierByID);
        ...
        public static ConsultantCollections GetConsultants(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.ConsultantCollections cntColletions = efundraising.EFundraisingCRM.Consultant.GetCollectionConsultants();
                cntColletions.SortByProperty("Name");
                theAppState.Set(consultantsKeyByName, cntColletions);
            }

            return (efundraising.EFundraisingCRM.ConsultantCollections)theAppState.Get(consultantsKeyByName);
        }
        ...
        private static ConsultantCollections GetConsultantsByKeyID(System.Web.HttpApplicationState theAppState)
        {
            ...
            return (efundraising.EFundraisingCRM.ConsultantCollections)theAppState.Get(consultantsKeyById);
        }
        ...
        public static PoStatusCollections GetPoStatusCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.PoStatusCollections poStsCol = efundraising.EFundraisingCRM.PoStatus.GetPoStatussCollections();
                poStsCol.SortByProperty("Description");
                theAppState.Set(PoStatusCollectionsKey, poStsCol);
            }

            return (efundraising.EFundraisingCRM.PoStatusCollections)theAppState.Get(PoStatusCollectionsKey);
        }
        ...
        public static CarriersCollection GetCarrierCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.CarriersCollection crCollections = new CarriersCollection();
                crCollections.GetAllCarriers();
                crCollections.SortByProperty("Description");
                theAppState.Set(CarrierCollectionsKey, crCollections);
            }

            return (efundraising.EFundraisingCRM.CarriersCollection)theAppState.Get(CarrierCollectionsKey);
        }
        ...
        public static CarrierShippingOptionCollection GetCarrierShippingOptionCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.CarrierShippingOptionCollection csoCollections = new CarrierShippingOptionCollection();
            ...
            return (efundraising.EFundraisingCRM.CarrierShippingOptionCollection)theAppState.Get(CarrierShippingCollectionsKey);
        }
        ...
        public static SalesStatusCollection GetSalesStatusCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.SalesStatusCollection ssCollections = new SalesStatusCollection();
            ...
            return (efundraising.EFundraisingCRM.SalesStatusCollection)theAppState.Get(SalesStatusCollectionsKey);
        }
        ...
        public static ProductionStatusCollection GetProductionStatusCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.ProductionStatusCollection prCollections = new ProductionStatusCollection();
            ...
            return (efundraising.EFundraisingCRM.ProductionStatusCollection)theAppState.Get(ProductionStatusCollectionsKey);
        }
        ...
        public static ARStatusCollection GetARStatusCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.ARStatusCollection arCollections = new ARStatusCollection();
            ...
            return (efundraising.EFundraisingCRM.ARStatusCollection)theAppState.Get(ARStatusCollectionsKey);
        }
        ...
        public static CreditCheckStatusCollection GetCreditCheckStatusCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.CreditCheckStatusCollection cdckCollections = new CreditCheckStatusCollection();
            ...
            return (efundraising.EFundraisingCRM.CreditCheckStatusCollection)theAppState.Get(CreditCheckStatusCollectionsKey);
        }
        ...
        public static ClientSequenceCollection GetClientSequenceCollection(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.ClientSequenceCollection csqCollections = new ClientSequenceCollection();
            ...
            return (efundraising.EFundraisingCRM.ClientSequenceCollection)theAppState.Get(ClientSequenceCollectionsKey);
        }
        ...
        public static PaymentMethodCollections GetPaymentMethodCollections(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.PaymentMethodCollections theCollections = new PaymentMethodCollections();
            ...
            return (efundraising.EFundraisingCRM.PaymentMethodCollections)theAppState.Get(PaymentMethodCollectionsKey);
        }
        ...
        public static PaymentTermCollections GetPaymentTermCollections(System.Web.HttpApplicationState theAppState)
        {
            ...
            {
                efundraising.EFundraisingCRM.PaymentTermCollections theCollections = new PaymentTermCollections();
                theCollections.GetAllPaymentTerms();
                theCollections.SortByProperty("Description");
                theAppState.Set(PaymentTermCollectionsKey, theCollections);
            }

            return (efundraising.EFundraisingCRM.PaymentTermCollections)theAppState.Get(PaymentTermCollectionsKey);
        }
