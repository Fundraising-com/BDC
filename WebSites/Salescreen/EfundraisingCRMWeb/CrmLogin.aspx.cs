    ...
    public partial class CrmLogin : System.Web.UI.Page
    {
        ...
        protected void LoginButton_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                Logger.Debug("LoginButton_Click crmUser -" + crmUser);
                if (crmUser != null)
                {

                    Logger.Debug("LoginButton_Click IsCookieEnable -" + efundraising.Utilities.CookieHandler.CookieHandler.IsCookieEnable(Request));
            ...
            {
                Logger.Error("Sales Screen: Login Click", ex);
