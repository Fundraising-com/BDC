...
namespace efundraising.EFundraisingCRMWeb.Sales.CreditCard
{
		...
		private void RefreshGrid()
		{
            ...
            if (fromDate <= toDate)
			{
				...
				if (errorMessage.Length > 0)
				{
					...
					Logger.Error(errorMessage.ToString().Replace("<li>", "\n"));
				}
				else
				{
 ...
 //OE PAYMENT ENTRY				    int createUserID = Convert.ToInt32(ManageSaleScreen.GetValueFromWebConfig("OrderExpress", "createUserID"));
