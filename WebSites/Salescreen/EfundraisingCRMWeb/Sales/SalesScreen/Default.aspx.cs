    ...
    public partial class Default : EFundraisingCRMSalesBasePage
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (clientID > -1)
                    {
                        ...
                        {
                            Logger.Debug("Sales Screen: Default Page Load -->Client Does not exist");
                        }
                    }
      ...
      */
        ...
        private void SetClientInfoForLead(int leadID, bool sameAsBilling)
        {
            ...
            {
                Logger.Error("SetClientInfoForLead: " + leadID, ex);
            }
        ...
        private string SaveClientShippingAddress(efundraising.EFundraisingCRM.Client theClient)
        {
            ...
            {
                Logger.Error("SaveClientShippingAddress: Cannot Save Client Shipping Address", ex);
                return ex.ToString();
            }
            return string.Empty;
        }
        ...
        private void SaveInfo(bool addressHygiene)
        {
            ...
            {
                Logger.Error("Error in Save Info on default page. LeadID=" + LeadID, ex);
        ...
        protected void newSalesbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Error("Sales Screen: newSalesbutton error", ex);
            }
        }
        ...
        private bool AddressHygiene(EFundraisingCRMWeb.Components.User.Address address, bool enableSuggestionList, bool isBilling)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Error("Error in AddressHygiene. LeadID=" + line, ex);
                return false;
            }
        }
        ...
        protected void NewAddressButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Error("Error in NewAddressButton_Click", ex);
