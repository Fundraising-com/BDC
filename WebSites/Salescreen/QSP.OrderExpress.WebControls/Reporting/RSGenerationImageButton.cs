...
namespace QSP.WebControl.Reporting
{
	...
	[DefaultProperty("Text"), 
		ToolboxData("<{0}:RSGenerationImageButton runat=server></{0}:RSGenerationImageButton>")]
	public class RSGenerationImageButton : System.Web.UI.WebControls.ImageButton, INamingContainer
	{
        /// <summary>
