            ...
            try
            {
                ...
                if (!(IsPostBack))
                {
                   ...
                   /* if (Session[Global.SessionVariables.CLIENT_ID] == null)
                    {
                        efundraising.Diagnostics.Logger.LogError("error in credit info control, client id is null");
                    }
                    else
                    {*/
                ...
                efundraising.Diagnostics.Logger.LogError("Error in credit check control", x);
            }
		}
