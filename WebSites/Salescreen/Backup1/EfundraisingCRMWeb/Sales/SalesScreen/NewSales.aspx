							...
							<TD vAlign="top" align="left">
								...
								<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="240" border="0" 
									...
									<TR>
										<TD class="NormalText">
											&nbsp;&nbsp;
                                            <table style="width:250px; height: 24px; border-color:Blue" border="0">
                                                 <tr>
                                                <td class="style2" style="width:200px; height: 1px" colspan=3>
                                                        <asp:Label id="Label10" runat="server" CssClass="FrameTitleColor">SAP External Data</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                
                                                <td style="height: 7px">
											<asp:label id="Label4" runat="server" Font-Bold="True" ForeColor="Gray">Billing Account Id</asp:label>
                                                    </td>
                                                    <td style="height: 7px">
											<asp:label id="Label7" runat="server" class="NormalText" Font-Bold="True" ForeColor="Gray">SAP Order ID 
                                                        id</asp:label>
                                                    </td>
                                            ...
                                            <asp:textbox id=OEIdTextBox runat="server" CssClass="NormalText specialTextBox" 
                                             ...
                                             <tr>
                                                    <td style="width: 106px; height: 7px;" class="style2" colspan=3>
											<asp:label id="Label9" runat="server" Font-Bold="True" ForeColor="Gray" Width="200px">SAP Order Status</asp:label>
                                                    </td>
                                                
                                                </tr>
                                            <tr>
                                            <td style="width: 106px" class="style2" colspan=3>
                                                        <asp:textbox id="StatusTextbox" runat="server" CssClass="NormalText specialTextBox" 
                                                            Columns="9" BorderStyle="Solid" ReadOnly="True" Width="200px"></asp:textbox></td>
