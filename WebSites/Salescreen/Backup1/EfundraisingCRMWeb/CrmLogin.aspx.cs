	...
	public partial class CrmLogin : System.Web.UI.Page
	{
		...
		protected void LoginButton_Click(object sender, System.EventArgs e) {
            ...
            try
            {
                ...
                Logger.LogError("LoginButton_Click crmUser -" + crmUser);
                if (crmUser != null)
                {

                    Logger.LogError("LoginButton_Click IsCookieEnable -" + efundraising.Utilities.CookieHandler.CookieHandler.IsCookieEnable(Request));
