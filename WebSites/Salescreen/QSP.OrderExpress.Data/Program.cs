...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class Program : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string TABLE_NAME = "program";
		public const string PARAM_PKID = "@iprogram_id";
		public const string PARAM_PROGRAM_NAME = "@sprogram_name";
		...
		private const string SQL_PROC_DELETE = "pr_program_Delete";
		private const string SQL_PROC_INSERT = "pr_program_Insert";
		private const string SQL_PROC_UPDATE = "pr_program_Update";
		private const string SQL_PROC_SELECT_ONE = "pr_program_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_program_SelectAll";		
		...
		protected override SqlCommand GetInsertCommand()
		{
			if ( insertCommand == null )
			{
				...
				sqlParams.Add(new SqlParameter(PARAM_PROGRAM_NAME, SqlDbType.VarChar, 100));
				...
				sqlParams[PARAM_PROGRAM_NAME].SourceColumn = dataDef.FLD_PROGRAM_NAME;
		...
		protected override SqlCommand GetUpdateCommand()
		{
			if ( updateCommand == null )
			{
				...
				sqlParams.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int));
				sqlParams.Add(new SqlParameter(PARAM_PROGRAM_TYPE_ID, SqlDbType.Int));
				sqlParams.Add(new SqlParameter(PARAM_PROGRAM_NAME, SqlDbType.VarChar, 50));
                sqlParams.Add(new SqlParameter(PARAM_DESCRIPTION, SqlDbType.VarChar, 250));	
		...
		{
			get{return dataDef.TBL_PROGRAM;}
		}
		...
		/// </UL>
		/// Will fill all properties corresponding with a program in the table with the value of the row selected.
		/// </remarks>
		...
		public dataDef SelectAll_Search(int SearchType, String Criteria, int ProgramTypeID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_program_SelectAll_Search";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
