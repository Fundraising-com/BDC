...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'Form_delivery_method'.
	/// </summary>
	public class Form_delivery_method : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iform_delivery_method_id";
		...
		private const string SQL_PROC_DELETE = "pr_form_delivery_method_Delete";
		private const string SQL_PROC_INSERT = "pr_form_delivery_method_Insert";
		private const string SQL_PROC_UPDATE = "pr_form_delivery_method_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_form_delivery_method_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_form_delivery_method_SelectAll";
		...
		{
			get{return dataDef.TBL_FORM_DELIVERY_METHOD;}
		}
		...
		public dataDef SelectAllWform_idLogic(int FormID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_form_delivery_method_SelectAllWform_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
