...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class PromoSubdivision : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@ipromo_subdivision_id";
		public const string PARAM_SUBDIVISION_ID = "@ssubdivision_code";
		public const string PARAM_PROMO_ID = "@ipromo_id";
		
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_INSERT = "pr_QSPForm_promo_Subdivision_Insert";
		private const string SQL_PROC_UPDATE = "pr_QSPForm_promo_Subdivision_Update";
		private const string SQL_PROC_DELETE = "pr_QSPForm_promo_Subdivision_Delete";
		private const string SQL_PROC_SELECT_ONE = "pr_QSPForm_promo_Subdivision_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_QSPForm_promo_Subdivision_SelectAll";
		private const string SQL_PROC_SELECT_ALL_BY_PROMO_ID = "pr_QspForm_Promo_Subdivision_SelectAllByPromoID";
		...
		private void FillParams(SqlParameterCollection param)
		{
			...
			param.Add(new SqlParameter(PARAM_PROMO_ID,SqlDbType.Int));
			param.Add(new SqlParameter(PARAM_SUBDIVISION_ID,SqlDbType.VarChar));
		}

		private void MapColumn(SqlParameterCollection param)
		{
			param[PARAM_PKID].SourceColumn = dataDef.FLD_PKID;
			param[PARAM_PROMO_ID].SourceColumn = dataDef.FLD_PROMO_ID;
			param[PARAM_SUBDIVISION_ID].SourceColumn = dataDef.FLD_SUBDIVISION_CODE;
		}

		protected override string TableName
		{
			get{return dataDef.TBL_PROMO_SUBDIVISION;}
		}
		...
		public new dataDef SelectOne(int PromoSubdivisionID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ONE;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, PromoSubdivisionID));
			Select(cmdToExecute,Table);
			return Table;
		}
		public dataDef SelectAllByPromoID(int PromoID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ALL_BY_PROMO_ID;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PROMO_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, PromoID));
			Select(cmdToExecute,Table);
			return Table;
		}
