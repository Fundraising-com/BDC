...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class CatalogGroup : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@icatalog_group_id";
		public const string PARAM_CODE ="@scatalog_group_code";
		public const string PARAM_NAME ="@scatalog_group_name";	
		public const string PARAM_DESCRIPTION ="@sdescription";	
		
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_DELETE = "pr_catalog_group_Delete";
		private const string SQL_PROC_INSERT = "pr_catalog_group_Insert";
		private const string SQL_PROC_UPDATE = "pr_catalog_group_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_catalog_group_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_catalog_group_SelectAll";
		...
		{
			get{return dataDef.TBL_CATALOG_GROUP;}
		}
		
		//We create a new method when we want to the return type variable
		public new dataDef SelectOne(int CatalogGroupItemID)
		{
			...
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CatalogGroupItemID));
		...
		public dataDef SelectAllWcatalog_idLogic(int CatalogID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_catalog_group_SelectAllWcatalog_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
...
//			cmdToExecute.CommandType = CommandType.StoredProcedure;
//			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_CATALOG_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CatalogGroupID));
//			
//					
//			Select(cmdToExecute,Table);
//			
