...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'Form_section'.
	/// </summary>
	public class Form_section : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iform_section_id";
		public const string PARAM_FORM_ID = "@iform_id";
        public const string PARAM_FORM_SECTION_NUMBER = "@iform_section_number";
        public const string PARAM_FORM_SECTION_TITLE = "@sform_section_title";
        public const string PARAM_FORM_SECTION_TYPE_ID = "@iform_section_type_id";
        public const string PARAM_DESCRIPTION = "@sdescription";
        public const string PARAM_CATALOG_ITEM_CATEGORY_ID = "@icatalog_item_category_id";
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_DELETE = "pr_form_section_Delete";
		private const string SQL_PROC_INSERT = "pr_form_section_Insert";
		private const string SQL_PROC_UPDATE = "pr_form_section_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_form_section_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_form_section_SelectAll";
		...
		protected override SqlCommand GetInsertCommand()
		{
			if ( insertCommand == null )
			{
                ...
                sqlParams.Add(new SqlParameter(PARAM_FORM_SECTION_TITLE, SqlDbType.VarChar, 100));
                sqlParams.Add(new SqlParameter(PARAM_FORM_SECTION_TYPE_ID, SqlDbType.Int));
                sqlParams.Add(new SqlParameter(PARAM_CATALOG_ITEM_CATEGORY_ID, SqlDbType.Int));
                sqlParams.Add(new SqlParameter(PARAM_DESCRIPTION, SqlDbType.VarChar, 250));
				...
				sqlParams[PARAM_FORM_SECTION_TITLE].SourceColumn = dataDef.FLD_FORM_SECTION_TITLE;
                sqlParams[PARAM_FORM_SECTION_TYPE_ID].SourceColumn = dataDef.FLD_FORM_SECTION_TYPE_ID;
                sqlParams[PARAM_CATALOG_ITEM_CATEGORY_ID].SourceColumn = dataDef.FLD_CATALOG_ITEM_CATEGORY_ID;
		...
		{
			get{return dataDef.TBL_FORM_SECTION;}
		}
		...
		public dataDef SelectAllWform_idLogic(int FormID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_form_section_SelectAllWform_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public dataDef SelectAllWform_idLogic(int FormID, int FormSectionTypeID)
        {
            dataDef Table = new dataDef();
