...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'Form_order_type'.
	/// </summary>
	public class Form_order_type : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iform_order_type_id";
		...
		private const string SQL_PROC_DELETE = "pr_form_order_type_Delete";
		private const string SQL_PROC_INSERT = "pr_form_order_type_Insert";
		private const string SQL_PROC_UPDATE = "pr_form_order_type_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_form_order_type_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_form_order_type_SelectAll";
		...
		{
			get{return dataDef.TBL_FORM_ORDER_TYPE;}
		}
		...
		public dataDef SelectAllWform_idLogic(int FormID)
		{
			...
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.pr_form_order_type_SelectAllWform_idLogic";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
