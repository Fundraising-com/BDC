...
namespace QSPForm.Data
{
	...
	/// </summary>
	public class Promo_TextSubdivision : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iPromo_Text_subdivision_id";
		...
		private const string SQL_PROC_INSERT = "pr_QSPForm_Promo_Text_Subdivision_Insert";
		private const string SQL_PROC_UPDATE = "pr_QSPForm_Promo_Text_Subdivision_Update";
		private const string SQL_PROC_DELETE = "pr_QSPForm_Promo_Text_Subdivision_Delete";
		private const string SQL_PROC_SELECT_ONE = "pr_QSPForm_Promo_Text_Subdivision_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_QSPForm_Promo_Text_Subdivision_SelectAll";
		private const string SQL_PROC_SELECT_ALL_BY_Promo_Text_ID = "pr_QspForm_Promo_Text_Subdivision_SelectAllByPromo_TextID";
		...
		{
			get{return dataDef.TBL_Promo_Text_SUBDIVISION;}
		}
		...
		public new dataDef SelectOne(int Promo_TextSubdivisionID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ONE;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, Promo_TextSubdivisionID));
			Select(cmdToExecute,Table);
			return Table;
		}
		public dataDef SelectAllByPromo_TextID(int Promo_TextID)
		{
			dataDef Table = new dataDef();
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = SQL_PROC_SELECT_ALL_BY_Promo_Text_ID;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_Promo_Text_ID, SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, Promo_TextID));
			Select(cmdToExecute,Table);
			return Table;
		}
