...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'Order_group'.
	/// </summary>
	public class Order_group : DBTableOperation
	{

		#region Parameter
		//Stored procedure parameter names
		public const string PARAM_PKID = "@iorder_group_id";		
		//
		// Stored procedure names for each operation
		private const string SQL_PROC_DELETE = "pr_order_group_Delete";
		private const string SQL_PROC_INSERT = "pr_order_group_Insert";
		private const string SQL_PROC_UPDATE = "pr_order_group_Update";	
		private const string SQL_PROC_SELECT_ONE = "pr_order_group_SelectOne";
		private const string SQL_PROC_SELECT_ALL = "pr_order_group_SelectAll";
		...
		{
			get{return dataDef.TBL_ORDER_GROUP;}
		}
		...
		public new dataDef SelectOne(int ID)
		{
			...
			cmdToExecute.CommandText = SQL_PROC_SELECT_ALL;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter(PARAM_PKID, SqlDbType.VarChar, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ID));
		...
		public dataDef SelectAllWcampaign_idLogic(int CampaignID)
		{
			...
			cmdToExecute.CommandText = SQL_PROC_SELECT_ALL;
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			cmdToExecute.Parameters.Add(new SqlParameter("@icampaign_id", SqlDbType.VarChar, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CampaignID));
