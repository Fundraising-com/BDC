...
namespace QSPForm.Business
{
	...
	using dataAccessRef = QSPForm.Data.CatalogItem;
	...
	public class CatalogItemSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public CatalogItemSystem()
		{
		...
		//   Validates a specific CatalogItem Ownership Table field against his maxlength 
		// Returns:
		...
		public dataDef SelectAllByProductID(int ProductID)
		{			
			dataDef dTbl;
			//
			// Get the user DataTable from the DataLayer
			//
			dTbl = objDataAccess.SelectAllWproduct_idLogic(ProductID);				
...
//		public dataDef SelectAll_Search(int SearchType, String Criteria, int CatalogItemType, string SubdivisionCode)
//		{			
//			dataDef dTbl;
//			
//			//
//			// Get the user DataTable from the DataLayer
//			//				
//			dTbl = objDataAccess.SelectAll_Search(SearchType, Criteria, CatalogItemType, SubdivisionCode);				
//			
//			return dTbl;			
//		}				
