...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.PromoCouponSubdivisionTable;
	using dataAccessRef = QSPForm.Data.PromoCouponSubdivision;
	...
	public class PromoCouponSubdivisionSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public PromoCouponSubdivisionSystem()
		{
		...
		public dataDef SelectAllByPromoCouponID(int Promo_CouponID)
		{
			dataDef dTbl;
			dTbl = objDataAccess.SelectAllByPromoCouponID(Promo_CouponID);		
			return dTbl;		
		}
