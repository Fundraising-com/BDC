...
namespace QSPForm.Business
{
	...
	using dataAccessRef = QSPForm.Data.CatalogGroupCatalog;
	...
	public class CatalogGroupCatalogSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public CatalogGroupCatalogSystem()
		{
		...
		//----------------------------------------------------------------
		// Function Validate:
		//   Validates CatalogGroupCatalog row
		// Returns:
		...
		//   Validates a specific CatalogGroupCatalog Ownership Table field against his maxlength 
		// Returns:
		...
		private bool IsValid_RequiredFields(DataRow row)
		{
			bool IsValid = true;
			//CatalogGroupCatalog
			IsValid &= IsValid_RequiredField(row, dataDef.FLD_CATALOG_ID, "Catalog ID");
			IsValid &= IsValid_RequiredField(row, dataDef.FLD_CATALOG_GROUP_ID, "Catalog Group ID");
		...
		public dataDef SelectByCatalogID(int CatalogID)
		{			
			dataDef dTbl;			
			//
			// Get the user DataTable from the DataLayer
...
//		public dataDef SelectAll_Search(int SearchType, String Criteria, int CatalogGroupCatalogType, string SubdivisionCode)
//		{			
//			dataDef dTbl;
//			
//			//
//			// Get the user DataTable from the DataLayer
//			//				
//			dTbl = objDataAccess.SelectAll_Search(SearchType, Criteria, CatalogGroupCatalogType, SubdivisionCode);				
//			
//			return dTbl;			
//		}				
