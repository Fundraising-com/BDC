...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.PromoSubdivisionTable;
	using dataAccessRef = QSPForm.Data.PromoSubdivision;
	...
	public class PromoSubdivisionSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public PromoSubdivisionSystem()
		{
		...
		public dataDef SelectAll_Search(int SearchType, String Criteria, string SubdivisionCode, int NationalStatus, int DisplayStatus, DateTime StartDate, DateTime EndDate, string FM_ID, bool IncludeFMReportedTo)
		{			
			dataDef dTbl;
			dTbl = objDataAccess.SelectAll_Search(SearchType, Criteria, SubdivisionCode, NationalStatus, DisplayStatus, StartDate, EndDate, FM_ID, IncludeFMReportedTo);		
			return dTbl;	
		}
		...
		public dataDef SelectAllByPromoID(int PromoID)
		{
			dataDef dTbl;
			dTbl = objDataAccess.SelectAllByPromoID(PromoID);		
			return dTbl;		
		}
