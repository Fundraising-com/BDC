...
namespace QSPForm.Business
{
	...
	using QSPForm.Data;
	using dataDef = QSPForm.Common.DataDef.Promo_TextSubdivisionTable;
	using dataAccessRef = QSPForm.Data.Promo_TextSubdivision;
	...
	public class Promo_TextSubdivisionSystem : BusinessSystem
	{
		
		dataAccessRef objDataAccess;
		
		public Promo_TextSubdivisionSystem()
		{
		...
		public dataDef SelectAllByPromo_TextID(int Promo_TextID)
		{
			dataDef dTbl;
			dTbl = objDataAccess.SelectAllByPromo_TextID(Promo_TextID);		
			return dTbl;		
		}
