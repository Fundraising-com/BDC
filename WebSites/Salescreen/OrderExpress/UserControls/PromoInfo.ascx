<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.PromoInfo" Codebehind="PromoInfo.ascx.cs" %>
		...
		<td align="center">
			<table id="Table3" cellSpacing="0" cellPadding="0" width="600" border="0">
				...
				<tr runat="server" id="trStartDate">
					<td valign="top"><span class="StandardLabel">Labeling Start Date&nbsp;:</span></td>
					<td valign="top"><asp:Label Runat="server" ID="lblStartDate" CssClass="DescInfoLabel"></asp:Label></td>
				</tr>
				<tr runat="server" id="trEndDate">
					<td valign="top"><span class="StandardLabel">Labeling End Date&nbsp;:</span></td>
					<td valign="top"><asp:Label Runat="server" ID="lblEndDate" CssClass="DescInfoLabel"></asp:Label></td>
				</tr>
				<tr>
