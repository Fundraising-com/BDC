...
<%@ Register TagPrefix="uc1" TagName="Promo_LogoHeaderForm" Src="Promo_LogoHeaderForm.ascx" %>
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.Promo_LogoDetail" Codebehind="Promo_LogoDetail.ascx.cs" %>

<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
	<TR>
		<TD>
			<uc1:Promo_LogoHeaderForm id="ctrlPromo_LogoHeaderForm" runat="server"></uc1:Promo_LogoHeaderForm><br>
		</TD>
	</TR>
