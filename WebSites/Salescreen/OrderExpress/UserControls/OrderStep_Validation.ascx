...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.OrderStep_Validation" Codebehind="OrderStep_Validation.ascx.cs" %>
...
<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
		<td align="left"> <!--Section Body --><uc1:orderinfo id="OrderInfo1" runat="server"></uc1:orderinfo></td>
	</tr>
	<tr>
		<td align="center">
			<br>
		...
		<TD align="center"><br>
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<td>
						<TABLE align=right id="Table2sss" cellSpacing="0" cellPadding="0" width="400" border="0">
							<TR id=trSaveButton runat=server align="right">
								<td  align="right">
								...
								<td align="right" valign="top">
									<asp:imagebutton id="imgBtnSaveForLater" runat="server" AlternateText="Click here to save for later process"
										ImageUrl="~/images/btnSaveOrder.gif" CausesValidation="False"></asp:imagebutton><br>
									<br>
								</td>
							</TR>
							...
							<TR id=trConfirmationButton runat=server>
								...
								<td align="right">
									<asp:imagebutton id="imgBtnConfirm" runat="server" AlternateText="Click here to confirm your order"
										ImageUrl="~/images/btnSubmitOrder.gif" CausesValidation="False" ToolTip="Click here to submit and process your order"></asp:imagebutton>
								</td>
							</TR>
							<TR id=trPersonalizationButton runat=server>
								<td align="right">
									<asp:label id="Label1" runat="server" CssClass="StandardLabel">
										Personalize . . . Finalize Order
									</asp:label>
								</td>
								<td align="right">
									<asp:imagebutton id="imgBtnPersonalize" runat="server" AlternateText="Click here to personalize your order"
										ImageUrl="~/images/btnPersonalize.gif" CausesValidation="False" ToolTip="Click here to personalize your order" OnClick="imgBtnPersonalize_Click"></asp:imagebutton>
								</td>
							</TR>
						</TABLE>
					</td>
