...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.WarehouseSelector" Codebehind="WarehouseSelector.ascx.cs" %>
...
<TABLE id="Table5" cellSpacing="0" cellPadding="0" align="left" border="0">
	<TR>
		<TD>
			...
			<BR>
			<asp:HyperLink id="hypLnk_Map" NavigateUrl="javascript:void(0);" Font-Size=x-small Font-Bold=True ForeColor=red  runat="server">Click <u>here</u> to access a map of the QSP Warehouse Network.</asp:HyperLink>
			<br><br>
		...
		<TD><!--DataGrid  -->
			<cc2:sorteddatagrid id=dtgList runat="server" Font-Size="8pt" ShowFooter="True" DataSource="<%# DVList %>" AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="3" AllowSorting="True" AllowPaging="True" PageSize="10">
				...
				<Columns>
					...
					<asp:TemplateColumn visible="false" SortExpression="warehouse_id" HeaderText="WH&nbsp;ID">
						<HeaderStyle Width="50px"></HeaderStyle>
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
						<ItemTemplate>
							<asp:Label id="lblID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.warehouse_id")%>'>
							</asp:Label>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="fulf_warehouse_id" HeaderText="EDS&nbsp;WH&nbsp;#">
						...
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
						<ItemTemplate>
							<asp:Label id="lblFulfID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.fulf_warehouse_id")%>'>
							</asp:Label>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="warehouse_name" HeaderText="Warehouse&nbsp;Name">
						...
						<ItemTemplate>
							<asp:HyperLink id="hypLnkName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.warehouse_name") %>' ForeColor="#336699" NavigateUrl="javascript:void(0);">
							</asp:HyperLink>
						</ItemTemplate>
					</asp:TemplateColumn>
