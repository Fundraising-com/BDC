...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.OrgStep_PhoneNumber" Codebehind="OrgStep_PhoneNumber.ascx.cs" %>
...
<table id="Table3" cellSpacing="0" cellPadding="0" border="0">
	...
	<tr>
		<td><asp:label id="Label5" runat="server" CssClass="StandardLabel">
				4 - Validate or Enter the Phone Number Information:
			</asp:label><br>
			<br>
		</td>
	</tr>
	<tr>
		<td>
			<uc1:PhoneNumberList id="PhoneNumberList_Org" runat="server"></uc1:PhoneNumberList>
		</td>
	</tr>
	<tr>
		<td>
