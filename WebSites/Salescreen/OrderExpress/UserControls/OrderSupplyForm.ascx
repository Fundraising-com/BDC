...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.OrderSupplyForm" Codebehind="OrderSupplyForm.ascx.cs" %>
				...
				<tr>
					<td vAlign="top">
						...
						<table id="Table43dd" cellSpacing="0" cellPadding="0" border="0">
							...
							<tr>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
								<td><asp:label id="lblLabelDeliveryDate" runat="server" CssClass="StandardLabel">Requested&nbsp;Delivery&nbsp;Date:<span class="RequiredSymbolLabel">*</span>&nbsp;
									</asp:label></td>
								<td>&nbsp;</td>
								<td>
									<table id="Table3" cellSpacing="0" cellPadding="0" border="0">
										<tr>
											<TD><asp:textbox id="txtDeliveryDate" runat="server" CssClass="StandardTextBox" AutoPostBack="False" Font-Size="9px" Height="20px" Font-Names="Verdana, Arial, Tahoma" Width="100px"></asp:textbox>
											<ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender2" runat="server" TargetControlID="txtDeliveryDate"
                                                        Mask="99/99/9999" MessageValidatorTip="false" MaskType="Date" DisplayMoney="Left" AcceptNegative="Left" CultureName="en-US" />
											</TD>
											<td><asp:hyperlink id="hypLnkDeliveryDate" runat="server" NavigateUrl="javascript:void(0);" ImageUrl="~/images/Calendar.gif"
													AlternateText="Click here to select the delivery date from a popup calendar !"></asp:hyperlink>&nbsp;
											</td>
											<td>&nbsp;
											</td>
											<td><asp:requiredfieldvalidator id="reqFldVal_DeliveryDate" runat="server" CssClass="LabelError" ErrorMessage="The Delivery Date is required."
													ControlToValidate="txtDeliveryDate">*</asp:requiredfieldvalidator></td>
											<td><asp:comparevalidator id="compVal_DeliveryDate" runat="server" CssClass="LabelError" ErrorMessage="The Delivery Date is invalid"
													ControlToValidate="txtDeliveryDate" Operator="DataTypeCheck" Type="Date">*</asp:comparevalidator></td>
										</tr>
									</table>
								</td>
							</tr>
