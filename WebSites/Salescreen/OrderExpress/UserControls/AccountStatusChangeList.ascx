...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.AccountStatusChangeList" Codebehind="AccountStatusChangeList.ascx.cs" %>
<br>
<br>
<table id="Table5" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        <td>
            <!--DataGrid  -->
            <br>
            <cc2:SortedDataGrid ID="dtgAccount" runat="server" Font-Size="8pt" Width="600px"
                ShowFooter="True" DataSource="<%# DVAccountStatusChanges %>" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateColumn>
                        <itemtemplate>
							<asp:Label id="lblStatusRead" runat="server" Width="10px" BackColor='<%# System.Drawing.Color.FromName(DataBinder.Eval(Container, "DataItem.Color_Code").ToString()) %>' Height="5px" BaccountWidth="1px" BaccountStyle="Solid" BaccountColor="Black">
								&nbsp;&nbsp;
							</asp:Label>
						</itemtemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:BoundColumn DataField="account_status_name" SortExpression="account_status_name"
                        ReadOnly="True" HeaderText="Status">
                        <itemstyle width="100px" wrap="false"></itemstyle>
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="account_id" SortExpression="account_id" ReadOnly="True"
                        HeaderText="ID"></asp:BoundColumn>
                    <asp:BoundColumn DataField="fulf_account_id" SortExpression="fulf_account_id" ReadOnly="True"
                        HeaderText="EDS&nbsp;Account&nbsp;#"></asp:BoundColumn>
