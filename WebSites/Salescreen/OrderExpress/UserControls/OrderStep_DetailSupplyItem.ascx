<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.OrderStep_DetailSupplyItem" Codebehind="OrderStep_DetailSupplyItem.ascx.cs" %>
	...
	<tr>
		<td align="left"> <!--Section Body -->
			<table id="Table4" cellSpacing="0" cellPadding="0" border="0">
				<tr>
					<td><uc1:OrderSupplyForm id="SupplyForm" runat="server"></uc1:OrderSupplyForm></td>
				</tr>
			</table>
		</td>
	</tr>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" border="0">
				<TR>
					...
					<td><asp:imagebutton id="imgBtnNext" runat="server" AlternateText="Click here to confirm your selection and go to the next STEP"
							ImageUrl="~/images/btnNext.gif"></asp:imagebutton></td>
				</TR>
			</TABLE>
		</TD>
	</TR>
