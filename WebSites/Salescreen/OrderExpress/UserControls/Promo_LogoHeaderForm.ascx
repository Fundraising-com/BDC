...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.Promo_LogoHeaderForm" Codebehind="Promo_LogoHeaderForm.ascx.cs" %>
	...
	<tr>
		<td align="left">
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="600" border="0">
				...
				<TR align="left">
					<TD style="WIDTH: 215px" align="left"><SPAN class="StandardLabel">ID&nbsp;:</SPAN>
					</TD>
					<TD ><asp:label id="lblID" runat="server" Width="200px" CssClass="DescInfoLabel"></asp:label></TD>
				</TR>
				<TR align="left">
					<TD style="WIDTH: 215px" align="left"><SPAN class="StandardLabel">Name&nbsp;:</SPAN>
					</TD>
					<TD ><asp:textbox id="txtName" Runat="server"></asp:textbox></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 215px" align="left"><SPAN class="StandardLabel">Category&nbsp;:</SPAN>
					</TD>
				...
				<TR>
					<TD style="WIDTH: 215px" align="left"><SPAN class="StandardLabel">Image&nbsp;&nbsp;:</SPAN>
					</TD>
					<TD vAlign="top"><asp:image id="imgDetail" runat="server" Width="100" Height="100" ImageUrl=""></asp:image></TD>
				</TR>
				<TR id="trUpload" style="DISPLAY: none" runat="server">
					<TD style="WIDTH: 215px" align="left"><SPAN class="StandardLabel">Upload&nbsp;Image&nbsp;:</SPAN>
					</TD>
