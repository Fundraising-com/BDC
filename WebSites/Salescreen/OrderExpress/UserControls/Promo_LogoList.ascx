<%@ Reference Control="Promo_LogoDetailInfo.ascx" %>
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.Promo_logoList" Codebehind="Promo_LogoList.ascx.cs" %>
...
<TABLE id="Table5" cellSpacing="0" cellPadding="0" align="left" border="0">
										...
										<TR>
											<td>
												<table cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<tr>
														<td><asp:label id="Label12" runat="server" CssClass="ModuleSearchText">
																Category&nbsp;:
															</asp:label></td>
														<td>
	...
	<TR>
		<TD><!--DataGrid  --><cc2:sorteddatagrid id=dtgPromo_logo runat="server" SearchMode="0" width="700px" PageSize="10" AllowPaging="True" AllowSorting="True" CellPadding="3" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#CCCCCC" DataSource="<%# DVPromo_logo %>" AutoGenerateColumns="False" ShowFooter="True" Font-Size="10pt">
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<ASP:IMAGEBUTTON id="imgBtnDetail" runat="server" ImageUrl='' CommandName="Select" CausesValidation="False"
								Width="100"></ASP:IMAGEBUTTON>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="Promo_logo_id" HeaderText="ID">
						<ItemTemplate>
							<asp:Label id="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Promo_logo_id") %>' />
						</ItemTemplate>
					</asp:TemplateColumn>
