...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.SynchAccountList" Codebehind="SynchAccountList.ascx.cs" %>
...
<TABLE id="Table5" cellSpacing="0" cellPadding="0" align="left" border="0">
	...
	<TR>
		<TD width="100%"><!--DataGrid  -->
			<cc2:sorteddatagrid id=dtgAccount runat="server" SearchMode="0" ShowFooter="True" DataSource="<%# DVAccount %>" AutoGenerateColumns="False" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="3" AllowSorting="True" AllowPaging="True" Width="100%" PageSize="30" Font-Size="10pt">
				...
				<Columns>
					...
					<asp:BoundColumn DataField="account_status_name" SortExpression="account_status_name" ReadOnly="True"
						HeaderText="Status">
						<ItemStyle Width="100px" wrap="false"></ItemStyle>
					</asp:BoundColumn>
					<asp:TemplateColumn SortExpression="OL#INT" HeaderText="QSP&nbsp;ID">
						<HeaderStyle Width="50px"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id="Label8" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OL#INT")%>'>
							</asp:Label>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="OLCUST" HeaderText="EDS&nbsp;Acct&nbsp;#">
						<HeaderStyle Width="50px"></HeaderStyle>
						<ItemTemplate>
							<asp:Label id="lblAccountNumber" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OLCUST", "{0:D9}")%>'>
							</asp:Label>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:TemplateColumn SortExpression="OLNMBL" HeaderText="Account&nbsp;Name">
						<HeaderStyle Wrap="False" Width="250px"></HeaderStyle>
						<ItemTemplate>
							<asp:HyperLink id="hypLnkName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OLNMBL") %>' ForeColor="#336699" NavigateUrl="javascript:void(0);">
							</asp:HyperLink>
						</ItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:BoundColumn DataField="OLCYBL" SortExpression="OLCYBL" ReadOnly="True" HeaderText="City">
						<ItemStyle Wrap="False" Width="130px"></ItemStyle>
					</asp:BoundColumn>
					<asp:TemplateColumn SortExpression="OLZPBL" HeaderText="Zip">
						<ItemStyle Wrap="False" Width="100px"></ItemStyle>
						<ItemTemplate>
							<asp:Label id=Label2 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OLZPBL") %>'>
							</asp:Label>
						</ItemTemplate>
					</asp:TemplateColumn>
					<asp:BoundColumn DataField="OLSTBL" SortExpression="OLSTBL" ReadOnly="True" HeaderText="State"></asp:BoundColumn>
					<asp:BoundColumn DataField="OLRCTP" SortExpression="OLRCTP" ReadOnly="True" HeaderText="Op.Type"></asp:BoundColumn>
				</Columns>
