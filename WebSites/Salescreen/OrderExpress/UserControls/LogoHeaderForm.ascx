...
<%@ Control Language="c#" Inherits="QSP.OrderExpress.Web.UserControls.LogoHeaderForm" Codebehind="LogoHeaderForm.ascx.cs" %>
		...
		<td align="left">
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="600" border="0">
				...
				<TR>
					...
					<TD vAlign="top"><asp:textbox id="txtName" Runat="server"></asp:textbox><asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="The Name is required"
							ControlToValidate="txtName" CssClass="LabelError" >*</asp:RequiredFieldValidator></TD>
				</TR>
				<TR>
				...
				<TR id="trUpload" style="DISPLAY: none" runat="server">
				...
				<TR id="trNational" runat="server">
					...
					<TD vAlign="top" style="height: 20px"><asp:checkbox id="chkNational" Runat="server" AutoPostBack="True" OnCheckedChanged="chkNational_CheckedChanged"></asp:checkbox></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD vAlign="top"><asp:textbox id="txtDescription" Width="400px" Runat="server" Rows="5" TextMode="MultiLine"></asp:textbox><asp:RequiredFieldValidator id="required1" runat="server" ErrorMessage="The Description is required"
							ControlToValidate="txtDescription" CssClass="LabelError" >*</asp:RequiredFieldValidator></TD>
				</TR>
			</TABLE>
		</td>
	</tr>
