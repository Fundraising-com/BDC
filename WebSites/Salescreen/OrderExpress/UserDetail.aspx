<%@ Page Language="C#" MasterPageFile="~/SecondaryMaster.master" AutoEventWireup="true" Inherits="QSP.OrderExpress.Web.UserDetail" Codebehind="UserDetail.aspx.cs" %>
        ...
        <tr>
            <td align="left">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;
                    ...
                    <tr>
                        <td align="left">
                            <uc1:UserDetail ID="ctrlUserDetail" runat="server"></uc1:UserDetail>
                            <br>
                        </td>
                    </tr>
                </table>
