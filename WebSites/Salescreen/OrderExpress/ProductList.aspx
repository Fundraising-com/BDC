<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" Inherits="QSP.OrderExpress.Web.ProductList" Codebehind="ProductList.aspx.cs" %>
        ...
        <tr>
            <td align="left">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-left: 5px;">
                    <tr>
                        <td align="left">
                            <uc1:ProductList ID="ctrlProductList" runat="server"></uc1:ProductList>
                            <br>
                        </td>
                    </tr>
                </table>
