...
namespace QSP.OrderExpress.Web {
    public partial class FMAccountTransfer : BaseWebForm // System.Web.UI.Page
{
        ...
        protected DataView DVOrganization;
        ...
        protected void FlagPoleID_CheckedChanged(object sender, EventArgs e) {
            ...
            sample.Text = row.Cells[0].Text + " ";

            string flagpoleid = row.Cells[0].Text;

            int i = MasterGridView.Rows.Count;
        ...
        protected void imgSelect1_Click(object sender, ImageClickEventArgs e) {
            ...
            if (BxChkd == true) {
                RePopulateCheckBoxes();
                bool result = FMAccountSys.UpdateAccountsBYFMID(deletedIds, txtFMID.Text, txtFMID1.Text, txtFMID2.Text, Convert.ToDateTime(txtDate.Text), txtReason.Text, UserID);
                //Clear all Session values    
                Session.Remove("CheckedItems");
        ...
        protected void imgSelect2_Click(object sender, ImageClickEventArgs e) {
            ...
            bool result = FMterritorySys.UpdateTerritoryBYFMID(txtFMID.Text, txtFMID1.Text, txtFMID2.Text, Convert.ToDateTime(txtDate.Text), txtReason.Text, UserID);
