...
// This code file 'App_Code\Migrated\Stub_FormDetail_ascx_cs.cs' was created and contains an abstract class 
// used as a base class for the class 'Migrated_FormDetail' in file 'FormDetail.ascx.cs'.
...
namespace QSP.OrderExpress.Web.Code {
    abstract public class BaseFormDetail : BaseWebFormControl {
        public const string FORM_ID = "FormID";

        abstract public int FormID {
            get;
            set;
        }
    }
