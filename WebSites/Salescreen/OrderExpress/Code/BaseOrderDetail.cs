...
// This code file 'App_Code\Migrated\Stub_OrderDetail_ascx_cs.cs' was created and contains an abstract class 
// used as a base class for the class 'Migrated_OrderDetail' in file 'OrderDetail.ascx.cs'.
...
namespace QSP.OrderExpress.Web.Code {
    abstract public class BaseOrderDetail : BaseWebFormControl {
        public const string ORDER_ID = "OrderID";

        abstract public int OrderID {
            get;
            set;
        }
    }
