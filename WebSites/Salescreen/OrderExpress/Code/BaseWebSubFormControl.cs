...
namespace QSP.OrderExpress.Web.Code {
    /// <summary>Base Web User Control for SubForm Control in QSPForm_Web</summary>
    /// <remarks>
    ///		Inherit from BaseWebFormControl
    ///		We used this class to manage common functionnality
    ///		of the DataGrid by example
    ///	</remarks>
    public class BaseWebSubFormControl : BaseWebFormControl {
        private QSP.WebControl.DataGridControl.SortedDataGrid dtgMain;
        private DataView dvMain;
        private System.Web.UI.WebControls.Label lblCurrentIndex;
        ...
        public System.Web.UI.WebControls.Label LabelCurrentIndex {
            get {
                return lblCurrentIndex;
            }
            set {
                lblCurrentIndex = value;
            }
        }

        public System.Web.UI.WebControls.Label LabelTotal {
            get {
                return lblTotal;
            }
            set {
        ...
        protected virtual void OnItemCreated(DataGridItemEventArgs e) {
            ...
            if ((e.Item.ItemType == ListItemType.EditItem) || (e.Item.ItemType == ListItemType.Item)
                ...
                if ((imgBtnUpdate != null) && (this.Page.LabelMessage != null))
                    imgBtnUpdate.Attributes.Add("onclick", "document.all." + this.Page.LabelMessage.ClientID + ".innerHTML = '';");
        ...
        private void dtgMain_ItemDataBound(object source, DataGridItemEventArgs e) {
