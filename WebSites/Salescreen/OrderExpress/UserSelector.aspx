<%@ Page Language="C#" MasterPageFile="~/SecondaryMaster.master" AutoEventWireup="true" Inherits="QSP.OrderExpress.Web.UserSelector" Codebehind="UserSelector.aspx.cs" %>
        ...
        <tr>
            <td align="left">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-left: 5px;">
                    <tr>
                        <td align="left">
                            <uc1:UserSelector ID="ctrlUserSelector" runat="server"></uc1:UserSelector>
                            <br>
                        </td>
                    </tr>
                </table>
