<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrderSearchResults.ascx.cs"
    Inherits="QSP.OrderExpress.Web.V2.UserControls.OrderSearchResults" %>
        ...
        <td>
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("OrderId", "~/V2/Forms/OrderView.aspx?OrderId={0}") %>'
                                Target="_blank">
                    ...
                    <asp:BoundField DataField="OrderId" HeaderText="QSP order id" ReadOnly="True"
                        SortExpression="OrderId" />
                    <asp:BoundField DataField="EDSOrderId" HeaderText="EDS order id" ReadOnly="True"
                        SortExpression="EDSOrderId" />
                    <asp:BoundField DataField="OrderTypeName" HeaderText="Order type" ReadOnly="True"
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" EnableViewState="False"
    TypeName="QSP.OrderExpress.Web.V2.UserControls.OrderGridHelper" SelectCountMethod="GetCount"
