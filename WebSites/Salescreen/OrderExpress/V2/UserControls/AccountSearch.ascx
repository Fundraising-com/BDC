<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccountSearch.ascx.cs"
    Inherits="QSP.OrderExpress.Web.V2.UserControls.AccountSearch" %>
<table width="100%">
    <tr>
        <td colspan="4">
    ...
    <tr>
        <td colspan="3">
            <span class="Text_Note_Title">Note: </span><span class="Text_Note_Text">All criteria
                is considered when searching accounts.</span>
        </td>
        <td>
            <asp:Button ID="btnSearch" runat="server" Text="Search accounts" OnClick="btnSearch_Click"
