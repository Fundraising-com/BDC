...
namespace QSPForm.Common.DataDef
{
	...
	public class CatalogGroupCatalogTable : DataTable
	{
		//
		//Order Header constants
		// 
		/// <value>The constant used for catalog_group table. </value>
		public const String TBL_CATALOG_GROUP_CATALOG = "catalog_group";
		/// <value>The constant used for PKId field in the CatalogGroup table. </value>
		public const String FLD_PKID = "catalog_group_catalog_id";
		/// <value>The constant used for PKId field in the CatalogGroup table. </value>
		...
		public CatalogGroupCatalogTable() : base(TBL_CATALOG_GROUP_CATALOG) 
		{
			this.InitClass();
		}
		    
		public CatalogGroupCatalogTable(DataTable table) : base(table.TableName) 
		{
		...
		{
			CatalogGroupCatalogTable cln = ((CatalogGroupCatalogTable)(base.Clone()));
			cln.InitVars();
			return cln;
		}
		...
		{
			return new CatalogGroupCatalogTable();
		}
		...
		private void InitClass() 
		{
			...
			//
			this.TableName = TBL_CATALOG_GROUP_CATALOG;
