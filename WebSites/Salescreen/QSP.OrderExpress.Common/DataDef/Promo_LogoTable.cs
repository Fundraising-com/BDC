...
namespace QSPForm.Common.DataDef
{
	...
	public class Promo_LogoTable : DataTable, System.Collections.IEnumerable
	{		
		
		public const string TBL_Promo_logo = "QSPForm_Promo_logo";
		public const string FLD_PKID = "Promo_logo_id";
		...
		public Promo_LogoTable() : 
			base(TBL_Promo_logo) 
		{
			this.InitClass();
		}
		    
		public Promo_LogoTable(DataTable table) : 
		...
		/// </summary>
		public Promo_LogoTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}		
