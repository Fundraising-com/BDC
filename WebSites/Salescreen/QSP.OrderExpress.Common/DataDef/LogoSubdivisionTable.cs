...
namespace QSPForm.Common.DataDef
{
	...
	public class LogoSubdivisionTable : DataTable, System.Collections.IEnumerable
	{		
		
		public const string TBL_LOGO_SUBDIVISION = "QSPForm_logo_subdivision";
		public const string FLD_PKID = "logo_subdivision_id";
		...
		public LogoSubdivisionTable() : 
			base(TBL_LOGO_SUBDIVISION) 
		{
			this.InitClass();
		}
		    
		public LogoSubdivisionTable(DataTable table) : 
		...
		/// </summary>
		public LogoSubdivisionTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}		
		...
		{			
			...
			//
			this.TableName = TBL_LOGO_SUBDIVISION;
