...
namespace QSPForm.Common.DataDef
{
	...
	public class Promo_TextSubdivisionTable : DataTable, System.Collections.IEnumerable
	{		
		
		public const string TBL_Promo_Text_SUBDIVISION = "QSPForm_Promo_Text_subdivision";
		public const string FLD_PKID = "Promo_Text_subdivision_id";
		...
		public Promo_TextSubdivisionTable() : 
			base(TBL_Promo_Text_SUBDIVISION) 
		{
			this.InitClass();
		}
		    
		public Promo_TextSubdivisionTable(DataTable table) : 
		...
		/// </summary>
		public Promo_TextSubdivisionTable(SerializationInfo info, StreamingContext context) : base(info, context) 
		{		
		}		
		...
		{			
			...
			//
			this.TableName = TBL_Promo_Text_SUBDIVISION;
