//
// Louis Turmel,	June 27, 2005	Class creation and code comments added
//
...
namespace efundraising.efundraisingCore {
	...
	/// <summary>
	/// class environment for efundraising.efundraising web site
	/// </summary>
	[Serializable()]
	public sealed class eFundEnv {

		#region Constants
		private const string SESSION_KEY = "eFundEnv";
		#endregion
		...
		#region Methods
		public static eFundEnv CreateByPartnerId(int partnerId)
		{
			eFundEnv env = eFundEnv.Create();
			env.PartnerInfo = Partner.GetPartnerInfoByID(partnerId);
			return env;
		}
		...
		public int GetWebSiteID()
		{
			...
			EFundDatabase dbi = new EFundDatabase();
			webSiteID = dbi.GetWebSiteID(this.PromotionID, 2);
