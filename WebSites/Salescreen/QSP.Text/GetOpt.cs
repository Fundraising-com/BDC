...
namespace QSP.Text
{
    ...
    public class GetOpt
    {
        ...
        public bool IsDefined(string option)
        {
            ...
            {
                throw new MethodAccessException("Call the Parse() method first");
            }
        }
        ...
        public bool HasArgument(string option)
        {
            ...
            {
                throw new ArgumentException("Option ({0}) is not defined");
            }
        }
        ...
        public string GetOptionArg(string option)
        {
            ...
            {
                throw new ArgumentException("Option does not have an argument");
            }
        }
