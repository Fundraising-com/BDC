<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ControlerCustomerServiceOrdersStatement.ascx.cs" Inherits="QSPFulfillment.Reports.ControlerCustomerServiceOrdersStatement" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div style="TEXT-ALIGN: center">
	<table id="Table1" cellspacing="0" cellpadding="0" width="500" border="0">
		<tr>
			<td><asp:label id="lblTitle" cssclass="CSPageTitle" runat="server">Customer Service Orders Statement Report</asp:label></td>
		</tr>
	</table>
</div>
...
<cc2:rsgeneration id="rsGenerationCustomerServiceOrdersStatement" runat="server" reportname="CustomerServiceOrdersStatement"
	mode="PopUp"></cc2:rsgeneration>
