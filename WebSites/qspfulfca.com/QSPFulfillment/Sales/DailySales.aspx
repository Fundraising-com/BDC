<%@ Page language="c#" debug="true" Codebehind="DailySales.aspx.cs" AutoEventWireup="True" Inherits="QSPFulfillment.Sales.DailySales" %>
...
<html>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		...
		<%}%>
			<center>
				<h3><font face="Verdana" color="#2f4f88">Weekly Sales By UMC Code</font></h3>
			</center>
			<p></p>
					...
					<TD vAlign="top">
						<asp:DataGrid OnItemDataBound="grdCurYr_ItemDataBound" id="grdCurYr" runat="server" HorizontalAlign="Right" ShowFooter="True" AutoGenerateColumns="False" BorderColor="Black" BorderWidth="1px">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Daily">
									<ItemTemplate>
										<asp:HyperLink id=RankReportHyperLink runat="server" Text="View" NavigateUrl='<%# "../Sales/DailySalesForUMC.aspx?RequestID=" + strPCode + "&Name=" + Request.QueryString["Name"] + "&WeekDate=" + DataBinder.Eval(Container.DataItem, "Week") %>' Font-Underline="True" ForeColor="#2f4f88" Target="_blank" />
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
						</asp:DataGrid>
					...
					<TD vAlign="top">
						<asp:DataGrid OnItemDataBound="grdPriorYr_ItemDataBound" id="grdPriorYr" runat="server" HorizontalAlign="Center" ShowFooter="True" AutoGenerateColumns="False" BorderColor="Black" BorderWidth="1px" BackColor="#2F4F88">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Daily">
									<ItemTemplate>
										<asp:HyperLink id="Hyperlink1" runat="server" Text="View" NavigateUrl='<%# "../Sales/DailySalesForUMC.aspx?RequestID=" + strPCode + "&Name=" + Request.QueryString["Name"] + "&WeekDate=" + DataBinder.Eval(Container.DataItem, "Week") %>' Font-Underline="True" ForeColor="#2f4f88" Target="_blank" />
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
						</asp:DataGrid>
					...
					<TD vAlign="top">
						<asp:DataGrid OnItemDataBound="grdTwoAgo_ItemDataBound" id="grdTwoAgo" runat="server" HorizontalAlign="Left" ShowFooter="True" AutoGenerateColumns="False" BorderColor="Black" BorderWidth="1px" Font-Bold="True">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderText="Daily">
									<ItemTemplate>
										<asp:HyperLink id="Hyperlink2" runat="server" Text="View" NavigateUrl='<%# "../Sales/DailySalesForUMC.aspx?RequestID=" + strPCode + "&Name=" + Request.QueryString["Name"] + "&WeekDate=" + DataBinder.Eval(Container.DataItem, "Week") %>' Font-Underline="True" ForeColor="#2f4f88" Target="_blank" />
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
						</asp:DataGrid>
...
void BindGrid()
{
	...
	SqlCommand cmd = new SqlCommand("UMCSalesReport", conn);
	...
	da.SelectCommand.Parameters.Add(new SqlParameter("@ProductCode", SqlDbType.VarChar,6));
	...
	da.Fill(ds, "UMCSales");
	DataView dv = ds.Tables["UMCSales"].DefaultView;

	grdCurYr.DataSource = dv;
	grdCurYr.DataBind();

	SqlCommand cmd2 = new SqlCommand("UMCSalesReport", conn);
	...
	da2.SelectCommand.Parameters.Add(new SqlParameter("@ProductCode", SqlDbType.VarChar,6));
	da2.SelectCommand.Parameters["@ProductCode"].Value = strPCode;
	...
	//fill the dataset and retrieve the default view
	da2.Fill(ds, "UMCSales_PY");
	DataView dv2 = ds.Tables["UMCSales_PY"].DefaultView;
	
	grdPriorYr.DataSource = dv2;
	grdPriorYr.DataBind();

	SqlCommand cmd3 = new SqlCommand("UMCSalesReport", conn);
	...
	da3.SelectCommand.Parameters.Add(new SqlParameter("@ProductCode", SqlDbType.VarChar,6));
	da3.SelectCommand.Parameters["@ProductCode"].Value = strPCode;
	...
	//fill the dataset and retrieve the default view
	da3.Fill(ds, "UMCSales_2Yr");
	DataView dv3 = ds.Tables["UMCSales_2Yr"].DefaultView;
