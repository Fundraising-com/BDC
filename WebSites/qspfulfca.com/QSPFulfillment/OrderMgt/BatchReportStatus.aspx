...
<%@ Page language="c#" Codebehind="BatchReportStatus.aspx.cs" AutoEventWireup="false" Inherits="QSPFulfillment.OrderMgt.BatchReportStatus" %>
				...
				<asp:label id="Label2" runat="server" forecolor="Blue"></asp:label><asp:datagrid id="DataGrid1" runat="server" width="95%" autogeneratecolumns="False" borderstyle="Solid"
					...
					<columns>
						...
						<asp:templatecolumn>
							...
							<itemstyle horizontalalign="Center"></itemstyle>
							<itemtemplate>
								<cc2:webfilestreamerlinkbutton id="lnkWebFileStreamerLinkButtonBatchReports" runat="server" visible="False" navigateurl="http://uspvl3k05-dev/ReportQueue/">PRINT</cc2:webfilestreamerlinkbutton>
							</itemtemplate>
						</asp:templatecolumn>
						<asp:templatecolumn>
							<headerstyle horizontalalign="Center" verticalalign="Bottom"></headerstyle>
