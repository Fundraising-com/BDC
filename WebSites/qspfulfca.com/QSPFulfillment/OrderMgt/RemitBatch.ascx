<%@ Control Language="c#" AutoEventWireup="True" Codebehind="RemitBatch.ascx.cs" Inherits="QSPFulfillment.OrderMgt.RemitBatch" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="dbwc" Namespace="DBauer.Web.UI.WebControls" Assembly="DBauer.Web.UI.WebControls.HierarGrid" %>
<P><DBWC:HIERARGRID id="hidGrid" style="Z-INDEX: 101" TemplateDataMode="Table" TemplateCachingBase="Tablename"
	...
	<PagerStyle HorizontalAlign="Left" ForeColor="#000066" BackColor="White"  cssClass="CSPager" Mode="NumericPages"></PagerStyle>
		<Columns>
			<asp:BoundColumn DataField="ID" ReadOnly="True" HeaderText="Remit Batch Id"></asp:BoundColumn>
			...
			<asp:BoundColumn DataField="FulFillmenthouseNbr" ReadOnly="True" HeaderText="Ful Fillment house Nbr"></asp:BoundColumn>
			...
			<asp:BoundColumn DataField="TotalItemPrice" ReadOnly="True" HeaderText="Total Item Price" DataFormatString="{0:c}">
				<ItemStyle HorizontalAlign="Right"></ItemStyle>
			</asp:BoundColumn>
		</Columns>
	</DBWC:HIERARGRID></P>
