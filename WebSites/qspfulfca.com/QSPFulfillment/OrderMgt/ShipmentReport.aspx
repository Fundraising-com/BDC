...
<%@ Page language="c#" Codebehind="ShipmentReport.aspx.cs" AutoEventWireup="false" Inherits="QSPFulfillment.OrderMgt.ShipmentReport" %>
...
<html>
	...
	<body ms_positioning="GridLayout" topmargin="0" leftmargin="0" rightmargin="0">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="lblShipmentReport" style="Z-INDEX: 100; LEFT: 48px; POSITION: absolute; TOP: 32px; width: 511px;"
				runat="server" font-names="Verdana" font-size="Large">Shipment Report</asp:label>
			...
			<table id="Table1" style="Z-INDEX: 101; LEFT: 48px; WIDTH: 816px; POSITION: absolute; TOP: 104px; HEIGHT: 136px"
				...
				<tr>
					<td style="WIDTH: 142px; HEIGHT: 24px">
						<asp:label id="lblOrderId" runat="server" width="184px" font-size="X-Small" font-names="Verdana"
					...
					<td style="WIDTH: 204px; HEIGHT: 24px">
						<asp:label id="lblShowBHE" runat="server" width="184px" font-size="X-Small" font-names="Verdana"
							font-bold="True">Show BHE</asp:label></td>
					<td style="HEIGHT: 24px">
	                    <asp:CheckBox ID="ShowBHECheckBox" runat="server" Checked="True" />
                    </td>
				</tr>
				<tr>
					<td style="WIDTH: 142px; HEIGHT: 24px">
			...
			<cc2:rsgeneration id="rsGenerationShipmentReport" runat="server" reportname="Shipment" mode="PopUp"></cc2:rsgeneration>
		</form>
	</body>
</html>
