<%@ Page language="c#" Codebehind="SearchProblemSolverReport.aspx.cs" AutoEventWireup="false" Inherits="QSPFulfillment.Finance.SearchProblemSolverReport" %>
<%@ Register TagPrefix="cc2" Namespace="QSPFulfillment.CommonWeb" Assembly="QSPFulfillment"  %>
<%@ Register TagPrefix="cc1" Namespace="skmMenu" Assembly="skmMenu"  %>
<html>
	<head>
		<title>CA Fulfill System - Problem Solver Report</title>
	...
	<body topmargin="0" leftmargin="0">
		<form method="post" runat="server" id="StatementForm">
			...
			<br>
			<center><h3><font face="Verdana" color="#2f4f88">Problem Solver Report</font></h3>
			</center>
			<p></p>
			...
			<table border="0" cellspacing="0" cellpadding="2" width="100%" align="center">
				<tr>
					<td>
						<asp:datagrid onitemdatabound="ProblemSolverReportDG_ItemDataBound" id="ProblemSolverReportDG"
							headerstyle-font-bold="True" allowsorting="true" onsortcommand="ProblemSolverReportDG_Sort"
							...
							pagerstyle-backcolor="#2f4f88" pagerstyle-forecolor="white" onpageindexchanged="ProblemSolverReportDG_Page"
							...
							<columns>
								<asp:templatecolumn headerstyle-verticalalign="Top" itemstyle-verticalalign="Top" headertext="Order ID"
									...
									<itemtemplate>
										...
										<cc2:rsgenerationlinkbutton id="rsGenerationMagazineItemsSummary" runat="server" causesvalidation="false" font-underline="True"
											forecolor="RoyalBlue" />
									</itemtemplate>
								</asp:templatecolumn>
