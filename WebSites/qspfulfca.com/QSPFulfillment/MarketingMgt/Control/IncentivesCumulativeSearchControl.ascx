...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="IncentivesCumulativeSearchControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.IncentivesCumulativeSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<br>
...
<asp:label id="lblMessage" runat="server"></asp:label><cc2:datagridobject id="dtgMain" runat="server" autogeneratecolumns="False" borderwidth="1px" borderstyle="None"
	...
	<columns>
		...
		<asp:templatecolumn headertext="Level Attained">
			<itemtemplate>
				<asp:label id="lblPrizeLevel" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.Prize_Level") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Qty Required">
			<itemtemplate>
				<asp:label id="lblPrizeLevelQuantity" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.Prize_Level_Qty_Required") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
