...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DefaultProductMaintenanceControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.DefaultProductMaintenanceControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<br>
<table id="Table3" style="BORDER-RIGHT: silver 1px solid; BORDER-TOP: silver 1px solid; BORDER-LEFT: silver 1px solid; BORDER-BOTTOM: silver 1px solid"
	...
	<tr>
		...
		<td>
			<asp:textbox id="tbxEnglishDescription" runat="server" maxlength="50" columns="40"></asp:textbox>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<asp:textbox id="tbxFrenchDescription" runat="server" maxlength="50" columns="40"></asp:textbox>
		</td>
	</tr>
	<tr>
		<td><asp:label id="LabelVendorProductCode" cssclass="csPlainText" runat="server">Vendor Product Code</asp:label></td>
		<td><cc1:textboxsearch id="tbxVendorProductCode" runat="server" contenttype="string" parametername="VendorProductCode" maxlength="12"></cc1:textboxsearch></td>
	</tr>
	<tr>
