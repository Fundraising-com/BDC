<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DefaultSingleContractSearchControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.DefaultSingleContractSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
