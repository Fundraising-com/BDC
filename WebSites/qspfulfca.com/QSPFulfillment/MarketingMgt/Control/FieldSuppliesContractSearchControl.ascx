<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FieldSuppliesContractSearchControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.FieldSuppliesContractSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:label id="lblMessage" runat="server"></asp:label><cc2:datagridobject id="dtgMain" runat="server" autogeneratecolumns="False" borderwidth="1px" borderstyle="None"
	...
	<columns>
		...
		<asp:templatecolumn visible="False">
			<itemtemplate>
				<asp:Label id="lblMagPriceInstance" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MagPrice_Instance") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn visible="False">
		...
		<asp:templatecolumn headertext="Product Name">
			<itemtemplate>
				<asp:Label id="lblProductName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Product_Sort_Name") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Applicability">
			<itemtemplate>
				<asp:label id="lblFSApplicability" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FSApplicability") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Distribution">
			<itemtemplate>
				<asp:label id="lblFSDistributionLevel" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.FSDistributionLevel") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="FS Qty. %">
			<itemtemplate>
				<asp:label id="lblFSExtraLimitRate" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.FSExtra_Limit_Rate") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Catalog Price">
			<itemtemplate>
				<asp:Label id=lblCatalogPrice runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.QSP_Price") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Brochure">
			<itemtemplate>
				<asp:label id="lblFSIsBrochure" runat="server" text='<%# Convert.ToBoolean(DataBinder.Eval(Container, "DataItem.FSIsBrochure")) ? "Y" : "N" %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Content Catalog">
			<itemtemplate>
				<asp:label id="lblFSContentCatalogCode" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.FSContent_Catalog_Code") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Tax Region">
			<itemtemplate>
				<asp:label id="lblTaxRegion" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.TaxRegion") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
		<asp:templatecolumn headertext="Province">
			<itemtemplate>
				<asp:label id="lblFSProvinceCode" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.FSProvinceCode") %>'>
				</asp:label>
			</itemtemplate>
		</asp:templatecolumn>
