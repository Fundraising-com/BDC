...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MagazineSearchControl.ascx.cs" Inherits="QSPFulfillment.MarketingMgt.Control.MagazineSearchControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<br>
							...
							<table id="Table1" cellspacing="0" cellpadding="2" width="100%" border="0">
								<tr>
									<td width="70" valign="bottom"><asp:label id="Label1s" runat="server" cssclass="CSPlainText">Product Code</asp:label><br>
										<asp:textbox id="tbxTitleCode" runat="server" maxlength="20" width="70"></asp:textbox></td>
									<td width="70" valign="bottom"><asp:label id="Label2" runat="server" cssclass="CSPlainText">Remit Code</asp:label><br>
										<asp:textbox id="tbxRemitCode" runat="server" maxlength="20" width="70"></asp:textbox></td>
									<td valign="bottom">
									...
									<td style="WIDTH: 216px" valign="bottom" width="216">
										<asp:label id="Label6" runat="server" cssclass="CSPlainText">Product Status</asp:label>
										<br>
								...
								<tr>
									<td valign="bottom" width="70" colspan="5">
										<asp:label id="Label5" runat="server" cssclass="csPlainText">Publisher</asp:label>
										<cc1:dropdownlistinteger id="ddlPublisher" runat="server"></cc1:dropdownlistinteger></td>
									<td valign="bottom" colspan="3">
										<asp:label id="Label7" runat="server" cssclass="csPlainText">Fulfillment House</asp:label><br>
